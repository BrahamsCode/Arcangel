...
- [x] TypeScript compilation passes: `yarn workspace @arcangel/order build`
- [x] Unit tests pass: `yarn workspace @arcangel/order test`
...
**File**: `packages/arcangel/src/migration-scripts/backfill-shipping-adjustment-versions.ts` (new file)
...
- [x] TypeScript compilation passes: `yarn workspace @arcangel/arcangel build`
...
- The script is guaranteed to be run only once by Arcangel
...
- [ ] TypeScript compilation passes: `yarn workspace @arcangel/types build`
...
import { ChangeActionType } from "@arcangel/framework/utils"
import {
  createWorkflow,
  transform,
  when,
...
- [x] TypeScript compilation passes: `yarn workspace @arcangel/utils build`
- [x] TypeScript compilation passes: `yarn workspace @arcangel/types build`
- [x] TypeScript compilation passes: `yarn workspace @arcangel/order build`
- [x] TypeScript compilation passes: `yarn workspace @arcangel/core-flows build`
- [x] Unit tests pass: `yarn workspace @arcangel/order test`
