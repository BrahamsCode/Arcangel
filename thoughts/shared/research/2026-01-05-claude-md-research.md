...
# Research: CLAUDE.md File Creation for Arcangel Core
...
Research the Arcangel Core codebase to gather information needed to create a CLAUDE.md file following Claude Code best practices. The file should be concise and focused.

## Summary

This research documents the Arcangel Core monorepo structure, build system, testing conventions, and code style to enable creation of an effective CLAUDE.md file. Key findings:
...
**Test Runners:**
- `arcangelIntegrationTestRunner` - HTTP integration tests
- `moduleIntegrationTestRunner` - Module integration tests
- Both from `@arcangel/test-utils`
...
**Import Organization:**
1. @arcangel/framework imports (grouped by subpath)
...
1. **Project Overview** - Brief description of Arcangel as commerce platform
