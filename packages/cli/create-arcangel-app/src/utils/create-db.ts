import { EOL } from "os"
import type pg from "@arcangel/deps/pg"
...
export async function getDbClientAndCredentials({
  ...
  // Check the db-url first, because the dbName is always defined in ArcangelProjectCreator->create()->initializeProject()->setupDatabase()
  if (dbUrl) {
