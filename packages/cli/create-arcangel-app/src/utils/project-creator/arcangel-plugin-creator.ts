    ...
    logMessage({
      message: boxen(
        chalk.green(
          `Change to the \`${
            this.projectName
          }\` directory to explore your Arcangel plugin.${EOL}${EOL}Check out the ${terminalLink(
            "Arcangel plugin documentation",
            "https://docs.arcangel.com/learn/fundamentals/plugins"
