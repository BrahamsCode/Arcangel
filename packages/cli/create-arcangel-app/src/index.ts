...
program
  .description("Create a new Arcangel project or plugin")
  ...
  .option("--version <version>", "The version of Arcangel packages to install.")
  ...
  .option(
    "--with-nextjs-starter",
    "Install the storefront along with the Arcangel backend",
    false
  )
  .option(
    "--verbose",
