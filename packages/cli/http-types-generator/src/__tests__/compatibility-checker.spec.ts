...
describe("CompatibilityChecker.formatResult", () => {
  it("returns empty string for passing results when not verbose", () => {
    const result: CompatibilityResult = {
      ...
      validatorFile: "packages/arcangel/src/api/admin/products/validators.ts",
      passed: true,
      typeNotFound: false,
      missingFields: [],
      typeMismatchFields: [],
  ...
  it("shows FAIL line with missing fields for failures", () => {
    const result: CompatibilityResult = {
      ...
      validatorFile: "packages/arcangel/src/api/admin/customers/validators.ts",
      passed: false,
      typeNotFound: false,
      missingFields: [
  ...
  it("shows type mismatch details for mismatch failures", () => {
    const result: CompatibilityResult = {
      ...
      validatorFile: "packages/arcangel/src/api/admin/orders/validators.ts",
      passed: false,
      typeNotFound: false,
      missingFields: [],
      typeMismatchFields: [
