import { SearchIndexLoader } from "@arcangel/framework/search"
import { ConfigModule, Logger, PluginDetails } from "@arcangel/framework/types"
 ...
 * (Postgres provider), and Cloud may swap that for Lakebase or Arcangel Cloud
