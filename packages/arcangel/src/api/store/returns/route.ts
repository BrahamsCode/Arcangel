import { createAndCompleteReturnOrderWorkflow } from "@arcangel/core-flows"
 ...
 *
 * To restrict access to this route, follow [this guide](https://docs.arcangel.com/resources/commerce-modules/order/secure-return-creation).
 *
 * @since 2.8.0
 */
export const POST = async (
  req: ArcangelRequest<HttpTypes.StoreCreateReturn>,
  res: ArcangelResponse<HttpTypes.StoreReturnResponse>
) => {
