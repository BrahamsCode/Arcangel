import { completeCartWorkflowId } from "@arcangel/core-flows"
import { prepareRetrieveQuery } from "@arcangel/framework"
...
export const POST = async (
  ...
  res: ArcangelResponse<HttpTypes.StoreCompleteCartResponse>
) => {
  ...
  if (errors?.[0]) {
    ...
    const statusOKErrors: string[] = [
      ...
      ArcangelError.Types.PAYMENT_AUTHORIZATION_ERROR,
      ArcangelError.Types.PAYMENT_REQUIRES_MORE_ERROR,
    ]
