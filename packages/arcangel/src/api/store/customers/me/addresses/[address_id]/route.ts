...
import { HttpTypes, ArcangelContainer } from "@arcangel/framework/types"
import {
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.StoreGetCustomerAddressParams>,
  res: ArcangelResponse<HttpTypes.StoreCustomerAddressResponse>
) => {
...
export const DELETE = async (
  ...
  res: ArcangelResponse<HttpTypes.StoreCustomerAddressDeleteResponse>
) => {
  const id = req.auth_context.actor_id
  await validateCustomerAddress(req.scope, id, req.params.address_id)
