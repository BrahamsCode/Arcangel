import { TaxCalculationContext } from "@arcangel/framework/types"
...
export function setTaxContext(options: TaxContextOptions = {}) {
  ...
  return async (req: AuthenticatedArcangelRequest, _, next: NextFunction) => {
    ...
    try {
      ...
      // TODO: Allow passing a context typings param to AuthenticatedArcangelRequest
...
const getTaxInclusivityInfo = async (req: ArcangelRequest) => {
...
const getTaxLinesContext = async (req: ArcangelRequest) => {
