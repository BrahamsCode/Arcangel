import { batchTranslationsWorkflow } from "@arcangel/core-flows"
...
import { BatchMethodRequest, HttpTypes } from "@arcangel/types"
...
export const POST = async (
  req: AuthenticatedArcangelRequest<
    ...
    >
  >,
  res: ArcangelResponse<HttpTypes.AdminTranslationsBatchResponse>
) => {
