import { createShippingOptionsWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminShippingOptionListParams>,
  res: ArcangelResponse<HttpTypes.AdminShippingOptionListResponse>
) => {
