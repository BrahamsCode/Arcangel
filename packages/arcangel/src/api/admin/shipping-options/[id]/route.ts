...
import { FulfillmentWorkflow, HttpTypes } from "@arcangel/framework/types"
import {
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminGetShippingOptionParams>,
  res: ArcangelResponse<HttpTypes.AdminShippingOptionResponse>
) => {
...
export const DELETE = async (
  req: AuthenticatedArcangelRequest,
  res: ArcangelResponse<HttpTypes.AdminShippingOptionDeleteResponse>
) => {
