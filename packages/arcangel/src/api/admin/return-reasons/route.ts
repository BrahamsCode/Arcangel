import { createReturnReasonsWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminReturnReasonListParams>,
  res: ArcangelResponse<HttpTypes.AdminReturnReasonListResponse>
) => {
...
export const POST = async (
  ...
  >,
  res: ArcangelResponse<HttpTypes.AdminReturnReasonResponse>
) => {
