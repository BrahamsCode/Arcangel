...
import { AdminReturnReasonResponse, HttpTypes } from "@arcangel/framework/types"
import {
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminReturnReasonParams>,
  res: ArcangelResponse<AdminReturnReasonResponse>
) => {
...
export const DELETE = async (
  req: AuthenticatedArcangelRequest,
  res: ArcangelResponse<HttpTypes.AdminReturnReasonDeleteResponse>
) => {
  const { id } = req.params
