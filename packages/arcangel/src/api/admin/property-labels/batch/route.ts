import { batchPropertyLabelsWorkflow } from "@arcangel/core-flows"
import {
...
export const POST = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminBatchPropertyLabels>,
  res: ArcangelResponse<HttpTypes.AdminBatchPropertyLabelResponse>
) => {
