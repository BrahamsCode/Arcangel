...
import { updateViewConfigurationWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminGetViewConfigurationParams>,
...
export const POST = async (
  req: AuthenticatedArcangelRequest<AdminUpdateViewConfigurationType>,
  res: ArcangelResponse<HttpTypes.AdminViewConfigurationResponse>
) => {
  const query = req.scope.resolve(ContainerRegistrationKeys.QUERY)
...
export const DELETE = async (
  ...
  res: ArcangelResponse<HttpTypes.AdminViewConfigurationDeleteResponse>
) => {
  const query = req.scope.resolve(ContainerRegistrationKeys.QUERY)
