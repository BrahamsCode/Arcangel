import { orderClaimRequestItemReturnWorkflow } from "@arcangel/core-flows"
import {
...
export const POST = async (
  req: AuthenticatedArcangelRequest<AdminPostReturnsRequestItemsReqSchemaType>,
  res: ArcangelResponse<HttpTypes.AdminClaimReturnPreviewResponse>
) => {
  const { id } = req.params
