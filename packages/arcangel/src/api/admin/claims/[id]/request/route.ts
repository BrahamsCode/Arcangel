...
export const POST = async (
  req: AuthenticatedArcangelRequest<{}, HttpTypes.AdminClaimParams>,
  res: ArcangelResponse<HttpTypes.AdminClaimRequestResponse>
) => {
  const { id } = req.params
...
export const DELETE = async (
  ...
  res: ArcangelResponse<HttpTypes.AdminClaimDeleteResponse>
) => {
  const { id } = req.params
