import { beginExchangeOrderWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminExchangeListParams>,
  res: ArcangelResponse<HttpTypes.AdminExchangeListResponse>
) => {
...
export const POST = async (
  ...
  >,
  res: ArcangelResponse<HttpTypes.AdminExchangeOrderResponse>
) => {
  const input = {
    ...req.validatedBody,
