...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminGetProductParams>,
  ...
  if (!product) {
    throw new ArcangelError(ArcangelError.Types.NOT_FOUND, "Product not found")
  }
...
export const DELETE = async (
  req: AuthenticatedArcangelRequest,
  res: ArcangelResponse<HttpTypes.AdminProductDeleteResponse>
) => {
