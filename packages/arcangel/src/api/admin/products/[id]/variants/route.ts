import { createProductVariantsWorkflow } from "@arcangel/core-flows"
...
import { refetchEntities, refetchEntity } from "@arcangel/framework/http"
import {
  remapKeysForProduct,
  remapKeysForVariant,
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminProductVariantParams>,
  res: ArcangelResponse<HttpTypes.AdminProductVariantListResponse>
) => {
