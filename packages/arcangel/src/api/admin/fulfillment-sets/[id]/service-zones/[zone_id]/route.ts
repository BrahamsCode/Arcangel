...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminServiceZonesParams>,
  res: ArcangelResponse<AdminServiceZoneResponse>
) => {
...
export const POST = async (
  ...
  >,
  res: ArcangelResponse<AdminFulfillmentSetResponse>
) => {
...
export const DELETE = async (
  ...
  res: ArcangelResponse<HttpTypes.AdminServiceZoneDeleteResponse>
) => {
