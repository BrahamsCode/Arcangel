...
import { createInventoryItemsWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminInventoryItemsParams>,
  res: ArcangelResponse<HttpTypes.AdminInventoryItemListResponse>
) => {
