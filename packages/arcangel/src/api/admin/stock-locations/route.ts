...
import { createStockLocationsWorkflow } from "@arcangel/core-flows"
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminStockLocationListParams>,
  res: ArcangelResponse<HttpTypes.AdminStockLocationListResponse>
) => {
