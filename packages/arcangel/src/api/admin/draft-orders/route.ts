...
export const GET = async (
  req: ArcangelRequest<HttpTypes.AdminDraftOrderListParams>,
  res: ArcangelResponse<HttpTypes.AdminDraftOrderListResponse>
) => {
  const variables = {
    filters: {
...
export const POST = async (
  ...
  >,
  res: ArcangelResponse<HttpTypes.AdminDraftOrderResponse>
) => {
