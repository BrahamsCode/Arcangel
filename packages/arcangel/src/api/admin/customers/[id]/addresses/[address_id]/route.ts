...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminCustomerAddressParams>,
  res: ArcangelResponse<HttpTypes.AdminCustomerAddressResponse>
) => {
...
export const DELETE = async (
  ...
  res: ArcangelResponse<HttpTypes.AdminCustomerAddressDeleteResponse>
) => {
