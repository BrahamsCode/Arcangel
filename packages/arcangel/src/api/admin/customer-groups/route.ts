...
import { createCustomerGroupsWorkflow } from "@arcangel/core-flows"
import {
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminGetCustomerGroupsParams>,
  res: ArcangelResponse<HttpTypes.AdminCustomerGroupListResponse>
) => {
