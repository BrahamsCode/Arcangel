...
import { ISettingsModuleService } from "@arcangel/framework/types"
...
export const GET = async (
  ...
  res: ArcangelResponse<HttpTypes.AdminLayoutConfigurationResponse>
) => {
...
export const POST = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminSetLayoutConfiguration>,
  res: ArcangelResponse<HttpTypes.AdminLayoutConfigurationResponse>
) => {
