import { createPriceListsWorkflow } from "@arcangel/core-flows"
import {
...
export const GET = async (
  req: AuthenticatedArcangelRequest<HttpTypes.AdminPriceListListParams>,
  res: ArcangelResponse<HttpTypes.AdminPriceListListResponse>
) => {
