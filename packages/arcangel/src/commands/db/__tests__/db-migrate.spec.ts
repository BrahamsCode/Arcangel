...
jest.mock("@arcangel/framework", () => ({
  ARCANGEL_CLI_PATH: "/mock/cli",
  ArcangelAppLoader: jest.fn().mockImplementation(() => ({
...
describe("db:migrate – main", () => {
  ...
  describe("successful migration", () => {
    ...
    it("uses the resolved logger to report migration-phase errors", async () => {
      ...
      const { ArcangelAppLoader } = require("@arcangel/framework")
      const migrationError = new Error("migration failed")
      ArcangelAppLoader.mockImplementation(() => ({
