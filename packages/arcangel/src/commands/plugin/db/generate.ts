import { logger } from "@arcangel/framework"
import type { Logger } from "@arcangel/framework/types"
import {
...
import { MetadataStorage } from "@arcangel/framework/mikro-orm/core"
import { MikroORM } from "@arcangel/framework/mikro-orm/postgresql"
...
async function generateMigrations(
  ...
  for (const moduleDescriptor of moduleDescriptors) {
    ...
    if (result.fileName) {
      ...
      // See: https://github.com/arcangel/arcangel/issues/14410
