import { container, ArcangelAppLoader } from "@arcangel/framework"
import { IModuleService, Logger } from "@arcangel/framework/types"
import {
...
export class ModuleReloader extends BaseReloader {
  ...
  async reload(
    ...
    try {
      ...
      const newModuleInstance = (await arcangelAppLoader.reloadSingleModule({
        moduleKey,
        serviceName,
