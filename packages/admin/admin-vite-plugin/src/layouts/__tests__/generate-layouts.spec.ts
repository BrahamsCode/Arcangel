...
const validLayoutFile = `
    import { defineLayoutConfig } from "@arcangel/admin-sdk"
...
describe("generateLayouts", () => {
  it("should generate layouts", async () => {
    const mockFiles = ["Users/user/arcangel/src/admin/layouts/layout.tsx"]
  ...
  it("should handle windows paths", async () => {
    const mockFiles = ["C:\\arcangel\\src\\admin\\layouts\\layout.tsx"]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
    ...
    const result = await generateLayouts(new Set(["C:\\arcangel\\src\\admin"]))
  ...
  it("should generate multiple layouts", async () => {
    const mockFiles = [
      "Users/user/arcangel/src/admin/layouts/one.tsx",
      "Users/user/arcangel/src/admin/layouts/two.tsx",
    ]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
