...
describe("generateMenuItems", () => {
  it("should generate menu items", async () => {
    const mockFiles = [
      "Users/user/arcangel/src/admin/routes/one/page.tsx",
      "Users/user/arcangel/src/admin/routes/two/page.tsx",
      "Users/user/arcangel/src/admin/routes/three/page.tsx",
    ]
    ...
    const result = await generateMenuItems(
      new Set(["Users/user/arcangel/src/admin"])
    )

    expect(result.imports).toEqual([
      `import { config as RouteConfig0 } from "Users/user/arcangel/src/admin/routes/one/page.tsx"`,
      `import { config as RouteConfig1 } from "Users/user/arcangel/src/admin/routes/two/page.tsx"`,
      `import { config as RouteConfig2 } from "Users/user/arcangel/src/admin/routes/three/page.tsx"`,
    ])
  ...
  it("should handle windows paths", async () => {
    // Setup mocks
    const mockFiles = [
      "C:\\arcangel\\src\\admin\\routes\\one\\page.tsx",
      "C:\\arcangel\\src\\admin\\routes\\two\\page.tsx",
      "C:\\arcangel\\src\\admin\\routes\\three\\page.tsx",
    ]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
    ...
    const result = await generateMenuItems(new Set(["C:\\arcangel\\src\\admin"]))

    expect(result.imports).toEqual([
      `import { config as RouteConfig0 } from "C:/arcangel/src/admin/routes/one/page.tsx"`,
      `import { config as RouteConfig1 } from "C:/arcangel/src/admin/routes/two/page.tsx"`,
      `import { config as RouteConfig2 } from "C:/arcangel/src/admin/routes/three/page.tsx"`,
    ])
    expect(utils.normalizeString(result.code)).toEqual(
      utils.normalizeString(expectedMenuItems)
    )
  ...
  it("should include rank property in generated menu items", async () => {
    const mockFilesWithRank = [
      "Users/user/arcangel/src/admin/routes/analytics/page.tsx",
      "Users/user/arcangel/src/admin/routes/reports/page.tsx",
    ]
  ...
  it("should handle translationNs field", async () => {
    ...
    const mockFiles = ["Users/user/arcangel/src/admin/routes/custom/page.tsx"]
    vi.mocked(utils.crawl).mockResolvedValue(mockFiles)
    ...
    expect(result.imports).toEqual([
      `import { config as RouteConfig0 } from "Users/user/arcangel/src/admin/routes/custom/page.tsx"`,
    ])
  ...
  it("should handle mixed ranked and unranked routes", async () => {
    const mockMixedFiles = [
      "Users/user/arcangel/src/admin/routes/first/page.tsx",
      "Users/user/arcangel/src/admin/routes/second/page.tsx",
      "Users/user/arcangel/src/admin/routes/third/page.tsx",
    ]
