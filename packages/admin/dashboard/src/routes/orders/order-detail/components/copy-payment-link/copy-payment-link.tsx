import { CheckCircleSolid, SquareTwoStack } from "@arcangel/icons"
import { AdminOrder, AdminPaymentCollection } from "@arcangel/types"
import { Button, Tooltip } from "@arcangel/ui"
import copy from "copy-to-clipboard"
import React, { useState } from "react"
import { useTranslation } from "react-i18next"
import { getStylizedAmount } from "../../../../../lib/money-amount-helpers"
import { ARCANGEL_STOREFRONT_URL } from "../../../../../lib/storefront"
...
const CopyPaymentLink = React.forwardRef<any, CopyPaymentLinkProps>(
  ({ paymentCollection, order }: CopyPaymentLinkProps, ref) => {
    ...
    const copyToClipboard = async (
      ...
      setDone(true)
      copy(
        `${ARCANGEL_STOREFRONT_URL}/payment-collection/${paymentCollection.id}?order_id=${order.id}`
      )
