...
import { Alert, Button, Heading, Hint, Input, Text, toast } from "@arcangel/ui"
...
import { AuthLoginResponse } from "@arcangel/js-sdk"
...
const CreateView = ({
  ...
  const isFirstRun = params.get("first_run") === "true" // true when the invite page is open during a "create arcangel app" run
