import type { CustomFieldModelFormMap } from "@arcangel/admin-shared"
 ...
 * @example
 * ```ts
 * import { unstable_createFormHelper, unstable_defineCustomFieldsConfig } from "@arcangel/admin-sdk"
 * import type { HttpTypes } from "@arcangel/types"
