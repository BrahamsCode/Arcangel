/**
 * Guards the CJS build of @arcangel/admin-bundler against esbuild rewriting
 ...
 * `arcangel develop` / `arcangel build` / `arcangel plugin:build` invocation. This
...
if (failures.length) {
  console.error(
    [
      ...
      "",
      "Do NOT convert this package to ESM — @arcangel/framework requires it from CJS.",
    ].join("\n")
  )
  process.exit(1)
}
