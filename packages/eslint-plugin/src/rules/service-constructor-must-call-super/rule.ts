...
export const rule = createRule<[], MessageIds>({
  ...
  meta: {
    ...
    docs: {
      description:
        "A service that extends `ArcangelService(...)` and defines a constructor must call `super(...arguments)`.",
    },
    fixable: "code",
    messages: {
      missingSuperCall:
        "A constructor on a class extending `ArcangelService(...)` must call `super(...arguments)`.",
    },
    schema: [],
  },
  defaultOptions: [],
