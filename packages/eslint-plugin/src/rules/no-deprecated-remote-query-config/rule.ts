...
function typeReferencesRequest(
  ...
  // Support `HttpTypes.ArcangelRequest`, `HttpTypes.AuthenticatedArcangelRequest`.
  if (
...
export const rule = createRule<[], MessageIds>({
  ...
  meta: {
    ...
    docs: {
      description:
        "Disallow `req.remoteQueryConfig`; use `req.queryConfig` instead (deprecated since Arcangel v2.2.0).",
    },
    fixable: "code",
    messages: {
