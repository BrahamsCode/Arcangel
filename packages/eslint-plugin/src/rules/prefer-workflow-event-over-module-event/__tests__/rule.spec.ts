...
ruleTester.run("prefer-workflow-event-over-module-event", rule, {
  valid: [
    ...
    {
      code: `
        import { ProductCategoryWorkflowEvents } from "@arcangel/framework/utils"
        export const config = {
    ...
    {
      code: `
        import { AuthEvents } from "@arcangel/framework/utils"
    ...
    {
      code: `
        import { ProductEvents } from "@arcangel/framework/utils"
...
export const config = {
  event: ProductEvents.PRODUCT_CATEGORY_DELETED,
      ...
      output: `
import { ProductEvents, ProductCategoryWorkflowEvents } from "@arcangel/framework/utils"
export const config = {
  event: ProductCategoryWorkflowEvents.DELETED,
}
      `,
    ...
    {
      code: `
import { ProductEvents as PE } from "@arcangel/framework/utils"
export const config = { event: PE.PRODUCT_CATEGORY_DELETED }
      `,
      errors: [{ messageId: "preferWorkflowEvent" }],
      output: `
import { ProductEvents as PE, ProductCategoryWorkflowEvents } from "@arcangel/framework/utils"
export const config = { event: ProductCategoryWorkflowEvents.DELETED }
    ...
    {
      code: `
import * as utils from "@arcangel/framework/utils"
...
export const config = { event: ProductCategoryWorkflowEvents.DELETED }
    ...
    // fresh import added.
    {
      ...
      output: `import { ProductCategoryWorkflowEvents } from "@arcangel/framework/utils"
export const config = { event: ProductCategoryWorkflowEvents.DELETED }`,
    },
    // A different module enum with a workflow equivalent.
    {
      code: `
import { UserEvents } from "@arcangel/framework/utils"
export const config = { event: UserEvents.USER_CREATED }
      ...
      output: `
import { UserEvents, UserWorkflowEvents } from "@arcangel/framework/utils"
...
export { config }
    ...
    {
      code: `
import { FulfillmentEvents } from "@arcangel/framework/utils"
