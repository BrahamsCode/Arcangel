...
const FORBIDDEN_ADMIN_IMPORTS = new Set([
  "@arcangel/framework/utils",
  "@arcangel/framework/http",
...
export const rule = createRule<[], MessageIds>({
  name: "admin-no-arcangel-utils-import",
  meta: {
    type: "problem",
    docs: {
      description:
        "Don't import Node-only framework modules (`@arcangel/framework/utils`, `@arcangel/framework/http`, `@arcangel/framework/workflows-sdk`) in admin code — they break the browser bundle.",
    },
    messages: {
