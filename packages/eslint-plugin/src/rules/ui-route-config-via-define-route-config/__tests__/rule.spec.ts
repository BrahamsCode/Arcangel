...
ruleTester.run("ui-route-config-via-define-route-config", rule, {
  valid: [
    ...
    {
      code: `import { defineRouteConfig } from "@arcangel/admin-sdk"
...
export default CustomPage`,
    ...
    {
      code: `import { defineRouteConfig as drc } from "@arcangel/admin-sdk"
const CustomPage = () => null
...
export default CustomPage`,
    ...
    {
      code: `import { defineRouteConfig } from "@arcangel/admin-sdk"
import type { RouteConfig } from "@arcangel/admin-sdk"
const CustomPage = () => null
