...
ruleTester.run("no-conditional-expressions-in-workflow", rule, {
  valid: [
    ...
    {
      code: `
        import { createWorkflow, createStep } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, transform } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, when } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, transform, when } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, createStep, when } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
          when({ input }, (data) => true).then(() => {
            const step = createStep("s", () => {
              const v = input ? 1 : 2
  ...
  invalid: [
    ...
    {
      code: `
        import { createWorkflow as cw } from "@arcangel/framework/workflows-sdk"
    ...
    {
      code: `
        import { createWorkflow, when as w } from "@arcangel/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
