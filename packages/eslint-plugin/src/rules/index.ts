...
import { rule as adminNoArcangelUtilsImport } from "./admin-no-arcangel-utils-import"
...
import { rule as arcangelContextOnContextParam } from "./arcangel-context-on-context-param"
...
import { rule as useArcangelErrorNotGenericError } from "./use-arcangel-error-not-generic-error"
...
export const rules = {
  ...
  "admin-no-arcangel-utils-import": adminNoArcangelUtilsImport,
  ...
  "arcangel-context-on-context-param": arcangelContextOnContextParam,
  ...
  "use-arcangel-error-not-generic-error": useArcangelErrorNotGenericError,
