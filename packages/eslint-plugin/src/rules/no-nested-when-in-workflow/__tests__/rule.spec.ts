...
ruleTester.run("no-nested-when-in-workflow", rule, {
  valid: [
    ...
    {
      code: `
        import { createWorkflow, when, createStep } from "@arcangel/framework/workflows-sdk"
  ...
  invalid: [
    ...
    {
      code: `
        import { createWorkflow, when, WorkflowResponse } from "@arcangel/framework/workflows-sdk"
