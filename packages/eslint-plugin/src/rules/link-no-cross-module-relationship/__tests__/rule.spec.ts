...
ruleTester.run("link-no-cross-module-relationship", rule, {
  valid: [
    ...
    {
      code: `
        import { model } from "@arcangel/framework/utils"
    ...
    {
      code: `
        import { model as m } from "@arcangel/framework/utils"
    ...
    // Non-framework `model` import — out of scope.
    {
      code: `
        ...
        import Other from "@arcangel/other/models/other"
  ...
  invalid: [
    // belongsTo across modules.
    {
      code: `
        import { model } from "@arcangel/framework/utils"
        import Product from "@arcangel/arcangel/product/models/product"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Product",
            source: "@arcangel/arcangel/product/models/product",
          },
        },
      ],
    },
    // hasMany across modules.
    {
      code: `
        import { model } from "@arcangel/framework/utils"
        import { Customer } from "@arcangel/customer"
    ...
    // Block body with single return targeting an external import.
    {
      code: `
        import { model } from "@arcangel/framework/utils"
        import Other from "@arcangel/other"
        export default model.define("x", {
    ...
    // Aliased model import.
    {
      code: `
        import { model as m } from "@arcangel/framework/utils"
        import Foreign from "@arcangel/other/models/foreign"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Foreign",
            source: "@arcangel/other/models/foreign",
          },
        },
      ],
    },
