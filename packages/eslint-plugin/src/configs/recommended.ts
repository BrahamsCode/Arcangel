  ...
  return [
    ...
    tsParserBlock(),
    {
      ...
      rules: {
        ...
        [ruleId("use-arcangel-error-not-generic-error")]: "warn",
    ...
    },
    {
      ...
      rules: {
        ...
        [ruleId("admin-no-arcangel-utils-import")]: "error",
      },
    },
    {
      files: [
    ...
    {
      // Direct descendants of `subscribers/` only — Arcangel loads a subscriber
    ...
    {
      // Direct descendants of `jobs/` only — Arcangel loads a scheduled job from
