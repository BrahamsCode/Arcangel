 ...
 * are exposed to consumers (e.g. `"@arcangel/no-async-workflow-constructor"`).
 *
 ...
 */
export const PLUGIN_NAMESPACE = "@arcangel"
...
export const FRAMEWORK_UTILS_SOURCE = "@arcangel/framework/utils"
export const WORKFLOWS_SDK_SOURCE = "@arcangel/framework/workflows-sdk"
export const FRAMEWORK_TYPES_SOURCE = "@arcangel/framework/types"
export const FRAMEWORK_HTTP_SOURCE = "@arcangel/framework/http"
export const LEGACY_TYPES_SOURCE = "@arcangel/types"
export const ADMIN_SDK_SOURCE = "@arcangel/admin-sdk"

/** All sources that expose Arcangel type declarations. */
export const TYPES_SOURCES: ReadonlySet<string> = new Set([
  FRAMEWORK_TYPES_SOURCE,
  LEGACY_TYPES_SOURCE,
])

/** The name of the `Modules` enum as imported from `@arcangel/framework/utils`. */
