 ...
 * within a Arcangel resource such as an API Route or a Subscriber.
 *
 * For example:
 *
 * ```ts
...
export type ReturnWorkflow<TData, TResult, THooks extends any[]> = {
   ...
   *
   * Learn more in [this documentation](https://docs.arcangel.com/learn/fundamentals/workflows/execute-another-workflow).
   *
   ...
   *
   * Learn more in [this documentation](https://docs.arcangel.com/learn/fundamentals/workflows/workflow-hooks#how-to-consume-a-hook).
   */
