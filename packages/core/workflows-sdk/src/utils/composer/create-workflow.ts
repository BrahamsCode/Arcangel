...
global[OrchestrationUtils.SymbolArcangelWorkflowComposerContext] = null
...
export function createWorkflow<TData, TResult, THooks extends any[]>(
  ...
  const context: CreateWorkflowComposerContext = {
    __type: OrchestrationUtils.SymbolArcangelWorkflowComposerContext,
    workflowId: name,
  ...
  global[OrchestrationUtils.SymbolArcangelWorkflowComposerContext] = context
  ...
  delete global[OrchestrationUtils.SymbolArcangelWorkflowComposerContext]
