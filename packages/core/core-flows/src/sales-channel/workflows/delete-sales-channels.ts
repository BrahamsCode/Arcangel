import { Modules, SalesChannelWorkflowEvents } from "@arcangel/framework/utils"
import {
  createWorkflow,
  transform,
  WorkflowData,
 ...
 * [Delete Sales Channel Admin API Route](https://docs.arcangel.com/api/admin/sales-channels/delete-a-sales-channel).
 * 
