...
import { SalesChannelWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Update Sales Channel Admin API Route](https://docs.arcangel.com/api/admin/sales-channels/update-a-sales-channel).
 * 
