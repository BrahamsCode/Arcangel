import type { BigNumberInput, PaymentDTO } from "@arcangel/framework/types"
import {
  BigNumber,
  defaultCurrencies,
 ...
 * :::note
 *
 * You can retrieve a payment's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
