...
import { CreateTranslationDTO, UpdateTranslationDTO } from "@arcangel/types"
 ...
 * [Manage Translations Admin API Route](https://docs.arcangel.com/api/admin/translations/manage-translations).
 *
