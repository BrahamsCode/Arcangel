...
export interface ReleaseLockStepInput {
   ...
   * the default provider (in-memory or the provider configured in arcangel-config.ts) will be used.
   */
  provider?: string
...
/**
 * This step releases a lock for a given key. Learn more about locks in the [Locking Module](https://docs.arcangel.com/resources/infrastructure-modules/locking)
 * guide.
 *
 * @example
