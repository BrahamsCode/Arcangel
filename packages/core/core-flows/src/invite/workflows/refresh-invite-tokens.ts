import type { InviteDTO, InviteWorkflow } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Refresh Invite Token Admin API Route](https://docs.arcangel.com/api/admin/invites/refresh-invite-token).
 *
 * This workflow is useful to trigger resending invite tokens. It emits the `invite.resent` event,
 * which you can listen to in a [Subscriber](https://docs.arcangel.com/learn/fundamentals/events-and-subscribers).
 *
