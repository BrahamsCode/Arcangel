import type { InviteWorkflow, UserDTO } from "@arcangel/framework/types"
import { InviteWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Accept Invite Admin API Route](https://docs.arcangel.com/api/admin/invites/accept-invite).
 *
 ...
 * using the [Retrieve Registration JWT Token API Route](https://docs.arcangel.com/api/admin/auth/retrieve-registration-jwt-token).
 *
