import type { CreateTaxRateDTO, TaxRateDTO } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Create Tax Rates Admin API Route](https://docs.arcangel.com/api/admin/tax-rates/create-tax-rate).
 *
