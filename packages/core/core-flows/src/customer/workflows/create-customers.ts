...
import { CustomerWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow creates one or more customers. It's used by the [Create Customer Admin API Route](https://docs.arcangel.com/api/admin/customers/create-customer).
 *
 * This workflow has a hook that allows you to perform custom actions on the created customer. You can see an example in [this guide](https://docs.arcangel.com/resources/commerce-modules/customer/extend).
 *
