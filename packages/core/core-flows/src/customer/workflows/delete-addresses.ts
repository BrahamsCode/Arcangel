 ...
 * [Remove Customer Addresses Admin API Route](https://docs.arcangel.com/api/admin/customers/remove-an-address-from-customer)
 * and the [Remove Customer Addresses Store API Route](https://docs.arcangel.com/api/store/customers/remove-address).
 * 
 * :::note
 * 
 * This workflow deletes addresses created by the [Customer Module](https://docs.arcangel.com/resources/commerce-modules/customer)
