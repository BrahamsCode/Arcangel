import type { CreateCustomerDTO, CustomerDTO } from "@arcangel/framework/types"
import {
  createWorkflow,
  transform,
  WorkflowData,
 ...
 * [Register Customer Store API Route](https://docs.arcangel.com/api/store/customers/register-customer).
 *
 * You can create an auth identity first using the [Retrieve Registration JWT Token API Route](https://docs.arcangel.com/api/store/auth/retrieve-registration-jwt-token).
 * Learn more about basic authentication flows in [this documentation](https://docs.arcangel.com/resources/commerce-modules/auth/authentication-route).
 *
