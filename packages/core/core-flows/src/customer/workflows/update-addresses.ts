...
/**
 * This workflow updates one or more addresses for customers. It's used by the [Update Customer Address Admin API Route](https://docs.arcangel.com/api/admin/customers/update-address)
 * and the [Update Customer Address Store API Route](https://docs.arcangel.com/api/store/customers/update-address).
 * 
