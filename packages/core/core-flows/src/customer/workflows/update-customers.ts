...
/**
 * This workflow updates one or more customers. It's used by the [Update Customer Admin API Route](https://docs.arcangel.com/api/admin/customers/update-a-customer) and
 * the [Update Customer Store API Route](https://docs.arcangel.com/api/store/customers/update-customer).
 * 
