...
/**
 * This workflow creates one or more addresses for customers. It's used by the [Add Customer Address Admin API Route](https://docs.arcangel.com/api/admin/customers/add-address)
 * and the [Add Customer Address Store API Route](https://docs.arcangel.com/api/store/customers/create-address).
 * 
