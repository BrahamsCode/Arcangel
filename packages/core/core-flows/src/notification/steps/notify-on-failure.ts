import type { INotificationModuleService } from "@arcangel/framework/types"
...
export type NotifyOnFailureStepInput = {
   ...
   * A [Notification Module Provider](https://docs.arcangel.com/resources/infrastructure-modules/notification)
