...
import { createStep, StepResponse } from "@arcangel/workflows-sdk"
 ...
 * :::note
 *
 * You can retrieve cart or shipping option's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
