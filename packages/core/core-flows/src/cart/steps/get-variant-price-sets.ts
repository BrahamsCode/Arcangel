import { ArcangelContainer, Query } from "@arcangel/framework"
import {
  CalculatedPriceSet,
...
export interface GetVariantPriceSetsStepInput {
   ...
   *
   * Learn more in [this documentation](https://docs.arcangel.com/resources/commerce-modules/product/guides/price#retrieve-calculated-price-for-a-context).
   */
