 ...
 * [Complete Cart Store API Route](https://docs.arcangel.com/api/store/carts/complete-cart).
 *
 ...
 * For example, in the [Subscriptions recipe](https://docs.arcangel.com/resources/recipes/subscriptions/examples/standard#create-workflow),
 ...
 * [entry point of the link](https://docs.arcangel.com/learn/fundamentals/module-links/custom-columns#method-2-using-entry-point)
 ...
 *
 * ```ts
 * import { createStep, StepResponse } from "@arcangel/framework/workflows-sdk"
 * import { ArcangelError } from "@arcangel/framework/utils"
 * import { cancelOrderWorkflow } from "@arcangel/arcangel/core-flows"
 *
 * type StepInput = {
 *   order_id: string
 *   // other input fields...
 ...
 *   WorkflowResponse
 * } from "@arcangel/framework/workflows-sdk"
 * import { useQueryGraphStep } from "@arcangel/framework/workflows-sdk"
