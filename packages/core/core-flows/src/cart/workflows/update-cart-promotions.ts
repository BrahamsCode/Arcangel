import { PromotionActions } from "@arcangel/framework/utils"
import {
  createHook,
  createWorkflow,
  parallelize,
 ...
 * [Add Promotions Store API Route](https://docs.arcangel.com/api/store/carts/add-promotions).
 *
 ...
 *     cart_id: "cart_123",
 *     promo_codes: ["10OFF"],
 *     // imported from @arcangel/framework/utils
