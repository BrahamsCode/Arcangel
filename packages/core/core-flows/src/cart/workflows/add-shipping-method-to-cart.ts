import { CartWorkflowEvents, ArcangelError } from "@arcangel/framework/utils"
import {
  createHook,
  createWorkflow,
  parallelize,
...
export interface AddShippingMethodToCartWorkflowInput {
  ...
  options: {
     ...
     *
     * Learn more in [this documentation](https://docs.arcangel.com/resources/commerce-modules/fulfillment/shipping-option#data-property).
     */
 ...
 * [Add Shipping Method Store API Route](https://docs.arcangel.com/api/store/carts/add-shipping-method).
 *
