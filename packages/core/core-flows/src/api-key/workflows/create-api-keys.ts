import type { ApiKeyDTO, CreateApiKeyDTO } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Create API Key Admin API Route](https://docs.arcangel.com/api/admin/api-keys/create-api-key).
 *
