import type { LinkWorkflowInput } from "@arcangel/framework/types"
import { WorkflowData, createWorkflow, transform } from "@arcangel/framework/workflows-sdk"
import {
 ...
 * [Manage Sales Channels API Route](https://docs.arcangel.com/api/admin/api-keys/manage-sales-channels).
 *
