import type { CreateUserDTO, UserDTO } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 *
 * You can create an auth identity first using the [Retrieve Registration JWT Token API Route](https://docs.arcangel.com/api/admin/auth/retrieve-registration-jwt-token).
