import { Modules, RegionWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  createWorkflow,
  transform,
 ...
 * [Delete Region Admin API Route](https://docs.arcangel.com/api/admin/regions/delete-a-region).
 *
