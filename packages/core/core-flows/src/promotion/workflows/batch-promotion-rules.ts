 ...
 * [Manage Promotion Rules Admin API Route](https://docs.arcangel.com/api/admin/promotions/manage-rules),
 * [Manage Promotion Buy Rules Admin API Route](https://docs.arcangel.com/api/admin/promotions/manage-buy-rules),
 * and [Manage Promotion Target Rules Admin API Route](https://docs.arcangel.com/api/admin/promotions/manage-target-rules).
 * 
