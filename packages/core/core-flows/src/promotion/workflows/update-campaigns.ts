...
/**
 * This workflow updates one or more campaigns. It's used by the [Update Campaign Admin API Route](https://docs.arcangel.com/api/admin/campaigns/update-a-campaign).
 *
