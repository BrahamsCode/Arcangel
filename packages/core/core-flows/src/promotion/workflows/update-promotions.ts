...
import { isString } from "@arcangel/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
...
/**
 * This workflow updates one or more promotions. It's used by the [Update Promotion Admin API Route](https://docs.arcangel.com/api/admin/promotions/update-a-promotion).
 *
