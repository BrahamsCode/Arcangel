import type { StoreDTO, StoreWorkflow } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
...
/**
 * This workflow creates one or more stores. By default, Arcangel uses a single store. This is useful
