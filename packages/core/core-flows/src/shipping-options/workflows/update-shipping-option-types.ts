...
import { ShippingOptionTypeWorkflowEvents } from "@arcangel/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
 ...
 * [Update Shipping Option Type Admin API Route](https://docs.arcangel.com/api/admin/shipping-option-types/update-a-shipping-option-type).
 *
