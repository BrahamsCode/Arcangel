 ...
 * [Delete File Upload Admin API Route](https://docs.arcangel.com/api/admin/uploads/delete-a-file).
 * 
 * The [File Module Provider](https://docs.arcangel.com/resources/infrastructure-modules/file) installed
