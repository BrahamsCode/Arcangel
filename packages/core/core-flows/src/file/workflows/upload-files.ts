import type { FileDTO } from "@arcangel/framework/types"
import {
  createWorkflow,
  WorkflowData,
  WorkflowResponse,
 ...
 * [File Module Provider](https://docs.arcangel.com/resources/infrastructure-modules/file). The workflow is used by the
 * [Upload Files Admin API Route](https://docs.arcangel.com/api/admin/uploads/upload-files).
 *
