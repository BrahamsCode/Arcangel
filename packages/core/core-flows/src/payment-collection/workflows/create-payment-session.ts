...
import { isPresent, Modules } from "@arcangel/framework/utils"
import {
  createWorkflow,
  parallelize,
  transform,
...
export interface CreatePaymentSessionsWorkflowInput {
   ...
   * Learn more in [this documentation](https://docs.arcangel.com/resources/commerce-modules/payment/payment-session#data-property).
   */
 ...
 * [Initialize Payment Session Store API Route](https://docs.arcangel.com/api/store/payment-collections/initialize-payment-session).
 *
