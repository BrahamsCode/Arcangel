...
import { WorkflowData, createWorkflow, WorkflowResponse } from "@arcangel/framework/workflows-sdk"
 ...
 * [Delete Price Preferences Admin API Route](https://docs.arcangel.com/api/admin/price-preferences/delete-a-price-preference).
 *
