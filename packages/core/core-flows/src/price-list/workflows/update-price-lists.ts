import type { UpdatePriceListWorkflowInputDTO } from "@arcangel/framework/types"
 ...
 * [Update Price List Admin API Route](https://docs.arcangel.com/api/admin/price-lists/update-a-price-list).
 *
