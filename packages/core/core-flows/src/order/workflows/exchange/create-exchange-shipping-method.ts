 ...
 * :::note
 *
 * You can retrieve an order, order exchange, and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * It's used by the [Add Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/add-inbound-shipping)
 * and the [Add Outbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/add-outbound-shipping).
 *
