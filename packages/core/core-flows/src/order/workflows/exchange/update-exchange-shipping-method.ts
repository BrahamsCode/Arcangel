 ...
 * :::note
 *
 * You can retrieve an order exchange and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Update Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/update-inbound-shipping)
 * or the [Outbound Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/update-outbound-shipping).
 *
 ...
 * 
 * ```ts
 * import { updateExchangeShippingMethodWorkflow } from "@arcangel/arcangel/core-flows";
