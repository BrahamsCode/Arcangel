 ...
 * [Remove Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/remove-inbound-shipping-method) or
 * the [Remove Outbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/exchanges/remove-outbound-shipping-method).
 * 
