import type { PaymentCollectionDTO } from "@arcangel/framework/types"
 ...
 * :::note
 *
 * You can retrieve a payment collection's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Mark Payment Collection as Paid Admin API Route](https://docs.arcangel.com/api/admin/payment-collections/mark-as-paid).
 *
