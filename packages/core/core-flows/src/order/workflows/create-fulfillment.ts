 ...
 * :::note
 *
 * You can retrieve an order's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
...
/**
 * This workflow creates a fulfillment for an order. It's used by the [Create Order Fulfillment Admin API Route](https://docs.arcangel.com/api/admin/orders/create-fulfillment).
 *
 ...
 * Reservations are created automatically when an order is placed through the [completeCartWorkflow](https://docs.arcangel.com/resources/references/arcangel-workflows/completeCartWorkflow).
 ...
 * using the [createReservationsWorkflow](https://docs.arcangel.com/resources/references/arcangel-workflows/createReservationsWorkflow) before creating the fulfillment,
