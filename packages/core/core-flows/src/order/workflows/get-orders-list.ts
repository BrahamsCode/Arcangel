import type { OrderDetailDTO, OrderDTO } from "@arcangel/framework/types"
import { deduplicate } from "@arcangel/framework/utils"
import {
  createWorkflow,
  transform,
  WorkflowData,
...
export type GetOrdersListWorkflowInput = {
   ...
   * are passed to [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [List Orders Admin API Route](https://docs.arcangel.com/api/admin/orders/list-orders), and the
 * [List Orders Store API Route](https://docs.arcangel.com/api/store/orders/list-orders).
 *
