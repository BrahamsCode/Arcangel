import type { AdditionalData, CreateOrderDTO } from "@arcangel/framework/types"
import {
  PromotionActions,
  deduplicate,
  isDefined,
...
/**
 * This workflow creates an order. It's used by the [Create Draft Order Admin API Route](https://docs.arcangel.com/api/admin/draft-orders/create-draft-order), but
 ...
 * you can create a workflow that imports orders from an external system, then uses this workflow to create the orders in Arcangel.
 *
 * :::note
 *
 ...
 * as they don't have an associated reservation. To create the reservations, use the [createReservationsWorkflow](https://docs.arcangel.com/resources/references/arcangel-workflows/createReservationsWorkflow)
 ...
 *
 * ```ts
 * import { createOrderWorkflow } from "@arcangel/arcangel/core-flows";
