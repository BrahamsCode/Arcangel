 ...
 * :::note
 *
 * You can retrieve an order and fulfillment's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Mark Fulfillment as Delivered Admin API Route](https://docs.arcangel.com/api/admin/orders/mark-delivered).
 *
