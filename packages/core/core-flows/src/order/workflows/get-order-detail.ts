import type { OrderDetailDTO } from "@arcangel/framework/types"
 ...
 * [Get an Order Admin API Route](https://docs.arcangel.com/api/admin/orders/get-an-order), and
 * [Get an Order Store API Route](https://docs.arcangel.com/api/store/orders/get-an-order).
 *
