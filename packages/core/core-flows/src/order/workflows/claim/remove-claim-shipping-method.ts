 ...
 * It's used by the [Remove Inbound Shipping Method](https://docs.arcangel.com/api/admin/claims/remove-inbound-shipping-method),
 * or [Remove Outbound Shipping Method](https://docs.arcangel.com/api/admin/claims/remove-outbound-shipping-method) Admin API Routes.
 * 
