...
import { ChangeActionType, OrderChangeStatus } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * :::note
 *
 * You can retrieve an order claim and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 * or [useQueryGraphStep](https://docs.arcangel.com/resources/references/arcangel-workflows/steps/useQueryGraphStep).
 *
 * :::
 *
 * @example
 ...
 * It's used by the [Update Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/claims/update-inbound-shipping),
 * and the [Update Outbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/claims/update-outbound-shipping).
 *
 ...
 * 
 * ```ts
 * import { updateClaimShippingMethodWorkflow } from "@arcangel/arcangel/core-flows";
 * import { StepResponse } from "@arcangel/workflows-sdk";
 * 
 ...
 * :::note
 * 
 * Learn more about prices calculation context in the [Prices Calculation](https://docs.arcangel.com/resources/commerce-modules/pricing/price-calculation) documentation.
 * 
 * :::
 */
