 ...
 * :::note
 *
 * You can retrieve an order claim's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Cancel Claim API Route](https://docs.arcangel.com/api/admin/claims/cancel-a-claim).
 *
