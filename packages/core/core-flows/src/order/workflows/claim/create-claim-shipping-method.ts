 ...
 * :::note
 *
 * You can retrieve an order, order claim, and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * It's used by the [Add Inbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/claims/add-inbound-shipping),
 * and the [Add Outbound Shipping Admin API Route](https://docs.arcangel.com/api/admin/claims/add-outbound-shipping).
 *
