import type { OrderDTO, OrderWorkflow } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createStep,
...
import type { CustomerDTO, OrderPreviewDTO } from "@arcangel/framework/types"
 ...
 * :::note
 *
 * You can retrieve an order and customer details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 *
 * This workflow is used by the [Request Order Transfer Store API Route](https://docs.arcangel.com/api/store/orders/request-order-transfer),
 * and the [Request Order Transfer Admin API Route](https://docs.arcangel.com/api/admin/orders/request-transfer).
 *
