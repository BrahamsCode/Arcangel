 ...
 * This workflow is used by the [Cancel Order Transfer Store API Route](https://docs.arcangel.com/api/store/orders/cancel-transfer),
 * and the [Cancel Transfer Request Admin API Route](https://docs.arcangel.com/api/admin/orders/cancel-transfer).
 *
