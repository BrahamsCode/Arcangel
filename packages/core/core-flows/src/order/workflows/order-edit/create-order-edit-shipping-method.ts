 ...
 * :::note
 *
 * You can retrieve an order and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Add Shipping Method API Route](https://docs.arcangel.com/api/admin/order-edits/add-shipping-method).
 *
 ...
 *
 * ```ts
 * import { createOrderEditShippingMethodWorkflow } from "@arcangel/arcangel/core-flows";
