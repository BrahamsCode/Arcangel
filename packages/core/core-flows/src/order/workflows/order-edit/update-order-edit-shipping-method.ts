 ...
 * :::note
 *
 * You can retrieve an order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Update Shipping Method Admin API Route](https://docs.arcangel.com/api/admin/order-edits/update-shipping-method).
 *
 ...
 *
 * ```ts
 * import { updateOrderEditShippingMethodWorkflow } from "@arcangel/arcangel/core-flows";
