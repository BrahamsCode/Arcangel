 ...
 * :::note
 *
 * You can retrieve a return and order change details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Update Shipping Method Admin API Route](https://docs.arcangel.com/api/admin/returns/update-shipping-method).
 *
 ...
 * 
 * ```ts
 * import { updateReturnShippingMethodWorkflow } from "@arcangel/arcangel/core-flows";
