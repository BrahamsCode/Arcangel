 ...
 * :::note
 *
 * You can retrieve an order details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Create Return Store API Route](https://docs.arcangel.com/api/store/returns/create-return).
 *
 ...
 *
 * ```ts
 * import { createAndCompleteReturnOrderWorkflow } from "@arcangel/arcangel/core-flows";
