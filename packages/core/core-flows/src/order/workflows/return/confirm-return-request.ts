 ...
 * :::note
 *
 * You can retrieve an order, order change, and return details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Confirm Return Request Admin API Route](https://docs.arcangel.com/api/admin/returns/confirm-return-request).
 *
