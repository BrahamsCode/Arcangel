import type { OrderChangeActionDTO } from "@arcangel/framework/types"
...
import type { OrderChangeDTO, OrderWorkflow } from "@arcangel/framework/types"
 ...
 * :::note
 *
 * You can retrieve a draft order change's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
