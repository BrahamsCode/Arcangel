...
import type { PromotionDTO } from "@arcangel/framework/types"
 ...
 * :::note
 *
 * You can retrieve a promotion's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
