...
import { OrderChangeDTO, OrderDTO } from "@arcangel/framework/types"
 ...
 * [Confirm Draft Order Edit Admin API Route](https://docs.arcangel.com/api/admin/draft-orders/confirm-edit).
 *
