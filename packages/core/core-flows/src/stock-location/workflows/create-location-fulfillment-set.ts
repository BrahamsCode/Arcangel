import type { CreateLocationFulfillmentSetWorkflowInputDTO } from "@arcangel/framework/types"
import {
  WorkflowData,
  createWorkflow,
  transform,
 ...
 * [Add Fulfillment Set to Stock Location Admin API Route](https://docs.arcangel.com/api/admin/stock-locations/add-fulfillment-set).
 *
