...
import type { CreateStockLocationInput } from "@arcangel/framework/types"
 ...
 * [Create Stock Location Admin API Route](https://docs.arcangel.com/api/admin/stock-locations/create-stock-location).
 *
