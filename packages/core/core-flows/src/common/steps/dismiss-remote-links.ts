import { Link } from "@arcangel/framework/modules-sdk"
import type { LinkDefinition } from "@arcangel/framework/types"
 ...
 *
 * Learn more in the [Link documentation.](https://docs.arcangel.com/learn/fundamentals/module-links/link#dismiss-link).
 *
 * @example
