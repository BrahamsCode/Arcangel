import { DeleteEntityInput, Link } from "@arcangel/framework/modules-sdk"
 ...
 *
 * Learn more in the [Link documentation](https://docs.arcangel.com/learn/fundamentals/module-links/link#cascade-delete-linked-records)
 *
 * @example
