...
import type { InventoryTypes } from "@arcangel/framework/types"
import { InventoryItemWorkflowEvents } from "@arcangel/framework/utils"
 ...
 * [Update an Inventory Item Admin API Route](https://docs.arcangel.com/api/admin/inventory-items/update-an-inventory-item).
 *
