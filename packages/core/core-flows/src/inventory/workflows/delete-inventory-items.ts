...
import { InventoryItemWorkflowEvents, Modules } from "@arcangel/framework/utils"
 ...
 * [Delete Inventory Item Admin API Route](https://docs.arcangel.com/api/admin/inventory-items/delete-inventory-item).
 *
