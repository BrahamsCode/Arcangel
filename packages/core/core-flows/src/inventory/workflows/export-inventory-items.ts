 ...
 * [Export Inventory Items Admin API Route](https://docs.arcangel.com/api/admin/inventory-items/export-inventory-items).
 *
 * :::note
 *
 * This workflow doesn't return the exported inventory items. Instead, it sends a notification to the admin
 * users that they can download the exported inventory items. Learn more in the [API Reference](https://docs.arcangel.com/api/admin/inventory-items/export-inventory-items).
 *
 * :::
 *
 * @example
