 ...
 * :::note
 *
 * You can retrieve an inventory level's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
 ...
 * [Delete Inventory Levels Admin API Route](https://docs.arcangel.com/api/admin/inventory-items/remove-inventory-level).
 *
