import type { ProductTypes } from "@arcangel/framework/types"
import type { HttpTypes, RegionTypes } from "@arcangel/framework/types"
import { ArcangelError, lowerCaseFirst, normalizeCurrencyCode } from "@arcangel/framework/utils"
 ...
 * 
 * @throws {ArcangelError} When referenced tags or regions are not found
 * 
 * @example
 * ```typescript
