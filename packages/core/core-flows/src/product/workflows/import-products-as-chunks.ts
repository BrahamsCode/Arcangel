import type { WorkflowTypes } from "@arcangel/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Import Products Admin API Route](https://docs.arcangel.com/api/admin/products/create-product-import).
 *
 ...
 *
 * The workflow only starts the import, but you'll have to confirm it using the [Workflow Engine](https://docs.arcangel.com/resources/infrastructure-modules/workflow-engine).
 ...
 *
 * You confirm the import using the [Workflow Engine](https://docs.arcangel.com/resources/infrastructure-modules/workflow-engine).
 ...
 * import type { IWorkflowEngineService } from "@arcangel/framework/types"
 ...
 * :::tip
 *
 * This example API route uses the same implementation as the [Confirm Product Import Admin API Route](https://docs.arcangel.com/api/admin/products/confirm-product-import-2).
 *
 * :::
 *
 * @summary
