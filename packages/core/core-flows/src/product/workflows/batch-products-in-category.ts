import type { ProductCategoryWorkflow } from "@arcangel/framework/types"
 ...
 * [Manage Products of Category Admin API Route](https://docs.arcangel.com/api/admin/product-categories/manage-products).
 *
