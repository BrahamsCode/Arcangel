...
import { ProductTypes } from "@arcangel/framework/types"
import {
 ...
 * It's used by the [Batch Image Variants Admin API Route](https://docs.arcangel.com/api/admin/products/manage-variants-of-product-image).
 *
 ...
 * This is also useful when writing a [seed script](https://docs.arcangel.com/learn/fundamentals/custom-cli-scripts/seed-data) or a custom import script.
 *
 * @since 2.11.2
 *
 * @example
