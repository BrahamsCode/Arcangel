 ...
 * [Manage Products Admin API Route](https://docs.arcangel.com/api/admin/products/manage-products).
 *
 * You can use this workflow within your own customizations or custom workflows to manage products in bulk. This is
 * also useful when writing a [seed script](https://docs.arcangel.com/learn/fundamentals/custom-cli-scripts/seed-data) or a custom import script.
 *
 * @example
