 ...
 * [Manage Variants in a Product Admin API Route](https://docs.arcangel.com/api/admin/products/manage-variants-in-a-product).
 * 
 ...
 * use this within a [seed script](https://docs.arcangel.com/learn/fundamentals/custom-cli-scripts/seed-data) or in a custom import script.
 * 
 * @example
