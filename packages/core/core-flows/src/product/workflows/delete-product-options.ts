import { Modules, ProductOptionWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Option Admin API Route](https://docs.arcangel.com/api/admin/product-options/delete-a-product-option).
 *
