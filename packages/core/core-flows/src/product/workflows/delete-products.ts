import { Modules, ProductWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Products Admin API Route](https://docs.arcangel.com/api/admin/products/delete-a-product).
 *
