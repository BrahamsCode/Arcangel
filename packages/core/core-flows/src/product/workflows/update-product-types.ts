...
import { ProductTypeWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Type Admin API Route](https://docs.arcangel.com/api/admin/product-types/update-a-product-type).
 *
