...
/**
 * This workflow updates one or more products. It's used by the [Update Product Admin API Route](https://docs.arcangel.com/api/admin/products/update-a-product).
 *
