 ...
 * [Export Products Admin API Route](https://docs.arcangel.com/api/admin/products/export-products).
 *
 * :::note
 *
 * This workflow doesn't return the exported products. Instead, it sends a notification to the admin
 * users that they can download the exported products. Learn more in the [API Reference](https://docs.arcangel.com/api/admin/products/export-products).
 *
 * :::
 *
 * @example
