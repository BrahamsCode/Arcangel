...
import { ProductTagWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Tag Admin API Route](https://docs.arcangel.com/api/admin/product-tags/update-a-product-tag).
 *
