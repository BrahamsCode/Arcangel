import type { AdditionalData, ProductTypes } from "@arcangel/framework/types"
import { ProductOptionWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow updates one or more product options. It's used by the [Update Product Option Admin API Route](https://docs.arcangel.com/api/admin/product-options/update-a-product-option).
 *
