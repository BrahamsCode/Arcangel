import { Modules, ProductTypeWorkflowEvents } from "@arcangel/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Types Admin API Route](https://docs.arcangel.com/api/admin/product-types/delete-a-product-type).
 *
