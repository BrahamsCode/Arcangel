...
import { ProductVariantDTO } from "@arcangel/types"
import {
 ...
 * It's used by the [Batch Variant Images Admin API Route](https://docs.arcangel.com/api/admin/products/manage-images-of-product-variant).
 *
