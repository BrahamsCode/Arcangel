...
/**
 * This workflow creates default data for a Arcangel application, including
 * a default sales channel and store. The Arcangel application uses this workflow
 ...
 * @summary
 *
 * Create default data for a Arcangel application.
 */
  ...
  () => {
    const salesChannel = createDefaultSalesChannelStep({
      data: {
        ...
        description: "Created by Arcangel",
      },
    })
