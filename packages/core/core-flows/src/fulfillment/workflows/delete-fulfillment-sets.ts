import { createWorkflow, WorkflowData } from "@arcangel/framework/workflows-sdk"
 ...
 * [Delete Fulfillment Sets Admin API Route](https://docs.arcangel.com/api/admin/fulfillment-sets/delete-fulfillment-set).
 * 
