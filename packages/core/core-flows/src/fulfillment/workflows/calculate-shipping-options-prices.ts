 ...
 * [Calculate Shipping Option Price Store API Route](https://docs.arcangel.com/api/store/shipping-options/calculate-shipping-option-price).
 *
 * :::note
 *
 ...
 *
 * ```ts
 * import { calculateShippingOptionsPricesWorkflow } from "@arcangel/arcangel/core-flows"
