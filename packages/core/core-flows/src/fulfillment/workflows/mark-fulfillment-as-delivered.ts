import type { FulfillmentDTO } from "@arcangel/framework/types"
 ...
 * :::note
 *
 * You can retrieve a fulfillment's details using [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query),
