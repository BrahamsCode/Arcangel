import type { FulfillmentWorkflow } from "@arcangel/framework/types"
import {
  createWorkflow,
  parallelize,
  transform,
...
import { ShippingOptionWorkflowEvents } from "@arcangel/framework/utils"
 ...
 * [Create Shipping Option Admin API Route](https://docs.arcangel.com/api/admin/shipping-options/create-shipping-option).
 *
 ...
 * :::note
 *
 * You can calculate the shipping option's price for a cart using the [calculateShippingOptionsPricesWorkflow](https://docs.arcangel.com/resources/references/arcangel-workflows/calculateShippingOptionsPricesWorkflow).
 *
 * :::
 *
 * ```ts
