import type { ProjectConfigOptions } from "@arcangel/framework/types"
import {
  AuthWorkflowEvents,
  generateJwtToken,
 ...
 * [Generate Reset Password Token for Admin](https://docs.arcangel.com/api/admin/auth/generate-reset-password-token)
 * and [Generate Reset Password Token for Customer](https://docs.arcangel.com/api/store/auth/generate-reset-password-token)
 * API Routes.
 *
 * The workflow emits the `auth.password_reset` event, which you can listen to in
 * a [subscriber](https://docs.arcangel.com/learn/fundamentals/events-and-subscribers). Follow
 * [this guide](https://docs.arcangel.com/resources/commerce-modules/auth/reset-password) to learn
