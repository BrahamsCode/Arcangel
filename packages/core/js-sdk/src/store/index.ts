import { FindParams, HttpTypes, SelectParams } from "@arcangel/types"
...
export class Store {
  ...
  public region = {
     ...
     * [List Regions API route](https://docs.arcangel.com/api/store/regions/list-regions).
     *
     * Related guide: [How to list regions in a storefront](https://docs.arcangel.com/resources/storefront-development/regions/list).
     *
     ...
     * ```
     *
     * Learn more about the `fields` property in the [API reference](https://docs.arcangel.com/api/store/select-fields-and-relations).
     */
    list: async (
    ...
    /**
     * This method retrieves a region by its ID. It sends a request to the [Get Region](https://docs.arcangel.com/api/store/regions/get-a-region)
     * API route.
     *
     * Related guide: [Store and retrieve regions in a storefront](https://docs.arcangel.com/resources/storefront-development/regions/store-retrieve-region).
     *
  ...
  public collection = {
     ...
     * [List Collections](https://docs.arcangel.com/api/store/collections/list-collections) API route.
     *
     * Related guide: [How to retrieve collections in a storefront](https://docs.arcangel.com/resources/storefront-development/products/collections/list).
     *
     * @param query - Filters and pagination configurations.
     * @param headers - Headers to pass in the request
    ...
    /**
     * This method retrieves a collection by its ID. It sends a request to the [Get Collection](https://docs.arcangel.com/api/store/collections/get-a-collection)
     * API route.
     *
     * Related guide: [How to retrieve a collection in a storefront](https://docs.arcangel.com/resources/storefront-development/products/collections/retrieve).
     *
  ...
  public category = {
     ...
     * [List Categories](https://docs.arcangel.com/api/store/product-categories/list-product-categories) API route.
     *
     * Related guide: [How to retrieve list of categories in the storefront](https://docs.arcangel.com/resources/storefront-development/products/categories/list).
     *
     * @param query - Filters and pagination configurations.
     * @param headers - Headers to pass in the request.
     ...
     * [Retrieve Product Category](https://docs.arcangel.com/api/store/product-categories/get-a-product-category).
     *
     * Related guide: [How to retrieve a category in the storefront](https://docs.arcangel.com/resources/storefront-development/products/categories/retrieve).
     *
  ...
  public productOption = {
     ...
     * [List Product Options](https://docs.arcangel.com/api/store/product-options/list-product-options) API route.
     *
     * @param query - Filters and pagination configurations.
     * @param headers - Headers to pass in the request.
     ...
     * [Retrieve Product Option](https://docs.arcangel.com/api/store/product-options/get-a-product-option).
     *
  ...
  public product = {
     ...
     * [List Products API route](https://docs.arcangel.com/api/store/products/list-products).
     *
     * Related guides:
     *
     * - [How to list products in a storefront](https://docs.arcangel.com/resources/storefront-development/products/list).
     * - [How to retrieve a product variant's prices in the storefront](https://docs.arcangel.com/resources/storefront-development/products/price)
     *
     * @param query - Filters and pagination configurations.
     * @param headers - Headers to pass in the request.
     ...
     * [Get Product](https://docs.arcangel.com/api/store/products/get-a-product) API route.
     *
     * Related guides:
     *
     * - [How to retrieve a product in the storefront](https://docs.arcangel.com/resources/storefront-development/products/retrieve).
     * - [How to retrieve a product variant's prices in the storefront](https://docs.arcangel.com/resources/storefront-development/products/price)
     *
  ...
  /**
   * Related guides: [How to implement carts in the storefront](https://docs.arcangel.com/resources/storefront-development/cart).
   *
   * @tags cart
   */
  public cart = {
    /**
     * This method creates a cart. It sends a request to the [Create Cart](https://docs.arcangel.com/api/store/carts/create-cart)
     * API route.
     *
     * Related guide: [How to create a cart in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/create).
     *
     ...
     * [Update Cart](https://docs.arcangel.com/api/store/carts/update-a-cart) API route.
     *
     * Related guide: [How to update a cart in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/update).
     *
     ...
     * [Get Cart](https://docs.arcangel.com/api/store/carts/get-a-cart) API route.
     *
     * Related guide: [How to retrieve a cart in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/retrieve).
     *
     * @param id - The cart's ID.
     * @param query - Configure the fields to retrieve in the cart.
     * @param headers - Headers to pass in the request.
     ...
     * [Add Line Item](https://docs.arcangel.com/api/store/carts/add-line-item) API route.
     *
     * Related guide: [How to manage a cart's line items in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/manage-items).
     *
     ...
     * [Update Line Item](https://docs.arcangel.com/api/store/carts/update-line-item) API route.
     *
     * Related guide: [How to manage a cart's line items in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/manage-items).
     *
     * @param cartId - The cart's ID.
     ...
     * [Remove Line Item](https://docs.arcangel.com/api/store/carts/remove-line-item) API route.
     *
     * Related guide: [How to manage a cart's line items in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/manage-items).
     *
     * @param cartId - The cart's ID.
     ...
     * the [Add Shipping Method](https://docs.arcangel.com/api/store/carts/add-shipping-method) API routes.
     *
     * Related guide: [Implement shipping step during checkout](https://docs.arcangel.com/resources/storefront-development/checkout/shipping).
     *
     * @param cartId - The cart's ID.
     ...
     * [Add Promotion Code](https://docs.arcangel.com/api/store/carts/add-promotions) API route.
     *
     * Related guide: [How to apply promotions to cart in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/manage-items).
     *
     * @param cartId - The cart's ID.
     ...
     * [Remove Promotion Code](https://docs.arcangel.com/api/store/carts/remove-promotions-from-cart) API route.
     *
     * Related guide: [How to apply promotions to cart in the storefront](https://docs.arcangel.com/resources/storefront-development/cart/manage-items).
     *
     * @param cartId - The cart's ID.
     ...
     * The method sends a request to the [Complete Cart](https://docs.arcangel.com/api/store/carts/complete-cart)
     * API route.
     *
     * Related guide: [Learn how to complete cart in checkout flow](https://docs.arcangel.com/resources/storefront-development/checkout/complete-cart).
     *
     * @param cartId - The cart's ID.
  ...
  public fulfillment = {
     ...
     * the [List Shipping Options](https://docs.arcangel.com/api/store/shipping-options/list-shipping-options-for-cart)
     * API route.
     *
     * Related guide: [Implement shipping step during checkout](https://docs.arcangel.com/resources/storefront-development/checkout/shipping).
     *
     ...
     * It sends a request to the [Calculate Shipping Option Price](https://docs.arcangel.com/api/store/shipping-options/calculate-shipping-option-price)
     * API route.
     *
  ...
  public payment = {
     ...
     * It sends a request to the [List Payment Providers](https://docs.arcangel.com/api/store/payment-providers/list-payment-providers)
     * API route.
     *
     * Related guide: [Implement payment step during checkout](https://docs.arcangel.com/resources/storefront-development/checkout/payment).
     *
     ...
     * It sends a request to the [Initialize Payment Session](https://docs.arcangel.com/api/store/payment-collections/initialize-payment-session)
     * API route.
     *
     * If the cart doesn't have a payment collection, a payment collection is created for the cart by
     * sending a request to the [Create Payment Collection](https://docs.arcangel.com/api/store/payment-collections/create-payment-collection)
     * API route.
     *
     * Related guide: [Implement payment step during checkout](https://docs.arcangel.com/resources/storefront-development/checkout/payment).
     *
  ...
  public order = {
     ...
     * sends a request to the [List Orders](https://docs.arcangel.com/api/store/orders/list-orders)
     * API route.
     *
     ...
     * [Get Order](https://docs.arcangel.com/api/store/orders/get-an-order) API route.
     *
  ...
  public customer = {
    /**
     * This method registers a customer. It sends a request to the [Register Customer](https://docs.arcangel.com/api/store/customers/register-customer)
     * API route.
     *
     ...
     *
     * Related guide: [How to register customer in storefront](https://docs.arcangel.com/resources/storefront-development/customers/register)
     *
     ...
     * [Update Customer](https://docs.arcangel.com/api/store/customers/update-customer) API route.
     *
     * Related guide: [How to edit customer's profile in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/profile).
     *
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [Get Logged-In Customer](https://docs.arcangel.com/api/store/customers/get-customer)
     * API route.
     *
     * @param query - Configure the fields to retrieve in the customer.
     * @param headers - Headers to pass in the request.
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [Create Address](https://docs.arcangel.com/api/store/customers/create-address)
     * API route.
     *
     * Related guides: [How to manage customer's addresses in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/addresses)
     *
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [Update Address](https://docs.arcangel.com/api/store/customers/update-address)
     * API route.
     *
     * Related guides: [How to manage customer's addresses in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/addresses)
     *
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [List Customer's Address](https://docs.arcangel.com/api/store/customers/list-customers-addresses)
     * API route.
     *
     * Related guides: [How to manage customer's addresses in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/addresses)
     *
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [Get Address](https://docs.arcangel.com/api/store/customers/get-address)
     * API route.
     *
     * Related guides: [How to manage customer's addresses in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/addresses)
     *
     ...
     * first with the {@link Auth.login} method.
     *
     * It sends a request to the [Remove Address](https://docs.arcangel.com/api/store/customers/remove-address)
     * API route.
     *
     * Related guides: [How to manage customer's addresses in the storefront](https://docs.arcangel.com/resources/storefront-development/customers/addresses)
     *
  ...
  public locale = {
     ...
     * [List Locales](https://docs.arcangel.com/api/store/locales/list-locales) API route.
     * 
     * @param headers - Headers to pass in the request.
