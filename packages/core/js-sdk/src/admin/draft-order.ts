...
export class DraftOrder {
   ...
   * [Get Draft Order](https://docs.arcangel.com/api/admin/draft-orders/get-a-draft-order)
   * API route.
   *
   ...
   * [List Draft Orders](https://docs.arcangel.com/api/admin/draft-orders/list-draft-orders) API route.
   *
   ...
   * [Create Draft Order](https://docs.arcangel.com/api/admin/draft-orders/create-draft-order) API route.
   *
   ...
   * [Delete Draft Order](https://docs.arcangel.com/api/admin/draft-orders/delete-a-draft-order) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   *
   ...
   * [Update Draft Order](https://docs.arcangel.com/api/admin/draft-orders/update-a-draft-order) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Convert Draft Order to Order](https://docs.arcangel.com/api/admin/draft-orders/convert-to-order) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Items](https://docs.arcangel.com/api/admin/draft-orders/add-item) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Update Draft Order Item](https://docs.arcangel.com/api/admin/draft-orders/update-new-item) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Remove Draft Order Item](https://docs.arcangel.com/api/admin/draft-orders/remove-item) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Update Draft Order Item](https://docs.arcangel.com/api/admin/draft-orders/update-item) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Promotions](https://docs.arcangel.com/api/admin/draft-orders/add-promotions) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Remove Draft Order Promotions](https://docs.arcangel.com/api/admin/draft-orders/remove-promotions) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Shipping Method](https://docs.arcangel.com/api/admin/draft-orders/add-shipping-method) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Update Draft Order Shipping Method](https://docs.arcangel.com/api/admin/draft-orders/update-new-shipping-method) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   ...
   * [Remove Draft Order Shipping Method](https://docs.arcangel.com/api/admin/draft-orders/remove-new-shipping-method) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Remove Draft Order Shipping Method](https://docs.arcangel.com/api/admin/draft-orders/remove-shipping-method) API route.
   * 
   * @param id - The draft order's ID.
  ...
  /**
   * This method updates a shipping method in a draft order. It sends a request to the
   * [Update Draft Order Shipping Method](https://docs.arcangel.com/api/admin/draft-orders/update-shipping-method) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Begin Draft Order Edit](https://docs.arcangel.com/api/admin/draft-orders/create-edit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   *
   ...
   * [Cancel Draft Order Edit](https://docs.arcangel.com/api/admin/draft-orders/cancel-edit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Request Draft Order Edit](https://docs.arcangel.com/api/admin/draft-orders/request-edit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   * @returns The draft order preview's details.
   ...
   * [Confirm Draft Order Edit](https://docs.arcangel.com/api/admin/draft-orders/confirm-edit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   * @returns The draft order preview's details.
