...
export class Campaign {
   ...
   * [Get Campaign](https://docs.arcangel.com/api/admin/campaigns/get-a-campaign) API route.
   *
   ...
   * [List Campaigns](https://docs.arcangel.com/api/admin/campaigns/list-campaigns) API route.
   *
   ...
   * [Create Campaign](https://docs.arcangel.com/api/admin/campaigns/create-campaign) API route.
   *
   ...
   * [Update Campaign](https://docs.arcangel.com/api/admin/campaigns/update-a-campaign) API route.
   *
   * @param id - The campaign's ID.
   ...
   * [Delete Campaign](https://docs.arcangel.com/api/admin/campaigns/delete-a-campaign) API route.
   *
   * @param id - The campaign's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Promotions](https://docs.arcangel.com/api/admin/campaigns/manage-promotions)
   * API route.
   *
   * @param id - The campaign's ID.
