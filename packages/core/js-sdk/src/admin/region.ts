...
export class Region {
   ...
   * [Create Region](https://docs.arcangel.com/api/admin/regions/create-region)
   * API route.
   * 
   ...
   * [Update Region](https://docs.arcangel.com/api/admin/regions/update-a-region)
   * API route.
   * 
   ...
   * [List Regions](https://docs.arcangel.com/api/admin/regions/list-regions)
   * API route.
   * 
   ...
   * [Get Region](https://docs.arcangel.com/api/admin/regions/get-a-region)
   * API route.
   * 
   ...
   * [Delete Region](https://docs.arcangel.com/api/admin/regions/delete-a-region)
   * API route.
   * 
