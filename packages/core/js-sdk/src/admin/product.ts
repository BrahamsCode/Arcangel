...
export class Product {
   ...
   * [Create Product Import](https://docs.arcangel.com/api/admin/products/create-product-import)
   * API route.
   *
   * @privateRemarks
   ...
   * the false positive. See: https://github.com/arcangel/arcangel/issues/15892
   *
   ...
   *
   * This method sends a request to the
   * [Create Product Import](https://docs.arcangel.com/api/admin/products/create-product-import-2)
   * API route.
   *
   * @since 2.8.5
   *
   ...
   * [Confirm Product Import](https://docs.arcangel.com/api/admin/products/confirm-product-import)
   * API route.
   *
   * @since 2.8.5
   *
   ...
   *
   * This method sends a request to the [Export Product](https://docs.arcangel.com/api/admin/products/export-products)
   * API route.
   *
   ...
   * [Manage Products](https://docs.arcangel.com/api/admin/products/manage-products)
   * API route.
   *
   ...
   * [Create Product](https://docs.arcangel.com/api/admin/products/create-product)
   * API route.
   *
   ...
   * [Update Product](https://docs.arcangel.com/api/admin/products/update-a-product)
   * API route.
   *
   ...
   * [List Products](https://docs.arcangel.com/api/admin/products/list-products) API route.
   *
   ...
   * [Get Product](https://docs.arcangel.com/api/admin/products/get-a-product)
   * API route.
   *
   * @param id - The product's ID.
   * @param query - Configure the fields to retrieve in the product.
   ...
   * [Delete Product](https://docs.arcangel.com/api/admin/products/delete-a-product)
   * API route.
   *
   * @param id - The product's ID.
   * @param headers - Headers to pass in the request
   ...
   * [Manage Variants](https://docs.arcangel.com/api/admin/products/manage-variants-in-a-product)
   * API route.
   *
   ...
   * [Create Variant](https://docs.arcangel.com/api/admin/products/create-variant)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [Update Variant](https://docs.arcangel.com/api/admin/products/update-variant)
   * API route.
   *
   * @param productId - The product's ID.
  ...
  /**
   * This method retrieves a paginated list of products. It sends a request to the
   * [List Products](https://docs.arcangel.com/api/admin/products/list-variants) API route.
   *
   ...
   * [Retrieve Variant](https://docs.arcangel.com/api/admin/products/get-variant)
   * API route.
   *
   * @param productId - The product's ID.
   * @param id - The variant's ID.
   ...
   * [Delete Variant](https://docs.arcangel.com/api/admin/products/delete-variant)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   *
   * It sends a request to the
   * [Manage Variant Inventory](https://docs.arcangel.com/api/admin/products/manage-variants-inventory)
   * API route.
   *
   ...
   * [List Options](https://docs.arcangel.com/api/admin/products/list-options) API route.
   *
   ...
   * [Batch Image Variants](https://docs.arcangel.com/api/admin/products/manage-variants-of-product-image)
   * API route.
   *
   * @since 2.11.2
   *
   ...
   * [Batch Variant Images](https://docs.arcangel.com/api/admin/products/manage-images-of-product-variant)
   * API route.
   *
   * @since 2.11.2
   *
   ...
   * [Batch Product Product Options](https://docs.arcangel.com/api/admin/products/add-options-to-product)
   * API route.
   *
   * @since 2.16.0
   *
