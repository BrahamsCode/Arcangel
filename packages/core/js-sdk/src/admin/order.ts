...
export class Order {
   ...
   * [Get Order](https://docs.arcangel.com/api/admin/orders/get-an-order)
   * API route.
   *
   ...
   * [Update Order Email](https://docs.arcangel.com/api/admin/orders/update-order)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [Get Order Preview](https://docs.arcangel.com/api/admin/orders/get-preview) API route.
   *
   * @param id - The order's ID.
   ...
   * [List Orders](https://docs.arcangel.com/api/admin/orders/list-orders) API route.
   *
   ...
   * [Archive Order](https://docs.arcangel.com/api/admin/orders/archive-an-order)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [Cancel Order](https://docs.arcangel.com/api/admin/orders/cancel-order)
   * API route.
   *
   * @param id - The order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Complete Order](https://docs.arcangel.com/api/admin/orders/complete-order)
   * API route.
   *
   * @param id - The order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Request Order Transfer](https://docs.arcangel.com/api/admin/orders/request-transfer)
   * API route.
   *
   * @param id - The order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Cancel Order Transfer Request](https://docs.arcangel.com/api/admin/orders/cancel-transfer)
   * API route.
   *
   * @param id - The order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Create Fulfillment](https://docs.arcangel.com/api/admin/orders/create-fulfillment)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [Cancel Fulfillment](https://docs.arcangel.com/api/admin/orders/cancel-fulfillment)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [Create Shipment](https://docs.arcangel.com/api/admin/orders/create-shipment)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [Mark Delivered ](https://docs.arcangel.com/api/admin/orders/mark-delivered)
   * API route.
   *
   * @param id - The order's ID.
   ...
   *
   * This method sends a request to the [List Shipping Options](https://docs.arcangel.com/api/admin/orders/list-shipping-options)
   * API route.
   *
   * @param id - The order's ID.
   ...
   *
   * This method sends a request to the [List Changes](https://docs.arcangel.com/api/admin/orders/list-changes)
   * API route.
   *
   * @param id - The order's ID.
   ...
   * [List Line Items](https://docs.arcangel.com/api/admin/orders/list-line-items)
   * API routes.
   *
   * @param id - The order's ID.
   ...
   * [Create Credit Line](https://docs.arcangel.com/api/admin/orders/create-credit-line) API route.
   *
   ...
   * [Authorize Payment Session](https://docs.arcangel.com/api/admin/orders/authorize-payment-session)
   * API route.
   *
   ...
   * [Update Order Change](https://docs.arcangel.com/api/admin/order-changes/update-order-change)
   * API route.
   *
   * @since 2.12.0
   *
   ...
   * a request to the [Export Orders](https://docs.arcangel.com/api/admin/orders/export-orders) API route.
   *
