...
export class Customer {
   ...
   * [Create Customer](https://docs.arcangel.com/api/admin/customers/create-customer) API route.
   *
   ...
   * [Update Customer](https://docs.arcangel.com/api/admin/customers/update-a-customer) API route.
   *
   ...
   * [List Customers](https://docs.arcangel.com/api/admin/customers/list-customers)
   * API route.
   *
   ...
   * [Get Customer](https://docs.arcangel.com/api/admin/customers/get-a-customer)
   * API route.
   *
   * @param id - The customer's ID.
   * @param query - Configure the fields to retrieve in the customer.
   ...
   * [Delete Customer](https://docs.arcangel.com/api/admin/customers/delete-a-customer)
   * API route.
   *
   * @param id - The customer's ID.
   * @param headers - Headers to pass in the request.
   ...
   * It sends a request to the [Manage Customers](https://docs.arcangel.com/api/admin/customers/manage-customer-groups)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Create Customer Address](https://docs.arcangel.com/api/admin/customers/add-address)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Update Customer Address](https://docs.arcangel.com/api/admin/customers/update-address)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Delete Customer Address](https://docs.arcangel.com/api/admin/customers/remove-an-address-from-customer)
   * API route.
   *
   * @param id - The customer's ID.
   * @param addressId - The customer address's ID.
   ...
   * [Get Customer Address](https://docs.arcangel.com/api/admin/customers/list-addresses-2)
   * API route.
   *
   * @param id - The customer's ID.
   * @param addressId - The customer address's ID.
   ...
   * [List Customer Addresses](https://docs.arcangel.com/api/admin/customers/list-addresses)
   * API route.
   *
   * @param id - The customer's ID.
   * @param headers - Headers to pass in the request.
