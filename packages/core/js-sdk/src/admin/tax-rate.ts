...
export class TaxRate {
   ...
   * [Create Tax Rate](https://docs.arcangel.com/api/admin/tax-rates/create-tax-rate)
   * API route.
   *
   ...
   * [Update Tax Rate](https://docs.arcangel.com/api/admin/tax-rates/update-a-tax-rate)
   * API route.
   *
   ...
   * [Delete Tax Rate](https://docs.arcangel.com/api/admin/tax-rates/delete-a-tax-rate)
   * API route.
   *
   ...
   * [Get Tax Rate](https://docs.arcangel.com/api/admin/tax-rates/get-a-tax-rate)
   * API route.
   *
   ...
   * [List Tax Rates](https://docs.arcangel.com/api/admin/tax-rates/list-tax-rates)
   * API route.
   *
