...
export class Return {
   ...
   * [List Returns](https://docs.arcangel.com/api/admin/returns/list-returns)
   * API route.
   * 
   ...
   * ```
   * 
   * Learn more about the `fields` property in the [API reference](https://docs.arcangel.com/api/admin/select-fields-and-relations).
   */
   ...
   * [Get Return](https://docs.arcangel.com/api/admin/returns/get-a-return)
   * API route.
   * 
   ...
   * [Create Return](https://docs.arcangel.com/api/admin/returns/create-return)
   * API route.
   * 
   ...
   * [Cancel Return](https://docs.arcangel.com/api/admin/returns/cancel-a-return)
   * API route.
   * 
   ...
   * [Cancel Return Request](https://docs.arcangel.com/api/admin/returns/cancel-return-request)
   * API route.
   * 
   * @param id - The ID of the return to cancel.
   * @param query - Configure the fields and relations to retrieve in the return.
   ...
   * [Add Return Item](https://docs.arcangel.com/api/admin/returns/add-items)
   * API route.
   * 
   ...
   * [Update Requested Return Item](https://docs.arcangel.com/api/admin/returns/update-requested-item)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Item from Return](https://docs.arcangel.com/api/admin/returns/remove-item)
   * API route.
   * 
   ...
   * [Add Shipping Method to Return](https://docs.arcangel.com/api/admin/returns/add-shipping-method)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Shipping Method in Return](https://docs.arcangel.com/api/admin/returns/update-shipping-method)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Shipping Method from Return](https://docs.arcangel.com/api/admin/returns/remove-shipping-method)
   * API route.
   * 
   ...
   * [Update Return](https://docs.arcangel.com/api/admin/returns/update-a-return)
   * API route.
   * 
   ...
   * [Confirm Return Receival](https://docs.arcangel.com/api/admin/returns/confirm-return-receival)
   * API route.
   * 
   * This method sends a request to the
   * [Confirm Return Request](https://docs.arcangel.com/api/admin/returns/confirm-return-request)
   * API route.
   * 
   ...
   * [Start Return Receival](https://docs.arcangel.com/api/admin/returns/start-return-receival)
   * API route.
   * 
   ...
   * [Add Received Items](https://docs.arcangel.com/api/admin/returns/add-received-items)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Received Item](https://docs.arcangel.com/api/admin/returns/update-received-item)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Received Item](https://docs.arcangel.com/api/admin/returns/remove-received-item)
   * API route.
   * 
   ...
   * 
   * The method sends a request to the
   * [Add Damaged Items](https://docs.arcangel.com/api/admin/returns/add-damaged-items)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Update Damaged Item](https://docs.arcangel.com/api/admin/returns/update-damaged-item)
   * API route.
   * 
   ...
   * 
   * This method sends a request to the
   * [Remove Damaged Item](https://docs.arcangel.com/api/admin/returns/remove-damaged-item)
   * API route.
   * 
   ...
   * [Cancel Return Receival](https://docs.arcangel.com/api/admin/returns/cancel-return-receival)
   * API route.
   * 
