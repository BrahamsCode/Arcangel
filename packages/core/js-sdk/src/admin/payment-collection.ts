...
export class PaymentCollection {
   ...
   * [Create Payment Collection](https://docs.arcangel.com/api/admin/payment-collections/create-payment-collection)
   * API route.
   * 
   ...
   * [Delete Payment Collection](https://docs.arcangel.com/api/admin/payment-collections/delete-a-payment-collection)
   * API route.
   * 
   ...
   * [Mark as Paid](https://docs.arcangel.com/api/admin/payment-collections/mark-as-paid)
   * API route.
   * 
   ...
   * [Create Payment Session](https://docs.arcangel.com/api/admin/payment-collections/initialize-payment-session)
   * API route.
   *
   * @param id - The payment collection's ID.
