...
export class Payment {
   ...
   * [List Payments](https://docs.arcangel.com/api/admin/payments/list-payments) API route.
   * 
   ...
   * [List Payment Providers](https://docs.arcangel.com/api/admin/payments/list-payment-providers) API route.
   * 
   * @param query - Filters and pagination configurations.
   * @param headers - Headers to pass in the request.
   ...
   * [Get Payment](https://docs.arcangel.com/api/admin/payments/get-a-payment)
   * API route.
   * 
   ...
   * [Capture Payment](https://docs.arcangel.com/api/admin/payments/capture-payment) API route.
   * 
   ...
   * [Refund Payment](https://docs.arcangel.com/api/admin/payments/refund-payment) API route.
   * 
