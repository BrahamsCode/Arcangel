...
export class ProductTag {
   ...
   * [Create Product Tag](https://docs.arcangel.com/api/admin/product-tags/create-product-tag)
   * API route.
   * 
   ...
   * [Update Product Tag](https://docs.arcangel.com/api/admin/product-tags/update-a-product-tag)
   * API route.
   * 
   ...
   * [List Product Tags](https://docs.arcangel.com/api/admin/product-tags/list-product-tags) API route.
   * 
   ...
   * [Get Product Tag](https://docs.arcangel.com/api/admin/product-tags/get-a-product-tag) API route.
   * 
   ...
   * [Delete Product Tag](https://docs.arcangel.com/api/admin/product-tags/delete-a-product-tag)
   * API route.
   * 
   * @param id - The tag's ID.
   * @param headers - Headers to pass in the request
