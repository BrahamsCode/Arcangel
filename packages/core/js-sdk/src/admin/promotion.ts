...
export class Promotion {
   ...
   * [Retrieve Promotion](https://docs.arcangel.com/api/admin/promotions/get-a-promotion)
   * API route.
   *
   ...
   * [List Promotions](https://docs.arcangel.com/api/admin/promotions/list-promotions)
   * API route.
   *
   ...
   * [Create Promotion](https://docs.arcangel.com/api/admin/promotions/create-promotion)
   * API route.
   *
   ...
   * [Update Promotion](https://docs.arcangel.com/api/admin/promotions/update-a-promotion)
   * API route.
   *
   * @param id - The promotion's ID.
   ...
   * [Delete Promotion](https://docs.arcangel.com/api/admin/promotions/delete-a-promotion)
   * API route.
   *
   * @param id - The promotion's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Manage Promotion's Rules API Route](https://docs.arcangel.com/api/admin/promotions/manage-rules).
   * - If you set the `ruleType` to `buy-rules`, the method sends a request to the
   * [Manage Promotion's Buy Rules API Route](https://docs.arcangel.com/api/admin/promotions/manage-buy-rules).
   * - If you set the `ruleType` to `target-rules`, the method sends a request to the
   * [Manage Promotion's Target Rules API Route](https://docs.arcangel.com/api/admin/promotions/manage-target-rules).
   *
   * @param id - The promotion's ID.
   ...
   * [List Rules of a Promotion API Route](https://docs.arcangel.com/api/admin/promotions/list-rules)
   *
   * @param id - The promotion's ID.
   ...
   *
   * This method sends a request to the
   * [List Rule Attribute Options API Route](https://docs.arcangel.com/api/admin/promotions/list-potential-rule-attributes)
   *
   ...
   *
   * This method sends a request to the
   * [List Rule Values API Route](https://docs.arcangel.com/api/admin/promotions/list-rule-values)
   *
