...
export class Currency {
   ...
   * [List Currencies](https://docs.arcangel.com/api/admin/currencies/list-currencies)
   * API route.
   * 
   ...
   * [Get Currency](https://docs.arcangel.com/api/admin/currencies/get-a-currency) API route.
   * 
