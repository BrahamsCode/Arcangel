...
export class OrderEdit {
   ...
   * [Create Order Edit](https://docs.arcangel.com/api/admin/order-edits/create-order-edit)
   * API route.
   *
   ...
   * [Request Order Edit](https://docs.arcangel.com/api/admin/order-edits/request-order-edit)
   * API route.
   *
   ...
   * to the [Confirm Order Edit](https://docs.arcangel.com/api/admin/order-edits/confirm-order-edit)
   * API route.
   *
   * @param id - The ID of the order that is being edited.
   * @param query - Configure the fields to retrieve in the order preview.
   ...
   * [Cancel Order Edit](https://docs.arcangel.com/api/admin/order-edits/cancel-order-edit)
   * API route.
   *
   * @param id - The ID of the order that is being edited.
   ...
   *
   * The method sends a request to the [Add Items](https://docs.arcangel.com/api/admin/order-edits/add-items)
   * API route.
   *
   * @param id - The ID of the order that is being edited.
   ...
   * [Update Item Quantity](https://docs.arcangel.com/api/admin/order-edits/update-item-quantity)
   * API route.
   *
   ...
   *
   * It sends a request
   * to the [Update Item](https://docs.arcangel.com/api/admin/order-edits/update-item)
   * API route.
   *
   * @param id - The ID of the order that is being edited.
