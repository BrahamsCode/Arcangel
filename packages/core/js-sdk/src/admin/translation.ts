...
export class Translation {
   ...
   * [List Translations](https://docs.arcangel.com/api/admin/translations/list-translations)
   * API route.
   *
   ...
   * [Manage Translations](https://docs.arcangel.com/api/admin/translations/manage-translations)
   * API route.
   *
   ...
   * [Get Translation Settings](https://docs.arcangel.com/api/admin/translations/list-settings) API route.
   *
   ...
   * [Batch Translation Settings](https://docs.arcangel.com/api/admin/translations/manage-translation-settings)
   * API route.
   *
   * @since 2.12.6
   *
   ...
   * translatable fields.
   * It sends a request to the
   * [Get Translation Entities](https://docs.arcangel.com/api/admin/translations/list-translatable-entities) API route.
   *
   * @since 2.12.4
   *
   ...
   * It sends a request to the
   * [Get Translation Statistics](https://docs.arcangel.com/api/admin/translations/get-statistics) API route.
   *
