...
export class RefundReason {
   ...
   * [List Refund Reasons](https://docs.arcangel.com/api/admin/refund-reasons/list-refund-reasons)
   * API route.
   *
   ...
   * [Get Refund Reason](https://docs.arcangel.com/api/admin/refund-reasons/get-a-refund-reason)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Create Refund Reason](https://docs.arcangel.com/api/admin/refund-reasons/create-refund-reason)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Update Refund Reason](https://docs.arcangel.com/api/admin/refund-reasons/update-a-refund-reason)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Delete Refund Reason](https://docs.arcangel.com/api/admin/refund-reasons/delete-a-refund-reason)
   * API route.
   *
   * @since 2.11.0
   *
