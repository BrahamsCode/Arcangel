...
export class ProductType {
   ...
   * [Create Product Type](https://docs.arcangel.com/api/admin/product-types/create-product-type)
   * API route.
   * 
   ...
   * [Update Product Type](https://docs.arcangel.com/api/admin/product-types/update-a-product-type)
   * API route.
   * 
   ...
   * [List Product Types](https://docs.arcangel.com/api/admin/product-types/list-product-types) API route.
   * 
   ...
   * [Get Product Type](https://docs.arcangel.com/api/admin/product-types/get-a-product-type)
   * API route.
   * 
   * @param id - The product type's ID.
   * @param query - Configure the fields to retrieve in the product type.
   ...
   * [Delete Product Type](https://docs.arcangel.com/api/admin/product-types/delete-a-product-type)
   * API route.
   * 
   * @param id - The product type's ID.
   * @param headers - Headers to pass in the request
