...
export class ProductCategory {
   ...
   * [Create Category](https://docs.arcangel.com/api/admin/product-categories/create-product-category)
   * API route.
   * 
   ...
   * [Update Category](https://docs.arcangel.com/api/admin/product-categories/update-a-product-category)
   * API route.
   * 
   ...
   * [List Product Categories](https://docs.arcangel.com/api/admin/product-categories/list-product-categories) API route.
   * 
   ...
   * [Get Product Category](https://docs.arcangel.com/api/admin/product-categories/get-a-product-category) API route.
   * 
   ...
   * [Delete Product Category](https://docs.arcangel.com/api/admin/product-categories/delete-a-product-category)
   * API route.
   * 
   * @param id - The category's ID.
   * @param headers - Headers to pass in the request
   ...
   * to the [Manage Products](https://docs.arcangel.com/api/admin/product-categories/manage-products)
   * API route.
   * 
   * @param id - The category's ID.
