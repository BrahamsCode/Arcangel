...
export class ShippingOptionType {
   ...
   * [Create Shipping Option Type](https://docs.arcangel.com/api/admin/shipping-option-types/create-shipping-option-type)
   * API route.
   *
   ...
   * [Update Shipping Option Type](https://docs.arcangel.com/api/admin/shipping-option-types/update-a-shipping-option-type)
   * API route.
   *
   ...
   * [List Shipping Option Types](https://docs.arcangel.com/api/admin/shipping-option-types/list-shipping-option-types) API route.
   *
   ...
   * [Get Shipping Option Type](https://docs.arcangel.com/api/admin/shipping-option-types/get-a-shipping-option-type)
   * API route.
   *
   * @param id - The shipping option type's ID.
   * @param query - Configure the fields to retrieve in the shipping option type.
   ...
   * [Delete Shipping Option Type](https://docs.arcangel.com/api/admin/shipping-option-types/delete-shipping-option-type)
   * API route.
   *
   * @param id - The shipping option type's ID.
   * @param headers - Headers to pass in the request
