...
export class ReturnReason {
   ...
   * [List Return Reasons](https://docs.arcangel.com/api/admin/return-reasons/schema)
   * API route.
   * 
   ...
   * [Get Return Reason](https://docs.arcangel.com/api/admin/return-reasons/get-a-return-reason)
   * API route.
   * 
   ...
   * [Create Return Reason](https://docs.arcangel.com/api/admin/return-reasons/create-return-reason)
   * API route.
   * 
   ...
   * [Update Return Reason](https://docs.arcangel.com/api/admin/return-reasons/update-a-return-reason)
   * API route.
   * 
   * @param id - The return reason's ID.
   ...
   * [Delete Return Reason](https://docs.arcangel.com/api/admin/return-reasons/delete-a-return-reason)
   * API route.
   * 
   * @param id - The return reason's ID.
