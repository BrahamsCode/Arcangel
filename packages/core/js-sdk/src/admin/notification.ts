...
export class Notification {
   ...
   * [Get Notification](https://docs.arcangel.com/api/admin/notifications/get-a-notification)
   * API route.
   * 
   ...
   * [List Notifications](https://docs.arcangel.com/api/admin/notifications/list-notifications)
   * API route.
   * 
