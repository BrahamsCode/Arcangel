...
export class TaxRegion {
   ...
   * [Create Tax Region](https://docs.arcangel.com/api/admin/tax-regions/create-tax-region)
   * API route.
   *
   ...
   * [Update Tax Region](https://docs.arcangel.com/api/admin/tax-regions/update-a-tax-region)
   * API route.
   * 
   * @since 2.8.0
   *
   ...
   * [Delete Tax Region](https://docs.arcangel.com/api/admin/tax-regions/delete-a-tax-region)
   * API route.
   *
   ...
   * [Get Tax Region](https://docs.arcangel.com/api/admin/tax-regions/get-a-tax-region)
   * API route.
   *
   ...
   * [List Tax Regions](https://docs.arcangel.com/api/admin/tax-regions/list-tax-regions)
   * API route.
   *
