...
export class ShippingProfile {
   ...
   * [Create Shipping Profile](https://docs.arcangel.com/api/admin/shipping-profiles/create-shipping-profile)
   * API route.
   * 
   ...
   * [Update Shipping Profile](https://docs.arcangel.com/api/admin/shipping-profiles/update-a-shipping-profile)
   * API route.
   * 
   ...
   * [Delete Shipping Profile](https://docs.arcangel.com/api/admin/shipping-profiles/delete-a-shipping-profile)
   * API route.
   * 
   ...
   * [List Shipping Profiles](https://docs.arcangel.com/api/admin/shipping-profiles/list-shipping-profiles)
   * API route.
   * 
   ...
   * [Get Shipping Profile](https://docs.arcangel.com/api/admin/shipping-profiles/get-a-shipping-profile)
   * API route.
   * 
