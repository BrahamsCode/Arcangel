...
export class FulfillmentSet {
   ...
   * [Delete Fulfillment Set](https://docs.arcangel.com/api/admin/fulfillment-sets/delete-fulfillment-set)
   * API route.
   * 
   ...
   * [Add Service Zone](https://docs.arcangel.com/api/admin/fulfillment-sets/add-service-zone)
   * API route.
   * 
   * @param id - The fulfillment set's ID.
   ...
   * [Get Service Zone](https://docs.arcangel.com/api/admin/fulfillment-sets/get-a-service-zone)
   * API route.
   * 
   ...
   * [Update Service Zone](https://docs.arcangel.com/api/admin/fulfillment-sets/update-service-zone)
   * API route.
   * 
   * @param fulfillmentSetId - The fulfillment set's ID.
   * @param serviceZoneId - The service zone's ID.
   ...
   * [Remove Service Zone](https://docs.arcangel.com/api/admin/fulfillment-sets/remove-service-zone)
   * API route.
   * 
