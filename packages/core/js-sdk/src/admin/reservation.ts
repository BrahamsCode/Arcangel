...
class Reservation {
   ...
   * [Get Reservation](https://docs.arcangel.com/api/admin/reservations/get-a-reservation)
   * API route.
   * 
   ...
   * [List Reservations](https://docs.arcangel.com/api/admin/reservations/list-reservations)
   * API route.
   * 
   ...
   * [Create Reservation](https://docs.arcangel.com/api/admin/reservations/create-reservation)
   * API route.
   * 
   ...
   * [Update Reservation](https://docs.arcangel.com/api/admin/reservations/update-a-reservation)
   * API route.
   * 
   * @param id - The reservation's ID.
   ...
   * [Delete Reservation](https://docs.arcangel.com/api/admin/reservations/delete-a-reservation)
   * API route.
   * 
   * @param id - The reservation's ID.
   * @param headers - Headers to pass in the request.
