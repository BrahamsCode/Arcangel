...
export class ShippingOption {
   ...
   * [Create Shipping Option](https://docs.arcangel.com/api/admin/shipping-options/create-shipping-option)
   * API route.
   * 
   ...
   * [Get Shipping Option](https://docs.arcangel.com/api/admin/shipping-options/get-a-shipping-option)
   * API route.
   * 
   ...
   * [Update Shipping Option](https://docs.arcangel.com/api/admin/shipping-options/update-a-shipping-option)
   * API route.
   * 
   ...
   * [Delete Shipping Option](https://docs.arcangel.com/api/admin/shipping-options/delete-a-shipping-option)
   * API route.
   * 
   ...
   * [List Shipping Options](https://docs.arcangel.com/api/admin/shipping-options/list-shipping-options)
   * API route.
   * 
   ...
   * [Manage Rules of a Shipping Option](https://docs.arcangel.com/api/admin/shipping-options/manage-rules)
   * API route.
   * 
