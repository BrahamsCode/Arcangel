...
export class Claim {
   ...
   * [List Claims](https://docs.arcangel.com/api/admin/claims/list-claims) API route.
   * 
   ...
   * [Get Claim](https://docs.arcangel.com/api/admin/claims/get-a-claim) API route.
   * 
   ...
   * [Create Claim](https://docs.arcangel.com/api/admin/claims/create-a-claim) API route.
   * 
   ...
   * [Cancel Claim](https://docs.arcangel.com/api/admin/claims/cancel-a-claim) API route.
   * 
   * @param id - The claim's ID.
   * @param query - Configure the fields to retrieve in the claim.
   * @param headers - Headers to pass in the request
   ...
   * [Add Items](https://docs.arcangel.com/api/admin/claims/add-claim-items) API route.
   * 
   ...
   * sends a request to the [Update Claim Item](https://docs.arcangel.com/api/admin/claims/update-a-claim-item) API route.
   * 
   ...
   * It sends a request to the [Remove Claim Item](https://docs.arcangel.com/api/admin/claims/remove-claim-item)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * 
   * This method sends a request to the [Add Inbound Items](https://docs.arcangel.com/api/admin/claims/add-inbound-items)
   * API route.
   * 
   ...
   * It sends a request to the [Update Inbound Item](https://docs.arcangel.com/api/admin/claims/update-inbound-items)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Remove Inbound Item](https://docs.arcangel.com/api/admin/claims/remove-inbound-item)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.arcangel.com/api/admin/claims/add-inbound-shipping)
   * API route.
   * 
   * @param id - The claim's ID.
   ...
   * It sends a request to the [Update Inbound Shipping](https://docs.arcangel.com/api/admin/claims/update-inbound-shipping)
   * API route.
   * 
   ...
   * It sends a request to the [Remove Inbound Shipping](https://docs.arcangel.com/api/admin/claims/remove-inbound-shipping-method)
   * API route.
   * 
   * Every shipping method has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Add Outbound Items](https://docs.arcangel.com/api/admin/claims/add-outbound-items)
   * API route.
   * 
   ...
   * It sends a request to the [Update Outbound Item](https://docs.arcangel.com/api/admin/claims/update-outbound-item)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Remove Outbound Item](https://docs.arcangel.com/api/admin/claims/remove-outbound-item)
   * API route.
   * 
   * Every item has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * [Add Outbound Shipping](https://docs.arcangel.com/api/admin/claims/add-outbound-shipping)
   * API route.
   * 
   * @param id - The claim's ID.
   * @param body - The shipping method's details.
   ...
   * It sends a request to the [Update Outbound Shipping](https://docs.arcangel.com/api/admin/claims/update-outbound-shipping)
   * API route.
   * 
   * Every shipping method has an `actions` property, whose value is an array of actions. 
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   ...
   * It sends a request to the [Confirm Claim Request](https://docs.arcangel.com/api/admin/claims/confirm-claim)
   * API route.
   * 
   * @param id - The claim's ID.
   ...
   * [Cancel Claim Request](https://docs.arcangel.com/api/admin/claims/cancel-claim-request)
   * API route.
   * 
   * @param id - The claim's ID.
   * @param query - Configure the fields to retrieve in the claim.
