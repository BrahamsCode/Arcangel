...
export class PriceList {
   ...
   * [Get Price List](https://docs.arcangel.com/api/admin/price-lists/get-a-price-list)
   * API route.
   *
   ...
   * [List Price Lists](https://docs.arcangel.com/api/admin/price-lists/list-price-lists) API route.
   *
   ...
   * [Create Price List](https://docs.arcangel.com/api/admin/price-lists/create-price-list)
   * API route.
   *
   ...
   * [Update Price List](https://docs.arcangel.com/api/admin/price-lists/update-a-price-list)
   * API route.
   *
   * @param id - The price list's ID.
   ...
   * [Delete Price List](https://docs.arcangel.com/api/admin/price-lists/delete-a-price-list)
   * API route.
   *
   * @param id - The price list's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Prices](https://docs.arcangel.com/api/admin/price-lists/manage-prices)
   * API route.
   *
   * @param id - The price list's ID.
   ...
   * [Get Prices](https://docs.arcangel.com/api/admin/price-lists/list-prices)
   * API route.
   * 
   * @since 2.12.3
   *
   ...
   * [Remove Product](https://docs.arcangel.com/api/admin/price-lists/remove-products-from-price-list)
   * API route.
   *
   * @param id - The price list's ID.
