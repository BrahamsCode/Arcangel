...
export class Invite {
   ...
   * (https://docs.arcangel.com/api/admin/invites/accept-invite)
   * API route.
   * 
   ...
   * [Create Invite](https://docs.arcangel.com/api/admin/invites/create-invite)
   * API route.
   * 
   ...
   * [Get Invite](https://docs.arcangel.com/api/admin/invites/get-an-invite)
   * API route.
   * 
   ...
   * [List Invites](https://docs.arcangel.com/api/admin/invites/list-invites)
   * API route.
   * 
   ...
   * [Refresh Invite Token](https://docs.arcangel.com/api/admin/invites/refresh-invite-token)
   * API route.
   * 
   * @param id - The invite's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Delete Invite](https://docs.arcangel.com/api/admin/invites/delete-invite)
   * API route.
   * 
   * @param id - The invite's ID.
   * @param headers - Headers to pass in the request.
