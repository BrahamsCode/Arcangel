...
export class CustomerGroup {
   ...
   * [Get Customer Group](https://docs.arcangel.com/api/admin/customer-groups/get-a-customer-group) API route.
   * 
   ...
   * [List Customer Groups](https://docs.arcangel.com/api/admin/customer-groups/list-customer-groups)
   * API route.
   * 
   ...
   * [Create Customer Group](https://docs.arcangel.com/api/admin/customer-groups/create-customer-group)
   * API route.
   * 
   ...
   * [Update Customer](https://docs.arcangel.com/api/admin/customer-groups/update-a-customer-group)
   * API route.
   * 
   * @param id - The customer group's ID.
   ...
   * [Delete Customer Group](https://docs.arcangel.com/api/admin/customer-groups/delete-a-customer-group)
   * API route.
   * 
   * @param id - The customer group's ID.
   * @param headers - Headers to pass in the request
   ...
   * It sends a request to the [Manage Customers](https://docs.arcangel.com/api/admin/customer-groups/manage-customers)
   * API route.
   * 
