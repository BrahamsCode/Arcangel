...
export class ProductOption {
   ...
   * [Create Option](https://docs.arcangel.com/api/admin/product-options/create-product-option)
   * API route.
   *
   ...
   * [Update Option](https://docs.arcangel.com/api/admin/product-options/update-a-product-option)
   * API route.
   *
   ...
   * [List Product Options API route](https://docs.arcangel.com/api/admin/product-options/list-product-options).
   *
   ...
   * [Get Product Option API route](https://docs.arcangel.com/api/admin/product-options/get-a-product-option).
   *
   * @param id - The product option's ID.
   ...
   * [Delete Product Option API route](https://docs.arcangel.com/api/admin/product-options/delete-a-product-option).
   *
   * @param id - The product option's ID.
   * @param headers - Headers to pass in the request
