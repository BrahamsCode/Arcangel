...
export class Store {
   ...
   * [Get Store](https://docs.arcangel.com/api/admin/stores/get-a-store)
   * API route.
   * 
   ...
   * [List Stores](https://docs.arcangel.com/api/admin/stores/list-stores)
   * API route.
   * 
   ...
   * [Update Store](https://docs.arcangel.com/api/admin/stores/update-a-store)
   * API route.
   * 
