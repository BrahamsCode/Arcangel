import { HttpTypes, SelectParams } from "@arcangel/types"
...
export class Exchange {
   ...
   * [List Exchanges](https://docs.arcangel.com/api/admin/exchanges/list-exchanges)
   * API route.
   * 
   ...
   * [Get Exchange](https://docs.arcangel.com/api/admin/exchanges/get-an-exchange)
   * API route.
   * 
   ...
   * [Create Exchange](https://docs.arcangel.com/api/admin/exchanges/create-exchange) API route.
   * 
   ...
   * [Cancel Exchange](https://docs.arcangel.com/api/admin/exchanges/cancel-an-exchange) API route.
   * 
   * @param id - The exchange's ID.
   * @param query - Configure the fields to retrieve in the exchange.
   * @param headers - Headers to pass in the request.
   ...
   * 
   * This method sends a request to the [Add Inbound Items](https://docs.arcangel.com/api/admin/exchanges/add-inbound-items-to-an-exchange)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * 
   * This method sends a request to the [Update Inbound Item](https://docs.arcangel.com/api/admin/exchanges/update-inbound-item)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * 
   * This method sends a request to the [Remove Inbound Item](https://docs.arcangel.com/api/admin/exchanges/remove-inbound-item)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the return item's `RETURN_ITEM` action.
   ...
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.arcangel.com/api/admin/exchanges/add-inbound-shipping)
   * API route.
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.arcangel.com/api/admin/exchanges/add-inbound-shipping)
   * API route.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Inbound Shipping](https://docs.arcangel.com/api/admin/exchanges/update-inbound-shipping)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Remove Inbound Shipping](https://docs.arcangel.com/api/admin/exchanges/remove-inbound-shipping-method)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * 
   * This method sends a request to the [Add Outbound Items](https://docs.arcangel.com/api/admin/exchanges/add-outbound-items-to-exchange)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param body - The items to add.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Inbound Item](https://docs.arcangel.com/api/admin/exchanges/update-outbound-item)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Outbound Item](https://docs.arcangel.com/api/admin/exchanges/remove-outbound-item)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the new exchange item's `ITEM_ADD` action.
   ...
   * 
   * This method sends a request to the [Add Outbound Shipping](https://docs.arcangel.com/api/admin/exchanges/add-outbound-shipping)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param body - The shipping method's details.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Outbound Shipping](https://docs.arcangel.com/api/admin/exchanges/update-outbound-shipping)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Remove Outbound Shipping](https://docs.arcangel.com/api/admin/exchanges/remove-outbound-shipping-method)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * 
   * This method sends a request to the [Confirm Exchange](https://docs.arcangel.com/api/admin/exchanges/confirm-an-exchange)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * [Cancel Exchange Request](https://docs.arcangel.com/api/admin/exchanges/cancel-exchange-request)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param query - Configure the fields to retrieve in the exchange.
