...
export class Fulfillment {
   ...
   * [Create Fulfillment](https://docs.arcangel.com/api/admin/fulfillments/create-fulfillment)
   * API route.
   * 
   ...
   * [Cancel Fulfillment](https://docs.arcangel.com/api/admin/fulfillments/cancel-a-fulfillment)
   * API route.
   * 
   ...
   * [Create Shipment](https://docs.arcangel.com/api/admin/fulfillments/create-shipment)
   * API route.
   * 
   * @param id - The fulfillment's ID.
