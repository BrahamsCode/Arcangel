...
export class PricePreference {
   ...
   * [Get Price Preference](https://docs.arcangel.com/api/admin/price-preferences/get-a-price-preference)
   * API route.
   *
   ...
   * [List Price Preferences](https://docs.arcangel.com/api/admin/price-preferences/list-price-preferences) API route.
   *
   ...
   * [Create Price Preference](https://docs.arcangel.com/api/admin/price-preferences/create-price-preference)
   * API route.
   *
   ...
   * [Update Price Preference](https://docs.arcangel.com/api/admin/price-preferences/update-a-price-preference)
   * API route.
   *
   * @param id - The price preference's ID.
   ...
   * [Delete Price Preference](https://docs.arcangel.com/api/admin/price-preferences/delete-a-price-preference)
   * API route.
   *
   * @param id - The price preference's ID.
   * @param headers - Headers to pass in the request
