...
export class FulfillmentProvider {
   ...
   * [List Fulfillment Providers](https://docs.arcangel.com/api/admin/fulfillment-providers/list-fulfillment-providers)
   * API route.
   *
   ...
   * [List Fulfillment Options](https://docs.arcangel.com/api/admin/fulfillment-providers/list-fulfillment-options)
   * API route.
   *
