...
export class Upload {
   ...
   * [Upload Files](https://docs.arcangel.com/api/admin/uploads/upload-files)
   * API route.
   *
   ...
   * [Get File](https://docs.arcangel.com/api/admin/uploads/get-a-file)
   * API route.
   *
   ...
   * [Delete File](https://docs.arcangel.com/api/admin/uploads/delete-a-file)
   * API route.
   *
