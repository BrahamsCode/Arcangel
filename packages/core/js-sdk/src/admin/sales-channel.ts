...
export class SalesChannel {
   ...
   * [Create Sales Channel](https://docs.arcangel.com/api/admin/sales-channels/create-sales-channel)
   * API route.
   * 
   ...
   * [Update Sales Channel](https://docs.arcangel.com/api/admin/sales-channels/update-a-sales-channel)
   * API route.
   * 
   ...
   * [Delete Sales Channel](https://docs.arcangel.com/api/admin/sales-channels/delete-a-sales-channel)
   * API route.
   * 
   ...
   * [Retrieve Sales Channel](https://docs.arcangel.com/api/admin/sales-channels/get-a-sales-channel)
   * API route.
   * 
   ...
   * [List Sales Channels](https://docs.arcangel.com/api/admin/sales-channels/list-sales-channels)
   * API route.
   * 
   ...
   * [Manage Products in Sales Channel](https://docs.arcangel.com/api/admin/sales-channels/manage-products)
   * API route.
   * 
