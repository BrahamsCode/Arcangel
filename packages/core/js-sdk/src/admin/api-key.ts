...
export class ApiKey {
   ...
   * [List API Keys](https://docs.arcangel.com/api/admin/api-keys/list-api-keys) API route.
   * 
  ...
  /**
   * This method creates an API key. It sends a request to the [Create API Key](https://docs.arcangel.com/api/admin/api-keys/create-api-key)
   * API route.
   * 
   ...
   * [Revoke API Key](https://docs.arcangel.com/api/admin/api-keys/revoke-api-key) API route.
   * 
   ...
   * [Get API key](https://docs.arcangel.com/api/admin/api-keys/get-api-key) API route.
   * 
   * @param id - The API key's ID.
   * @param headers - Headers to pass in the request.
   * @returns The API key's details.
   ...
   * [Update API Key](https://docs.arcangel.com/api/admin/api-keys/update-an-api-key) API route.
   * 
   * @param id - The API key's ID.
   ...
   * [Delete API Key](https://docs.arcangel.com/api/admin/api-keys/delete-an-api-key) API route.
   * 
   * @param id - The API key's ID.
   * @param headers - Headers to pass in the request.
   ...
   * or remove associations. It sends a request to the [Manage Sales Channels](https://docs.arcangel.com/api/admin/api-keys/manage-sales-channels)
   * API route.
   * 
   * @param id - The API key's ID.
