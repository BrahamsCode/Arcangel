...
export class StockLocation {
   ...
   * [Create Stock Location](https://docs.arcangel.com/api/admin/stock-locations/create-stock-location)
   * API route.
   * 
   ...
   * [Update Stock Location](https://docs.arcangel.com/api/admin/stock-locations/update-a-stock-location)
   * API route.
   * 
   ...
   * [Delete Stock Location](https://docs.arcangel.com/api/admin/stock-locations/delete-a-stock-location)
   * API route.
   * 
   ...
   * [Get Stock Location](https://docs.arcangel.com/api/admin/stock-locations/get-a-stock-location)
   * API route.
   * 
   ...
   * [List Stock Locations](https://docs.arcangel.com/api/admin/stock-locations/list-stock-locations)
   * API route.
   * 
   ...
   * [Manage Stock Location Sales Channels](https://docs.arcangel.com/api/admin/stock-locations/manage-sales-channels)
   * API route.
   * 
   ...
   * [Add Fulfillment Set to Stock Location](https://docs.arcangel.com/api/admin/stock-locations/add-fulfillment-set)
   * API route.
   * 
   ...
   * [Manage Fulfillment Providers of Stock Location](https://docs.arcangel.com/api/admin/stock-locations/manage-fulfillment-providers)
   * API route.
   * 
