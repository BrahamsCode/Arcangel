...
export class User {
   ...
   * [Update User](https://docs.arcangel.com/api/admin/users/update-a-user)
   * API route.
   *
   ...
   * [List Users](https://docs.arcangel.com/api/admin/users/list-users)
   * API route.
   *
   ...
   * [Get User](https://docs.arcangel.com/api/admin/users/get-a-user)
   * API route.
   *
   ...
   * [Delete User](https://docs.arcangel.com/api/admin/users/delete-a-user)
   * API route.
   *
   ...
   * [Get Logged-In User](https://docs.arcangel.com/api/admin/users/get-logged-in-user)
   * API route.
   *
   * @param query - Configure the fields and relations to retrieve in the user.
   * @param headers - Headers to pass in the request.
