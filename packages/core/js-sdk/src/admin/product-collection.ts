...
export class ProductCollection {
   ...
   * [Create Collection](https://docs.arcangel.com/api/admin/collections/create-collection)
   * API route.
   * 
   ...
   * [Update Collection](https://docs.arcangel.com/api/admin/collections/update-a-collection)
   * API route.
   * 
   ...
   * [List Collections](https://docs.arcangel.com/api/admin/collections/list-collections) API route.
   * 
   ...
   * [Get Collection](https://docs.arcangel.com/api/admin/collections/get-a-collection) API route.
   * 
   ...
   * [Delete Collection](https://docs.arcangel.com/api/admin/collections/delete-a-collection)
   * API route.
   * 
   * @param id - The collection's ID.
   * @param headers - Headers to pass in the request
   ...
   * to the [Manage Products](https://docs.arcangel.com/api/admin/collections/manage-products)
   * API route.
   * 
   * @param id - The collection's ID.
