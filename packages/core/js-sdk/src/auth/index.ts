import { AuthTypes, HttpTypes } from "@arcangel/types"
...
export class Auth {
  ...
  mfa = {
     ...
     * [List MFA Factors](https://docs.arcangel.com/api/admin/multi-factor-authentication/list-mfa-factors)
     * API route.
     *
     ...
     * request to the
     * [Create MFA Factor](https://docs.arcangel.com/api/admin/multi-factor-authentication/start-mfa-factor-enrollment)
     * API route.
     *
     ...
     * [Verify MFA Factor](https://docs.arcangel.com/api/admin/multi-factor-authentication/verify-and-enable-mfa-factor)
     * API route.
     *
     ...
     * [Delete MFA Factor](https://docs.arcangel.com/api/admin/auth/disable-mfa-factor)
     * API route.
     *
     ...
     * [Generate MFA Recovery Codes](https://docs.arcangel.com/api/admin/multi-factor-authentication/generate-mfa-recovery-codes)
     * API route.
     *
     ...
     * [Verify MFA Challenge](https://docs.arcangel.com/api/admin/multi-factor-authentication/verify-mfa-challenge)
     * API route.
     *
   ...
   * [Retrieve Registration Token API route](https://docs.arcangel.com/api/store/auth/retrieve-registration-jwt-token).
   *
   * Then, it stores the returned token and passes it in the header of subsequent requests. So, you can call the
   * [store.customer.create](https://docs.arcangel.com/resources/references/js-sdk/store/customer#create) method,
   * for example, after calling this method.
   *
   * Learn more in the [JS SDK Authentication](https://docs.arcangel.com/resources/js-sdk/auth/overview) guide.
   *
   ...
   * actor type. It sends a request to the [Authenticate API Route](https://docs.arcangel.com/api/admin/auth/authenticate-user).
   *
   ...
   * [Third-Party Login in Storefront](https://docs.arcangel.com/resources/storefront-development/customers/third-party-login) guide.
   *
   * :::
   *
   ...
   * [Set Authentication Session API route](https://docs.arcangel.com/api/admin/auth/set-authentication-session).
   *
   * Learn more in the [JS SDK Authentication](https://docs.arcangel.com/resources/js-sdk/auth/overview) guide.
   *
   ...
   * It sends a request to the [Validate Authentication Callback](https://docs.arcangel.com/api/admin/auth/validate-authentication-callback).
   *
   * The method stores the returned token and passes it in the header of subsequent requests. So, you can call the
   * [store.customer.create](https://docs.arcangel.com/resources/references/js-sdk/store/customer#create) or {@link refresh} methods,
   * for example, after calling this method.
   *
   * Learn more in the [JS SDK Authentication](https://docs.arcangel.com/resources/js-sdk/auth/overview) guide.
   *
   ...
   * with {@link callback}. It sends a request to the [Refresh Authentication Token API route](https://docs.arcangel.com/api/admin/auth/refresh-authentication-token).
   *
   ...
   *
   * If the `auth.type` of the SDK is set to `session`, this method will also send a request to the
   * [Delete Authentication Session API route](https://docs.arcangel.com/api/admin/auth/delete-authentication-session).
   *
   ...
   * It sends a request to the [Generate Reset Password Token API route](https://docs.arcangel.com/api/admin/auth/generate-reset-password-token).
   *
   * To reset the password later using the token delivered to the user, use the {@link updateProvider} method.
   *
   * Related guide: [How to allow customers to reset their passwords in a storefront](https://docs.arcangel.com/resources/storefront-development/customers/reset-password).
   *
   * @param actor - The actor type. For example, `user` for admin user, or `customer` for customer.
   ...
   *
   * This method sends a request to [this API route](https://docs.arcangel.com/api/admin/auth/reset-password).
   *
   * Related guide: [How to allow customers to reset their passwords in a storefront](https://docs.arcangel.com/resources/storefront-development/customers/reset-password).
   *
   * @param actor - The actor type. For example, `user` for admin user, or `customer` for customer.
   ...
   * It sends a request to the [List Auth Providers API route](https://docs.arcangel.com/api/admin#auth_getactor_typeproviders).
   *
   ...
   * user is created. It sends a request to the [Provision Auth User API route](https://docs.arcangel.com/api/admin#auth_postauth_provideruser).
   *
