...
export interface ISearchProvider {
  /**
   * Each search provider has a unique identifier, such as `search-arcangel`, used to
   ...
   * in `arcangel-config.ts` to configure the default provider for the Search Module.
   *
