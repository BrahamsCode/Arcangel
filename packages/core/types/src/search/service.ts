...
export interface ISearchModuleService extends IModuleService {
   ...
   * their definitions' `seed` functions. Arcangel handles reindexing automatically, as explained
   * in the [Reindexing and Migrations Guide](https://docs.arcangel.com/resources/infrastructure-modules/search/reindexing).
