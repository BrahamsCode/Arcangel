...
export interface IAuthModuleService extends IModuleService {
   ...
   *
   * Refer to [this guide](https://docs.arcangel.com/resources/commerce-modules/auth/authentication-route) to learn more about the authentication flows.
   *
   ...
   * `req` is an instance of the `ArcangelRequest` object:
   *
   * ```ts
   ...
   *
   * Learn more about this authentication flow in [this guide](https://docs.arcangel.com/resources/commerce-modules/auth/authentication-route#2-third-party-service-authenticate-flow).
   *
