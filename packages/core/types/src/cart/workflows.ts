...
export interface CreateCartCreateLineItemDTO {
   ...
   * [this documentation](https://docs.arcangel.com/resources/commerce-modules/pricing/tax-inclusive-pricing)
   */
...
export interface ConfirmVariantInventoryWorkflowInputDTO {
  ...
  variants: {
    ...
    id: string
    /**
     * Whether Arcangel manages the inventory of the variant. If disabled, the
