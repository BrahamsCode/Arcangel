...
export interface UpdateTaxRateDTO {
   ...
   *
   * Learn more [here](https://docs.arcangel.com/resources/commerce-modules/tax/tax-rates-and-rules#combinable-tax-rates).
   */
...
export interface CreateTaxRateRuleDTO {
   ...
   * For example, `product`.
   *
   * Learn more in [this guide](https://docs.arcangel.com/resources/commerce-modules/tax/tax-rates-and-rules#override-tax-rates-with-rules).
   */
  reference: string
