...
import { ArcangelContainer } from "../common"
...
export * from "../common/arcangel-container"
export * from "./arcangel-internal-service"
...
export type InternalModuleDeclaration = {
  scope: "internal"
  dependencies?: string[]
  definition?: CustomModuleDefinition // That represent the definition of the module, such as the one we have for the arcangel supported modules. This property is used for custom made modules.
