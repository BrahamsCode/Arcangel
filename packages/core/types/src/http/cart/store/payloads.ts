...
export interface StoreCreateCart {
   ...
   * retrieve. Arcangel doesn't reject a variant added to the cart when its
   * product isn't available in the cart's sales channel. Learn how to enforce
   * that validation in
   * [this guide](https://docs.arcangel.com/resources/commerce-modules/cart/sales-channel-availability).
   */
