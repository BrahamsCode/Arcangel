...
export interface StoreShippingOption {
   ...
   * - `calculated`: the price is calculated during checkout by the shipping option's fulfillment provider. Retrieve the price using the [Calculate Shipping Option Price API route](https://docs.arcangel.com/api/store/shipping-options/calculate-shipping-option-price).
   */
