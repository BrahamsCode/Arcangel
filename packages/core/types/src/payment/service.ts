...
export interface IPaymentModuleService extends IModuleService {
   ...
   * from other modules, use [Query](https://docs.arcangel.com/learn/fundamentals/module-links/query) instead.
   * 
   * :::
   *
   * ```ts
   ...
   *
   * Learn more about the payment flow in [this guide](https://docs.arcangel.com/resources/commerce-modules/payment/payment-flow)
   *
   ...
   *
   * Learn more about handling webhook events in [this guide](https://docs.arcangel.com/resources/commerce-modules/payment/webhook-events)
   *
   ...
   *
   * @example
   * In the following example, `req` is an instance of `ArcangelRequest`:
   *
   * ```ts
