import { Logger } from "@arcangel/types"
import { dynamicImport, promiseAll, readDirRecursive } from "@arcangel/utils"
...
export class SearchIndexLoader {
   ...
   * boots, which is why this has to run before `ArcangelApp`.
   */
  async load() {
