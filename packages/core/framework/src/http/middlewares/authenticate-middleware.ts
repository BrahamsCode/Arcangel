import { ApiKeyDTO, IApiKeyModuleService, Logger } from "@arcangel/types"
...
export const authenticate = (
  ...
  const authenticateMiddleware = async (
    ...
    const req_ = req as AuthenticatedArcangelRequest
...
const getApiKeyInfo = async (req: ArcangelRequest): Promise<ApiKeyDTO | null> => {
...
const getAuthContextFromSession = (
  session: Partial<ArcangelSession> = {},
  authTypes: AuthType[],
  actorTypes: string[]
): AuthContext | null => {
