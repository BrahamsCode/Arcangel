...
import { ContainerRegistrationKeys, ArcangelError } from "@arcangel/utils"
import { ArcangelRequest } from "../types"
...
export function getHttpResponseFromError(err: any): ErrorHttpResponse {
  ...
  switch (errorType) {
    ...
    case ArcangelError.Types.CONFLICT:
      statusCode = 409
      ...
      break
    case ArcangelError.Types.UNAUTHORIZED:
      statusCode = 401
      break
    case ArcangelError.Types.FORBIDDEN:
      statusCode = 403
      break
    case ArcangelError.Types.PAYMENT_AUTHORIZATION_ERROR:
      statusCode = 422
      break
    case ArcangelError.Types.DUPLICATE_ERROR:
      statusCode = 422
      body.code = INVALID_REQUEST_ERROR
      break
    case ArcangelError.Types.NOT_ALLOWED:
    case ArcangelError.Types.INVALID_DATA:
      statusCode = 400
      break
    case ArcangelError.Types.NOT_FOUND:
      statusCode = 404
      break
    case ArcangelError.Types.DB_ERROR:
      statusCode = 500
      body.code = API_ERROR
      break
    case ArcangelError.Types.UNEXPECTED_STATE:
    case ArcangelError.Types.INVALID_ARGUMENT:
      break
    default:
  ...
  return function coreErrorHandler(
    ...
    if ("issues" in err && Array.isArray(err.issues)) {
      ...
      res.status(statusCode).json({
        type: ArcangelError.Types.INVALID_DATA,
...
const mapStatusCodeToErrorType = (statusCode: number) => {
  switch (statusCode) {
    case 400:
      return ArcangelError.Types.INVALID_DATA
    case 401:
      return ArcangelError.Types.UNAUTHORIZED
    case 403:
      return ArcangelError.Types.FORBIDDEN
    case 404:
      return ArcangelError.Types.NOT_FOUND
    case 409:
      return ArcangelError.Types.CONFLICT
    default:
