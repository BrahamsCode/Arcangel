...
import * as utils from "@arcangel/utils"
import { Query } from "../query"

jest.mock("@arcangel/utils", () => ({
  ...jest.requireActual("@arcangel/utils"),
...
function createMockContainer(): ArcangelContainer {
  return {
    resolve: jest.fn(),
...
function createQueryInstance(
  queryResult: any = [],
  container: ArcangelContainer = createMockContainer()
) {
  return {
    query: new Query({
