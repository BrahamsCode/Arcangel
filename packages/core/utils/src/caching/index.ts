import { ICachingModuleService, Logger, ArcangelContainer } from "@arcangel/types"
import { ArcangelContextType, Modules } from "../modules-sdk"
...
>(options: {
  ...
  container: ArcangelContainer | ((this: Target) => ArcangelContainer)
}) {
  return function (
    target: Target,
    ...
    descriptor.value = async function (
      ...
      const container: ArcangelContainer =
