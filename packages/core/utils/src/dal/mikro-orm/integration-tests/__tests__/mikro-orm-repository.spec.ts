...
import { defineConfig } from "@arcangel/deps/mikro-orm/postgresql"
import { BigNumberRawValue } from "@arcangel/types"
...
describe("mikroOrmRepository", () => {
  ...
  beforeEach(async () => {
    ...
    orm = await MikroORM.init(
      defineConfig({
        ...
        // Match Arcangel's production config: soft-delete filters are not
  ...
  describe("error mapping", () => {
    it("should map UniqueConstraintViolationException to ArcangelError on upsertWithReplace", async () => {
    ...
    it("should map NotNullConstraintViolationException ArcangelError on upsertWithReplace", async () => {
    ...
    it("should map InvalidFieldNameException ArcangelError on upsertWithReplace", async () => {
    ...
    it("should map ForeignKeyConstraintViolationException ArcangelError on upsertWithReplace", async () => {
      const entity2 = {
        title: "en2",
        handle: "some-handle",
        entity1: { id: "1" },
