  ...
  implements IFulfillmentProvider
{
   ...
   * @example
   * // other imports...
   * import { FulfillmentOption } from "@arcangel/framework/types"
   *
   * class MyFulfillmentProviderService extends AbstractFulfillmentProviderService {
   *   // ...
   ...
   *
   * This method is invoked in Arcangel whenever the calculated shipping option's price needs to be resolved
   * against a cart:
   *
   ...
   *
   * @example
   * import { CalculateShippingOptionPriceDTO } from "@arcangel/framework/types"
   * class MyFulfillmentProviderService extends AbstractFulfillmentProviderService {
   *   // ...
