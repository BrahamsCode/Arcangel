  ...
  implements IPaymentProvider
{
  ...
  /**
   * This method validates the options of the provider set in `arcangel-config.ts`.
   ...
   *
   * @param options - The provider's options passed in `arcangel-config.ts`.
   *
   * @example
  ...
  /**
   * The constructor allows you to access resources from the [module's container](https://docs.arcangel.com/learn/fundamentals/modules/container)
   ...
   * :::note
   *
   * A module's options are passed when you register it in the Arcangel application.
   *
   * :::
   *
   ...
   *
   * @example
   * import { AbstractPaymentProvider } from "@arcangel/framework/utils"
   ...
   * property in the `arcangel-config.ts`.
   *
   * @example
   ...
   * 
   * ![Diagram showcasing capture payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307414/Arcangel%20Resources/Klarna_Payment_Graphic_2025_1_lii7bw.jpg)
   * 
   ...
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309870/Arcangel%20Resources/capture-data_acgdhf.jpg)
   *
   ...
   * 
   * ![Diagram showcasing authorize payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307795/Arcangel%20Resources/authorize-payment_qzpy6e.jpg)
   * 
   ...
   * For example, you can store the ID of the payment in the third-party provider to reference it later.
   *
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309278/Arcangel%20Resources/authorize-data_erjg7r.jpg)
   *
   ...
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310189/Arcangel%20Resources/cancel-data_gzcgbc.jpg)
   *
   ...
   * 
   * ![Diagram showcasing initiate payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310624/Arcangel%20Resources/initiate-payment_dpoa2g.jpg)
   * 
   * #### Understanding `data` property
   * 
   ...
   * :::
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310699/Arcangel%20Resources/initiate-data_ikc05t.jpg)
   *
   ...
   * 
   * ![Diagram showcasing delete payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/Arcangel%20Resources/delete-payment_smxsiq.jpg)
   * 
   * #### Understanding `data` property
   * 
   * The `data` property of the method's parameter contains the `PaymentSession` record's `data` property, which was
   * returned by the {@link initiatePayment} method.
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/Arcangel%20Resources/delete-data_xg65ck.jpg)
   *
   ...
   * :::
   * 
   * ![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311296/Arcangel%20Resources/refund-data_plcjl0.jpg)
   *
  ...
  /**
   * This method is executed when a webhook event is received from the third-party payment provider. Arcangel uses
   * the data returned by this method to perform actions in the Arcangel application, such as completing the associated cart
   * if the payment was authorized successfully.
   *
   * Learn more in the [Webhook Events](https://docs.arcangel.com/resources/commerce-modules/payment/webhook-events) documentation.
   *
   * @param data - The webhook event's data
   * @returns The webhook result. If the `action`'s value is `captured`, the payment is captured within Arcangel as well.
   * If the `action`'s value is `authorized`, the associated payment session is authorized within Arcangel and the associated cart
