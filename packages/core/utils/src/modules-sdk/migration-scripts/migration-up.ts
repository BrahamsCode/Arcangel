import { LoaderOptions, Logger, ModulesSdkTypes } from "@arcangel/types"
import { mikroOrmCreateConnection } from "../../dal"
import { loadDatabaseConfig } from "../load-module-database-config"
import { Migrations } from "../../migrations"
import { ArcangelError } from "../../common/errors"
...
export function buildMigrationScript({ moduleName, pathToMigrations }) {
  ...
  > = {}) {
    ...
    try {
      ...
      throw new ArcangelError(ArcangelError.Types.DB_ERROR, error.message)
    }
  }
}
