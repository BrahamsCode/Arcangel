import { getCallerFilePath, isFileDisabled, ARCANGEL_SKIP_FILE } from "../common"
import { toSnakeCase } from "../common/to-snake-case"

export const ArcangelPolicySymbol = Symbol.for("ArcangelPolicy")
...
export interface definePoliciesExport {
  [ArcangelPolicySymbol]: boolean
  policies: PolicyDefinition[]
}

// This will be overridden by the actual interface when arcangel types are loaded
