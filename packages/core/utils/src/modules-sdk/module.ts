import { Constructor, IDmlEntity, ModuleExports } from "@arcangel/types"
...
import { ArcangelServiceModelObjectsSymbol } from "./arcangel-service"
...
>(
  ...
  const modelObjects = service[ArcangelServiceModelObjectsSymbol] ?? {}
