 ...
 * - "policy-bindings.d.ts" - Module augmentation for @arcangel/framework/utils
 *
...
// Module augmentation for @arcangel/framework/utils
// Types and globals are defined in policy-types.d.ts
declare module "@arcangel/framework/utils" {
