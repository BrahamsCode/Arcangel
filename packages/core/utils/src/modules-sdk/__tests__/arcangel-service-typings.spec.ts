...
import { ArcangelService } from "../arcangel-service"
import { InferTypeOf } from "@arcangel/types"
...
describe("Arcangel Service typings", () => {
  describe("create<Service>", () => {
    test("type-hint model properties", () => {
      class BlogService extends ArcangelService({ Blog, Comment }) {}
    ...
    test("type-hint DTO properties", () => {
      class BlogService extends ArcangelService<{ Blog: { dto: BlogDTO } }>({
        Blog,
      }) {}
      const blogService = new BlogService(containerMock)
    ...
    test("define custom DTO for inputs", () => {
      class BlogService extends ArcangelService<{
  ...
  describe("update<Service>", () => {
    test("type-hint model properties", () => {
      class BlogService extends ArcangelService({ Blog }) {}
      const blogService = new BlogService(containerMock)
