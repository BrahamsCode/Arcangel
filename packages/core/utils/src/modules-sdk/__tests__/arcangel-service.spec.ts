...
import { ModuleJoinerConfig } from "@arcangel/types"
...
describe("Abstract Module Service Factory", () => {
  ...
  const arcangelService = ArcangelService({
    MainModelMock,
    OtherModelMock1,
    OtherModelMock2,
  })
  ...
  describe("Main Model Methods", () => {
    let instance: InstanceType<typeof arcangelService>

    beforeEach(() => {
      jest.clearAllMocks()
      instance = new arcangelService(containerMock)
