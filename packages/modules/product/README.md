...
[Product Module documentation](https://docs.arcangel.com/v2/resources/commerce-modules/product) | [Arcangel Website](https://arcangel.com/) | [Arcangel Repository](https://github.com/arcangel/arcangel)
...
> If you are using an existing Arcangel database, you can skip this step. This step is only applicable when the module is used in isolation from a full Arcangel setup
...
"scripts": {
    //...other scripts
    "product:migrations:run": "arcangel-product-migrations-up",
    "product:seed": "arcangel-product-seed ./seed-data.js"
},
```
...
const nextConfig = {
  experimental: {
    serverComponentsExternalPackages: ["@arcangel/product"],
  },
}
...
import { initialize as initializeProductModule } from "@arcangel/product"
...
Then, open in your browser the URL `http://localhost:3000/api/products`. If you seeded your database with demo products, or you’re using a Arcangel database schema, you’ll receive the products in your database. Otherwise, the request will return an empty array.
