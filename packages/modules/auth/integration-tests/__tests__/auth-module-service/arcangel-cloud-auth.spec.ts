...
import { IAuthModuleService } from "@arcangel/types"
...
const TOKEN_ENDPOINT = "https://arcangel.cloud/oauth/token"
const JWKS_URI = "https://arcangel.cloud/oauth/jwks"
...
moduleIntegrationTestRunner<IAuthModuleService>({
  ...
  moduleOptions: {
    cloud: {
      oauth_authorize_endpoint: "https://arcangel.cloud/oauth/authorize",
  ...
  testSuite: ({ service }) =>
    describe("Arcangel Cloud Auth provider", () => {
      afterEach(() => {
        mockCache.clear()
...
moduleIntegrationTestRunner<IAuthModuleService>({
  ...
  testSuite: ({ service }) =>
    describe("Arcangel Cloud Auth provider - when cloud options are not provided", () => {
...
moduleIntegrationTestRunner<IAuthModuleService>({
  ...
  testSuite: ({ service }) =>
    describe("Arcangel Cloud Auth provider - when cloud auth is disabled", () => {
      it("should not enable Arcangel Cloud Email provider", async () => {
        const error = await service
          .authenticate("cloud", {
            query: {},
