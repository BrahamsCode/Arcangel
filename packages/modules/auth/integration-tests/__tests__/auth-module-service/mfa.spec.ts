import { AuthTypes, IAuthModuleService } from "@arcangel/framework/types"
  ...
  testSuite: ({ MikroOrmWrapper, service }) => {
    describe("AuthModuleService - MFA", () => {
      ...
      it("provisions a pending TOTP factor without exposing the encrypted secret", async () => {
        ...
        expect(setup.otpauth_url).toContain("Arcangel%20Test:Authenticator%20app")
        expect(setup.otpauth_url).toContain("issuer=Arcangel%20Test")
        ...
        expect(providerMetadata.issuer).toEqual("Arcangel Test")
