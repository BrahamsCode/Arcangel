...
export type AuthModuleOptions = Partial<ModuleServiceInitializeOptions> & {
  ...
  /**
   * Options for the default Arcangel Cloud Auth provider
   * @private
   */
  cloud?: ArcangelCloudAuthProviderOptions
  /**
   * MFA configuration.
   */
  mfa?: {
...
export interface ArcangelCloudAuthProviderOptions {
...
declare module "@arcangel/types" {
  interface ModuleOptions {
    "@arcangel/auth": AuthModuleOptions
    "@arcangel/arcangel/auth": AuthModuleOptions
  }
}
