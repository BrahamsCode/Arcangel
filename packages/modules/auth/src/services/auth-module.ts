...
type InjectedDependencies = {
  ...
  authIdentityService: ModulesSdkTypes.IArcangelInternalService<any>
  authVerificationService: ModulesSdkTypes.IArcangelInternalService<any>
  authPasswordResetTokenService: ModulesSdkTypes.IArcangelInternalService<any>
  authMfaFactorService: ModulesSdkTypes.IArcangelInternalService<any>
  authMfaRecoveryCodeService: ModulesSdkTypes.IArcangelInternalService<any>
  providerIdentityService: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  implements AuthTypes.IAuthModuleService
{
  ...
  protected authIdentityService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof AuthIdentity>
  >
  protected authVerificationService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof AuthVerification>
  >
  protected authPasswordResetTokenService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof AuthPasswordResetToken>
  >
  protected authMfaFactorService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof AuthMfaFactor>
  >
  protected authMfaRecoveryCodeService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof AuthMfaRecoveryCode>
  >
  protected providerIdentityService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  protected async consumePasswordResetToken_(
    ...
    if (!resetToken) {
      throw new ArcangelError(ArcangelError.Types.UNAUTHORIZED, "Invalid token")
    }
