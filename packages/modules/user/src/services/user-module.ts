...
type InjectedDependencies = {
  ...
  userService: ModulesSdkTypes.IArcangelInternalService<any>
  inviteService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements UserTypes.IUserModuleService
{
  ...
  protected readonly userService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof User>
  >
  protected readonly inviteService_: ModulesSdkTypes.IArcangelInternalService<
