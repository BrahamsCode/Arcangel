...
export class InitialSetup20240226130829 extends Migration {
  async up(): Promise<void> {
    ...
    if (storeTables.length > 0) {
      ...
      this.addSql(
        `alter table "store" alter column "name" SET DEFAULT 'Arcangel Store';`
      )
      this.addSql(
      ...
      ("id" text not null, "name" text not null default \'Arcangel Store\', "supported_currency_codes" text[] not null default \'{}\',
