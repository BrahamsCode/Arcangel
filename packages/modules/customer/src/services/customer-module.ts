...
type InjectedDependencies = {
  ...
  customerService: ModulesSdkTypes.IArcangelInternalService<any>
  customerAddressService: ModulesSdkTypes.IArcangelInternalService<any>
  customerGroupService: ModulesSdkTypes.IArcangelInternalService<any>
  customerGroupCustomerService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements ICustomerModuleService
{
  ...
  protected customerService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Customer>
  >
  protected customerAddressService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof CustomerAddress>
  >
  protected customerGroupService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof CustomerGroup>
  >
  protected customerGroupCustomerService_: ModulesSdkTypes.IArcangelInternalService<
