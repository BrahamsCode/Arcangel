import { FileTypes, LocalFileServiceOptions } from "@arcangel/framework/types"
import {
...
export class LocalFileService extends AbstractFileProviderService {
  ...
  async upload(
    ...
    if (!file) {
      throw new ArcangelError(ArcangelError.Types.INVALID_DATA, `No file provided`)
    }
   ...
   * a file upload. In this case, the Arcangel backend will implement the
