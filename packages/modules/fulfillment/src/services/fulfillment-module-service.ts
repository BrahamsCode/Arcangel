...
type InjectedDependencies = {
  ...
  fulfillmentAddressService: ModulesSdkTypes.IArcangelInternalService<any>
  fulfillmentSetService: ModulesSdkTypes.IArcangelInternalService<any>
  serviceZoneService: ModulesSdkTypes.IArcangelInternalService<any>
  geoZoneService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingProfileService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingOptionService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingOptionRuleService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingOptionTypeService: ModulesSdkTypes.IArcangelInternalService<any>
  fulfillmentProviderService: FulfillmentProviderService
  fulfillmentService: ModulesSdkTypes.IArcangelInternalService<any>
  logger?: Logger
}
  ...
  implements IFulfillmentModuleService
{
  ...
  protected readonly fulfillmentSetService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof FulfillmentSet>
  >
  protected readonly serviceZoneService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ServiceZone>
  >
  protected readonly geoZoneService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof GeoZone>
  >
  protected readonly shippingProfileService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingProfile>
  >
  protected readonly shippingOptionService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingOption>
  >
  protected readonly shippingOptionRuleService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingOptionRule>
  >
  protected readonly shippingOptionTypeService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingOptionType>
  >
  protected readonly fulfillmentProviderService_: FulfillmentProviderService
  protected readonly fulfillmentService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  protected static buildGeoZoneConstraintsFromAddress(
     ...
     * to this pr https://github.com/arcangel/arcangel/pull/8066
     */
