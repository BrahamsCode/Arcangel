...
type InjectedDependencies = {
  ...
  taxRateService: ModulesSdkTypes.IArcangelInternalService<any>
  taxRegionService: ModulesSdkTypes.IArcangelInternalService<any>
  taxRateRuleService: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  implements ITaxModuleService
{
  ...
  protected taxRateService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof TaxRate>
  >
  protected taxRegionService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof TaxRegion>
  >
  protected taxRateRuleService_: ModulesSdkTypes.IArcangelInternalService<
