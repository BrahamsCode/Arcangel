import { DAL, ITaxProvider, Logger, TaxTypes } from "@arcangel/framework/types"
...
export default class TaxProviderService extends ModulesSdkUtils.ArcangelInternalService<InjectedDependencies>(
  TaxProvider
) {
  #logger: Logger
