...
import { SqlEntityManager } from "@arcangel/framework/mikro-orm/postgresql"
import {
  ApplicationMethod,
  Campaign,
  CampaignBudget,
...
type InjectedDependencies = {
  ...
  promotionService: ModulesSdkTypes.IArcangelInternalService<any>
  applicationMethodService: ModulesSdkTypes.IArcangelInternalService<any>
  promotionRuleService: ModulesSdkTypes.IArcangelInternalService<any>
  promotionRuleValueService: ModulesSdkTypes.IArcangelInternalService<any>
  campaignService: ModulesSdkTypes.IArcangelInternalService<any>
  campaignBudgetService: ModulesSdkTypes.IArcangelInternalService<any>
  campaignBudgetUsageService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements PromotionTypes.IPromotionModuleService
{
  ...
  protected promotionService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Promotion>
  >
  protected applicationMethodService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ApplicationMethod>
  >
  protected promotionRuleService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PromotionRule>
  >
  protected promotionRuleValueService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PromotionRuleValue>
  >
  protected campaignService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Campaign>
  >
  protected campaignBudgetService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof CampaignBudget>
  >

  protected campaignBudgetUsageService_: ModulesSdkTypes.IArcangelInternalService<
   ...
   * @returns void
   * @throws {ArcangelError} - If the promotion usage exceeds the budget limit.
   */
  async registerUsage(
