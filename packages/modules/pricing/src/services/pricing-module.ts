...
import { Collection } from "@arcangel/framework/mikro-orm/core"
...
type InjectedDependencies = {
  ...
  priceSetService: ModulesSdkTypes.IArcangelInternalService<any>
  priceRuleService: ModulesSdkTypes.IArcangelInternalService<any>
  priceService: ModulesSdkTypes.IArcangelInternalService<any>
  priceListService: ModulesSdkTypes.IArcangelInternalService<any>
  pricePreferenceService: ModulesSdkTypes.IArcangelInternalService<any>
  priceListRuleService: ModulesSdkTypes.IArcangelInternalService<any>
}
...
const BaseClass = ModulesSdkUtils.ArcangelService<{
...
{
  protected readonly container_: ArcangelContainer
  protected baseRepository_: DAL.RepositoryService
  protected readonly pricingRepository_: PricingRepositoryService & {
    clearAvailableAttributes?: () => Promise<void>
  }
  protected readonly priceSetService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PriceSet>
  >
  protected readonly priceRuleService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PriceRule>
  >
  protected readonly priceService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Price>
  >
  protected readonly priceListService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PriceList>
  >
  protected readonly priceListRuleService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof PriceListRule>
  >
  protected readonly pricePreferenceService_: ModulesSdkTypes.IArcangelInternalService<
