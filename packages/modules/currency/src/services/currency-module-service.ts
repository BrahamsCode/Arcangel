...
import { ArcangelService, normalizeCurrencyCode } from "@arcangel/framework/utils"
import { Currency } from "@models"

type InjectedDependencies = {
  baseRepository: DAL.RepositoryService
  currencyService: ModulesSdkTypes.IArcangelInternalService<typeof Currency>
}
  ...
  implements ICurrencyModuleService
{
  ...
  protected readonly currencyService_: ModulesSdkTypes.IArcangelInternalService<
    typeof Currency
  >
