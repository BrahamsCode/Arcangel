...
describe("Arcangel search utilities", () => {
    ...
    const optedIn = buildIndexPlan({
      ...
      fields: {
        ...
        title: {
          type: "text",
          searchable: true,
          provider_options: { "search-arcangel": { glob: true } },
        },
      },
    })
    ...
    const withoutGlob = buildIndexPlan({
      ...
      fields: {
        ...
        status: {
          type: "keyword",
          filterable: true,
          provider_options: { "search-arcangel": { glob: false } },
        },
      },
    })
      ...
      const disabled = buildIndexPlan({
        ...
        fields: {
          ...
          title: {
            type: "text",
            searchable: true,
            provider_options: { "search-arcangel": { fuzzy: false } },
          },
        },
      })
  ...
  describe("highlighting", () => {
    it("builds a Highlight compute_attributes expression with default tags", () => {
      ...
      expect(query.highlight).toEqual({
        pre_tag: "<mark>",
        post_tag: "</mark>",
        fields: [{ path: "title", key: "__arcangel_highlight_0__" }],
      })
    })
    ...
    it("crops fragments and honors custom tags when snippet is requested", () => {
      ...
      expect(query.query.compute_attributes?.__arcangel_highlight_0__).toEqual([
        "Highlight",
        "title",
        {
