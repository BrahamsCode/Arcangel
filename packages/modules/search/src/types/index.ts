...
export type SearchModuleOptions = Partial<ModuleServiceInitializeOptions> & {
  ...
  /**
   * Arcangel Cloud search. When set, the module registers the built-in
   * `search-arcangel` provider automatically — same pattern as payment `cloud`
...
declare module "@arcangel/types" {
  interface ModuleOptions {
    "@arcangel/search": SearchModuleOptions
    "@arcangel/arcangel/search": SearchModuleOptions
  }
}
...
export type SearchIndexContext = {
  ...
  indexService: ModulesSdkTypes.IArcangelInternalService<any>
  versionService: ModulesSdkTypes.IArcangelInternalService<any>
  syncService: ModulesSdkTypes.IArcangelInternalService<any>
