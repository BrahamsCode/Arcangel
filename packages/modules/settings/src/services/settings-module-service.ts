...
type InjectedDependencies = {
  ...
  viewConfigurationService: ModulesSdkTypes.IArcangelInternalService<any>
  propertyLabelService: ModulesSdkTypes.IArcangelInternalService<any>
  layoutConfigurationService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements SettingsTypes.ISettingsModuleService
{
  ...
  protected readonly viewConfigurationService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ViewConfiguration>
  >
  protected readonly propertyLabelService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  protected readonly layoutConfigurationService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  __hooks = {
    onApplicationStart: async () => {
      ...
      const joinerConfigs = ArcangelModule.getAllJoinerConfigs()
    ...
    for (const config of dataArray) {
      ...
      if (config.is_system_default) {
        ...
        if (existingDefault.length > 0) {
          throw new ArcangelError(
            ArcangelError.Types.DUPLICATE_ERROR,
