...
export type NotificationModuleOptions =
  Partial<ModuleServiceInitializeOptions> & {
    ...
    /**
     * Options for the default Arcangel Cloud Email provider
     * @private
     */
    cloud?: ArcangelCloudEmailOptions
  }

export type ArcangelCloudEmailOptions = {
  api_key: string
  endpoint: string
...
declare module "@arcangel/types" {
  interface ModuleOptions {
    "@arcangel/notification": NotificationModuleOptions
    "@arcangel/arcangel/notification": NotificationModuleOptions
  }
}
