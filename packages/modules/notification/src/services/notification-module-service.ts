...
type InjectedDependencies = {
  ...
  notificationService: ModulesSdkTypes.IArcangelInternalService<
    typeof Notification
  >
  ...
  implements INotificationModuleService
{
  ...
  protected readonly notificationService_: ModulesSdkTypes.IArcangelInternalService<
    typeof Notification
  >
      ...
      await promiseAll(
        notificationsToProcess.map(async (entry) => {
          ...
          if (!provider?.is_enabled) {
            ...
            throw new ArcangelError(ArcangelError.Types.NOT_FOUND, errorMessage)
          }
