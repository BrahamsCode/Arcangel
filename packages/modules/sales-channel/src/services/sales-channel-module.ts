...
type InjectedDependencies = {
  ...
  salesChannelService: ModulesSdkTypes.IArcangelInternalService<any>
}

export default class SalesChannelModuleService
  extends ArcangelService<{ SalesChannel: { dto: SalesChannelDTO } }>({
    SalesChannel,
  })
  implements ISalesChannelModuleService
{
  protected baseRepository_: DAL.RepositoryService
  protected readonly salesChannelService_: ModulesSdkTypes.IArcangelInternalService<
