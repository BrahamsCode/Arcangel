...
type InjectedDependencies = {
  ...
  stockLocationService: ModulesSdkTypes.IArcangelInternalService<any>
  stockLocationAddressService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements IStockLocationService
{
  ...
  protected readonly stockLocationService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof StockLocation>
  >
  protected readonly stockLocationAddressService_: ModulesSdkTypes.IArcangelInternalService<
