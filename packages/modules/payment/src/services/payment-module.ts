...
type InjectedDependencies = {
  ...
  paymentService: ModulesSdkTypes.IArcangelInternalService<any>
  captureService: ModulesSdkTypes.IArcangelInternalService<any>
  refundService: ModulesSdkTypes.IArcangelInternalService<any>
  paymentSessionService: ModulesSdkTypes.IArcangelInternalService<any>
  paymentCollectionService: ModulesSdkTypes.IArcangelInternalService<any>
  accountHolderService: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  implements IPaymentModuleService
{
  ...
  protected paymentService_: ModulesSdkTypes.IArcangelInternalService<
    typeof Payment
  >
  protected captureService_: ModulesSdkTypes.IArcangelInternalService<
    typeof Capture
  >
  protected refundService_: ModulesSdkTypes.IArcangelInternalService<
    typeof Refund
  >
  protected paymentSessionService_: ModulesSdkTypes.IArcangelInternalService<
    typeof PaymentSession
  >
  protected paymentCollectionService_: ModulesSdkTypes.IArcangelInternalService<
    typeof PaymentCollection
  >
  protected paymentProviderService_: PaymentProviderService
  protected accountHolderService_: ModulesSdkTypes.IArcangelInternalService<
