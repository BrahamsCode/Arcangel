...
type InjectedDependencies = {
  ...
  rbacRolePolicyService: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof RbacRolePolicy>
  >
  rbacRoleService: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof RbacRole>
  >
  rbacPolicyService: ModulesSdkTypes.IArcangelInternalService<
  ...
  implements IRbacModuleService
{
  ...
  protected readonly rbacRolePolicyService: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof RbacRolePolicy>
  >
  protected readonly rbacRoleService: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof RbacRole>
  >
  protected readonly rbacPolicyService: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof RbacPolicy>
  >
