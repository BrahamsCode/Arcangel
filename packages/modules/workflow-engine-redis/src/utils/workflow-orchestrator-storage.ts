...
} from "@arcangel/framework/orchestration"
...
{
  private workflowExecutionService_: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  constructor({
    ...
    workflowExecutionService: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  private async executeScheduledJob(
    ...
    try {
      ...
      if (e instanceof ArcangelError && e.type === ArcangelError.Types.NOT_FOUND) {
        this.logger_?.warn(
