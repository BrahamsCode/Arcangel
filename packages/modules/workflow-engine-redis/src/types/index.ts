...
declare module "@arcangel/types" {
  interface ModuleOptions {
    "@arcangel/workflow-engine-redis": RedisWorkflowsOptions
    "@arcangel/arcangel/workflow-engine-redis": RedisWorkflowsOptions
  }
}
