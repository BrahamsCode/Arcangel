...
type InjectedDependencies = {
  ...
  cartService: ModulesSdkTypes.IArcangelInternalService<any>
  addressService: ModulesSdkTypes.IArcangelInternalService<any>
  lineItemService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingMethodAdjustmentService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingMethodService: ModulesSdkTypes.IArcangelInternalService<any>
  lineItemAdjustmentService: ModulesSdkTypes.IArcangelInternalService<any>
  lineItemTaxLineService: ModulesSdkTypes.IArcangelInternalService<any>
  shippingMethodTaxLineService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements ICartModuleService
{
  ...
  protected cartService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Cart>
  >
  protected addressService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof Address>
  >
  protected lineItemService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof LineItem>
  >
  protected shippingMethodAdjustmentService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingMethodAdjustment>
  >
  protected shippingMethodService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof ShippingMethod>
  >
  protected lineItemAdjustmentService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof LineItemAdjustment>
  >
  protected lineItemTaxLineService_: ModulesSdkTypes.IArcangelInternalService<
    InferEntityType<typeof LineItemTaxLine>
  >
  protected shippingMethodTaxLineService_: ModulesSdkTypes.IArcangelInternalService<
