...
type InjectedDependencies = {
  ...
  inventoryItemService: ModulesSdkTypes.IArcangelInternalService<any>
  inventoryLevelService: InventoryLevelService
  reservationItemService: ModulesSdkTypes.IArcangelInternalService<any>
}
  ...
  implements IInventoryService
{
  ...
  protected readonly inventoryItemService_: ModulesSdkTypes.IArcangelInternalService<
    typeof InventoryItem
  >
  protected readonly reservationItemService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  private async ensureInventoryLevels(
    ...
    if (missing.length) {
      ...
      throw new ArcangelError(ArcangelError.Types.NOT_FOUND, error)
    }
  ...
  async createReservationItems(
    input:
      ...
      | InventoryTypes.CreateReservationItemInput,
    @ArcangelContext() context: Context = {}
  ): Promise<
