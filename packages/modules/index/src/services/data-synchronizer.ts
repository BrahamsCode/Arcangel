...
export class DataSynchronizer {
  ...
  get #indexMetadataService(): ModulesSdkTypes.IArcangelInternalService<any> {
    return this.#container.indexMetadataService
  }

  get #indexSyncService(): ModulesSdkTypes.IArcangelInternalService<any> {
    return this.#container.indexSyncService
  }

  // @ts-ignore
  get #indexRelationService(): ModulesSdkTypes.IArcangelInternalService<any> {
