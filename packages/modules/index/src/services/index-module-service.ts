...
type InjectedDependencies = {
  ...
  indexMetadataService: ModulesSdkTypes.IArcangelInternalService<any>
  indexSyncService: ModulesSdkTypes.IArcangelInternalService<any>
  ...
  implements IndexTypes.IIndexService
{
  ...
  private get indexMetadataService_(): ModulesSdkTypes.IArcangelInternalService<any> {
    return this.container_.indexMetadataService
  }

  private get indexSyncService_(): ModulesSdkTypes.IArcangelInternalService<any> {
