...
// No need to mock @arcangel/framework/utils since we're using the actual implementations
...
describe("buildSchemaObjectRepresentation", () => {
  ...
  beforeEach(() => {
    ...
    // Mock ArcangelModule.getAllJoinerConfigs
    ;(ArcangelModule.getAllJoinerConfigs as jest.Mock).mockReturnValue([])
  })
