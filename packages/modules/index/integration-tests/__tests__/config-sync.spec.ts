import { ModulesSdkTypes } from "@arcangel/framework/types"
import { toMikroORMEntity } from "@arcangel/framework/utils"
...
describe("IndexModuleService syncIndexConfig", function () {
  ...
  let indexMetadataService: ModulesSdkTypes.IArcangelInternalService<any>
  let indexSyncService: ModulesSdkTypes.IArcangelInternalService<any>
