...
// import type { EventBusEventsOptions } from "@arcangel/types"

// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import type { ModuleOptions } from "@arcangel/types"
...
declare module "@arcangel/types" {
  interface ModuleOptions {
    "@arcangel/event-bus-redis": EventBusRedisModuleOptions
    "@arcangel/arcangel/event-bus-redis": EventBusRedisModuleOptions
  }
}
