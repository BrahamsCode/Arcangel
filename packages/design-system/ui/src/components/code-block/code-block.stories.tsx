...
const snippets = [
  ...
  {
    label: "Arcangel JS Client",
    language: "jsx",
    code: `// Install the JS Client in your storefront project: @arcangel/arcangel-js\n\nimport Arcangel from "@arcangel/arcangel-js"\n\nconst arcangel = new Arcangel({ publishableApiKey: "YOUR_API_KEY"})\nconst product = await arcangel.products.retrieve("PRODUCT_ID")\nconsole.log(product.id)`,
  },
  {
    label: "Arcangel React",
    language: "tsx",
    code: `// Install the React SDK and required dependencies in your storefront project:\n// arcangel-react @tanstack/react-query @arcangel/arcangel\n\nimport { useProduct } from "arcangel-react"\n\nconst { product } = useProduct("PRODUCT_ID")\nconsole.log(product.id)`,
  },
]
