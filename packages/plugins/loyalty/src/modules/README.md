...
A module is a package of reusable functionalities. It can be integrated into your Arcangel application without affecting the overall system.
...
The last step is to add the module in Arcangel’s configurations.

In `arcangel-config.js`, add the module to the `modules` object:

```js title="arcangel-config.js"
