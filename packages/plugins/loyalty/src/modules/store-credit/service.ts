/* eslint-disable @arcangel/use-inject-manager-on-public-methods */
import {
  BigNumberValue,
  Context,
  DAL,
...
type InjectedDependencies = {
  ...
  accountTransactionService: ModulesSdkTypes.IArcangelInternalService<any>;
};
  ...
  implements IStoreCreditModuleService
{
  ...
  protected readonly accountTransactionService_: ModulesSdkTypes.IArcangelInternalService<
  ...
  /**
   * `ArcangelService` derives its generated method names from the model name, so
