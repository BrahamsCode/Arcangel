...
export const GET = async (
  req: AuthenticatedArcangelRequest<AdminGetStoreCreditAccountsParams>,
  res: ArcangelResponse<AdminStoreCreditAccountsResponse>
) => {
...
export const POST = async (
  req: AuthenticatedArcangelRequest<AdminCreateStoreCreditAccount>,
