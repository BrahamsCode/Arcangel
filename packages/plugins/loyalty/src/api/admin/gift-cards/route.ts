...
export const GET = async (
  req: AuthenticatedArcangelRequest<AdminGetGiftCardsParams>,
  res: ArcangelResponse<AdminGiftCardsResponse>
) => {
...
export const POST = async (
  req: AuthenticatedArcangelRequest<AdminCreateGiftCardParams>,
