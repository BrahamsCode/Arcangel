...
This starter is compatible with versions >= 2.0.0 of `@arcangel/arcangel`. 

## Getting Started

Visit the [Quickstart Guide](https://docs.arcangel.com/learn) to set up a server.

Visit the [Docs](https://docs.arcangel.com/learn#get-started) to learn more about our system requirements.

## What is Arcangel

Arcangel is a set of commerce modules and tools that allow you to build rich, reliable, and performant commerce applications without reinventing core commerce logic. The modules can be customized and used to build advanced ecommerce stores, marketplaces, or any product that needs foundational commerce primitives. All modules are open-source and freely available on npm.

Learn more about [Arcangel’s architecture](https://docs.arcangel.com/learn/advanced-development/architecture/overview) and [commerce modules](https://docs.arcangel.com/learn/basics/commerce-modules) in the Docs.
