...
import { startApp } from "../arcangel-test-runner-utils/bootstrap-app"

const flushMicrotasks = () => new Promise((resolve) => setImmediate(resolve))

describe("startApp", () => {
  const ENV_KEY = "ARCANGEL_TEST_UTILS_BOOTSTRAP_ENV"
