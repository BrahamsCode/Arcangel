import { applyEnvVarsToProcess } from "../arcangel-test-runner-utils/utils"

describe("applyEnvVarsToProcess", () => {
  const NEW_KEY = "ARCANGEL_TEST_UTILS_NEW_ENV"
  const EXISTING_KEY = "ARCANGEL_TEST_UTILS_EXISTING_ENV"
