 ...
 *     description: Whether Arcangel manages the variant's inventory. If disabled, the variant is always considered in stock.
 *     externalDocs:
 *       url: https://docs.arcangel.com/resources/storefront-development/products/inventory
