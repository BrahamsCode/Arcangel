 ...
 * 
 *       A product's availability in a sales channel only filters the products you retrieve. Arcangel doesn't reject a variant added to the cart when its product isn't available in the cart's sales channel. Refer to the guide in the external documentation to learn how to enforce that validation.
 *     externalDocs:
 *       url: https://docs.arcangel.com/resources/commerce-modules/cart/sales-channel-availability
 *   email:
 *     type: string
 *     title: email
