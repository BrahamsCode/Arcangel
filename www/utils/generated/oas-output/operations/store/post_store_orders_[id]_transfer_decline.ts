 ...
 * description: Decline an order transfer previously requested, typically by the admin user using the [Request Order Transfer Admin API route](https://docs.arcangel.com/api/admin#orders_postordersidtransferrequest).
