/**
 * @oas [get] /store/product-variants
 ...
 *     in: query
 *     description: Filter by whether Arcangel manages inventory for the product variant.
 *     required: false
 *     schema:
 *       type: boolean
 ...
 *   - name: with_deleted
 *     in: query
 *     description: The product variant's with deleted.
 *     required: false
 *     schema:
 *       type: boolean
 *       title: with_deleted
 ...
 *     label: cURL
 *     source: |-
 *       curl '{backend_url}/store/product-variants' \
