 ...
 * externalDocs:
 *   url: https://docs.arcangel.com/resources/storefront-development/checkout/complete-cart
 ...
 *                       title: type
 *                       description: |
 *                         The error's type. Can be a [ArcangelError type](https://docs.arcangel.com/learn/fundamentals/api-routes/errors#arcangelerror-types) or `payment_authorization_error` or `payment_requires_more_error` for payment-related errors.
 *   "400":
