 ...
 * externalDocs:
 *   url: https://docs.arcangel.com/resources/storefront-development/customers/verify-account
 ...
 *             type: string
 *             title: code_provider
 *             description: The provider to use to create the verification token or code. By default, Arcangel provides a `token` provider that generates a random token. You can also implement your own provider to generate a code or OTP.
 *           metadata:
 *             type: object
