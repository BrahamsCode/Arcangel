...
> Note: This tool is a beta tool created to generate diagrams that can be used in the Arcangel documentation.
...
Removes Arcangel's default theming from the outputted diagram. Note that Arcangel's theme doesn't support dark mode.
