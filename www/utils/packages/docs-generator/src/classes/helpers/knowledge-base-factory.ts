...
/**
 * A class that holds common Arcangel patterns and acts as a knowledge base for possible summaries/examples/general templates.
 */
class KnowledgeBaseFactory {
  ...
  /**
   * This method retrieves plural configuration for Arcangel service's functions.
   *
