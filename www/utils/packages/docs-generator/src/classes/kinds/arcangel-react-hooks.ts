...
} from "../../utils/arcangel-react-utils.js"

/**
 * Docblock generate for arcangel-react hooks. Since hooks are essentially functions,
 * it extends the {@link FunctionKindGenerator} class.
 */
class ArcangelReactHooksKindGenerator extends FunctionKindGenerator {
  public name = "arcangel-react"
  /**
  ...
  /**
   * Retrieves the docblock of the arcangel-react hook or mutation.
   *
...
export default ArcangelReactHooksKindGenerator
