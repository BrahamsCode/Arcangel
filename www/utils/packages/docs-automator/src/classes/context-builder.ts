...
Use the /writing-docs skill before making any documentation changes. This skill contains the rules and patterns for writing Arcangel documentation correctly.`
  }
