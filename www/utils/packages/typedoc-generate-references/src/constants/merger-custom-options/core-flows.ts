...
const coreFlowsOptions: FormattingOptionsType = {
  ...
  "^core_flows/.*/Workflows_.*/functions/.*/page\\.mdx": {
    reflectionDescription:
      "This documentation provides a reference to the `{{alias}}`. It belongs to the `@arcangel/arcangel/core-flows` package.",
    showSourceCodeLink: true,
    frontmatterData: {
      slug: "/references/arcangel-workflows/{{alias}}",
      sidebar_label: "{{alias}}",
    ...
    reflectionTitle: {
      ...
      suffix: "- Arcangel Core Workflows Reference",
    },
  },
  "^core_flows/.*/Steps_.*/functions/.*/page\\.mdx": {
    reflectionDescription:
      "This documentation provides a reference to the `{{alias}}`. It belongs to the `@arcangel/arcangel/core-flows` package.",
    frontmatterData: {
      slug: "/references/arcangel-workflows/steps/{{alias}}",
      sidebar_label: "{{alias}}",
    },
    reflectionTitle: {
      kind: false,
