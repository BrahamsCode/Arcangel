...
The Cache Module is deprecated starting from [Arcangel v2.11.0](https://github.com/arcangel/arcangel/releases/tag/v2.11.0). [Use the Caching Module](https://docs.arcangel.com/resources/infrastructure-modules/caching) instead.
...
In your workflow's step, you can resolve the Cache Module's service from the Arcangel container:
...
This will resolve the service of the configured Cache Module, which is the [In-Memory Cache Module](https://docs.arcangel.com/resources/infrastructure-modules/cache/in-memory) by default.
