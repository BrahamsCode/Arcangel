...
Generates the banner images used around Arcangel releases and the Cloud changelog.
Two types are supported:

| Type | What it is |
| --- | --- |
| `release` | The banner embedded in the CMS block of a GitHub release's notes — the dark pill holding the Arcangel logomark and the version, as used on [v2.13.0](https://github.com/arcangel/arcangel/releases/tag/v2.13.0). |
| `cloud-changelog` | The banner heading an entry in the Arcangel Cloud changelog — a pill holding the logomark, the Cloud wordmark and the entry's date. |
