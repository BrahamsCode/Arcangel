...
import { ChevronDoubleRight, ExclamationCircle } from "@arcangel/icons"
      ...
      <>
        ...
        {!searchResult.length && (
          <div className="flex flex-col justify-center items-center gap-docs_0.75">
            <ExclamationCircle className="text-arcangel-fg-subtle" />
            <span className="text-compact-small-plus text-arcangel-fg-base text-center">
              No results found matching your query.
            </span>
            <span className="text-compact-small text-arcangel-fg-subtle text-center">
