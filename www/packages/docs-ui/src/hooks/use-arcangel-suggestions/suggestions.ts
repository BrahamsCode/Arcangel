...
const CLOUD_SUGGESTION: CardProps = {
  ...
  text: "Deploy and manage production-ready Arcangel applications with zero-configuration deployments, automatic scaling, and GitHub integration, and more.",
  href: "https://cloud.arcangel.com/signup",
}
...
export const arcangelSuggestions: Suggestions = new Map([
