...
import { TriangleRightMini } from "@arcangel/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "hover:border-arcangel-tag-orange-border transition-colors",
        className
      )}
    >
      <div
      ...
      >
        <div className="flex gap-[6px] items-center">
          <BloomIcon className="text-arcangel-tag-orange-text" />
          {title && (
            <div
              className={clsx(
      ...
      <span className="text-arcangel-tag-blue-text">
