...
export const MDXComponents: MDXComponentsType = {
  ...
  p: ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => {
    return (
      <p
        className={clsx(
          "text-arcangel-fg-base [&:not(:last-child)]:mb-docs_1.5 last:!mb-0",
          className
        )}
        {...props}
      />
  ...
  li: ({
    ...
    return (
      <li
        className={clsx(
          "text-arcangel-fg-base [&:not(:last-child)]:mb-docs_0.5",
  ...
  hr: ({ className, ...props }: React.HTMLAttributes<HTMLHRElement>) => {
    return (
      <hr
        className={clsx(
          "my-docs_2 h-[1px] w-full border-0 bg-arcangel-border-base",
          className
        )}
        {...props}
      />
