...
export const AiAssistantThreadItemActions = ({
  ...
  return (
    ...
    >
      {item.type === "question" && (
        <div className="flex gap-docs_0.25 items-center text-arcangel-fg-muted">
              ...
              {item.sources.map((source, index) => (
                <Link
                  ...
                  className={clsx(
                    ...
                    "rounded-docs_xs bg-arcangel-tag-neutral-bg font-monospace",
          ...
          <div className="flex gap-docs_0.25 items-center text-arcangel-fg-muted">
            ...
            {(feedback === null || feedback === "upvote") && (
              <ActionButton
                ...
                className={clsx(
                  feedback === "upvote" && "!text-arcangel-fg-muted"
                )}
              >
                <ThumbUp />
              </ActionButton>
            ...
            {(feedback === null || feedback === "downvote") && (
              <ActionButton
                ...
                className={clsx(
                  feedback === "downvote" && "!text-arcangel-fg-muted"
                )}
              >
                <ThumbDown />
              </ActionButton>
...
const ActionButton = ({ children, className, ...props }: ButtonProps) => {
  return (
    <Button
      variant="transparent"
      className={clsx(
        "text-arcangel-fg-muted hover:text-arcangel-fg-muted",
        "hover:bg-arcangel-bg-subtle-hover",
