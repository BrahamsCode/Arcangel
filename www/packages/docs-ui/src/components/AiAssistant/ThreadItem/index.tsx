...
export const AiAssistantThreadItem = ({ item }: AiAssistantThreadItemProps) => {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "txt-small text-arcangel-fg-base",
      ...
      >
        <div
          className={clsx(
            "flex flex-col gap-docs_0.75",
            item.type === "question" && [
              "rounded-docs_xl bg-arcangel-tag-neutral-bg",
                    ...
                    <CodeMdx
                      ...
                      codeBlockProps={{
                        ...
                        overrideColors: {
                          ...
                          innerBorder: "border-arcangel-contrast-border-bot",
                        },
                      }}
                    />
                  )
        ...
        {item.type === "error" && (
          <span className="text-arcangel-fg-error">{item.content}</span>
        )}
      </div>
    </div>
  )
