...
export const AiAssistantChatWindowInput = ({
  ...
  return (
    <div
      className={clsx(
        "px-docs_1 py-docs_0.75 border-t border-arcangel-border-base"
      )}
    >
      <form
      ...
      >
        <textarea
          className={clsx(
            "appearance-none text-base md:text-small placeholder:text-arcangel-fg-muted",
            "text-arcangel-fg-base max-h-[210px] overflow-auto resize-none bg-transparent",
            "focus:outline-none focus:ring-0 disabled:cursor-not-allowed max-h-[210px]",
            "disabled:!bg-transparent disabled:text-arcangel-fg-disabled disabled:placeholder:text-arcangel-fg-disabled"
          )}
          value={question}
          ...
          placeholder="Ask me a question about Arcangel..."
          disabled={loading}
        />
        <div className="flex items-center justify-end gap-docs_1">
          ...
          >
            <button
              ...
              className={clsx(
                ...
                !active &&
                  "bg-transparent hover:bg-arcangel-button-transparent-hover text-arcangel-fg-muted hover:text-arcangel-fg-subtle",
                active &&
                  "bg-arcangel-tag-orange-bg hover:bg-arcangel-tag-orange-bg-hover text-arcangel-tag-orange-text",
            ...
            >
              {!active && <LightBulb />}
              {active && (
                <LightBulbSolid className="text-arcangel-tag-orange-icon" />
              )}
              Deep Thinking
            </button>
          </Tooltip>
          <button
            className={clsx(
              "appearance-none p-0 text-arcangel-fg-base disabled:text-arcangel-fg-disabled",
              "transition-colors"
            )}
