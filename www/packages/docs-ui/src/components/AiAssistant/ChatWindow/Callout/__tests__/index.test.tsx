...
// mock functions
const mockUseArcangelSuggestions = vi.fn((options) => null as unknown)
...
vi.mock("@/hooks/use-arcangel-suggestions", () => ({
  useArcangelSuggestions: (options: unknown) => mockUseArcangelSuggestions(options),
}))
...
describe("render", () => {
  test("should not render when there is no matched suggestion", () => {
    mockUseArcangelSuggestions.mockReturnValueOnce(null)
  ...
  test("should render when there is a matched suggestion", () => {
    ...
    mockUseArcangelSuggestions.mockReturnValueOnce(mockCardProps)
  ...
  test("should not render when loading is true", () => {
    ...
    mockUseArcangelSuggestions.mockReturnValueOnce({
      title: "Test Card",
      text: "This is a test card.",
      href: "https://example.com",
      icon: () => <div>Icon</div>,
  ...
  test("should pass correct keywords to useArcangelSuggestions", () => {
    render(<AiAssistantChatWindowCallout />)

    expect(mockUseArcangelSuggestions).toHaveBeenCalledWith({
