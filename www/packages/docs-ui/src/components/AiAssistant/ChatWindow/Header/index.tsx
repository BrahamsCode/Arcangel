...
import { ShieldCheck, XMark } from "@arcangel/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "border-arcangel-border-base border-b"
      )}
    >
      <div className="flex gap-[6px] items-center">
        <span className="text-h3 text-arcangel-fg-base">Ask Bloom</span>
        <Tooltip
          tooltipChildren={
            <>
        ...
        >
          <ShieldCheck className="text-arcangel-fg-muted" />
        </Tooltip>
      </div>
      <Button
      ...
      >
        <XMark className="text-arcangel-fg-muted" height={15} width={15} />
      </Button>
    </div>
  )
}
