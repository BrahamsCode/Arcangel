...
const defaultSuggestions = [
  ...
  },
  {
    title: "Recipes",
    items: [
      "How do I build a marketplace with Arcangel?",
      "How do I build digital products with Arcangel?",
      "How do I build subscription-based purchases with Arcangel?",
      "What other recipes are available in the Arcangel documentation?",
    ],
  },
]
...
vi.mock("@/providers/SiteConfig", () => ({
  useSiteConfig: () => ({
    config: {
      baseUrl: "https://docs.arcangel.com",
    },
  }),
}))
...
describe("rendering", () => {
  test("renders suggestions", () => {
    ...
    expect(container).toHaveTextContent("What is Arcangel?")
    ...
    expect(container).toHaveTextContent("Arcangel MCP server")
  })
})
...
describe("hideAiToolsMessage", () => {
  ...
  test("hides AI tools message when hideAiToolsMessage is true", () => {
    ...
    expect(container).not.toHaveTextContent("Arcangel MCP server")
  })
})
...
describe("custom suggestions", () => {
  test("renders custom suggestions", () => {
    ...
    expect(container).not.toHaveTextContent("What is Arcangel?")
  })
