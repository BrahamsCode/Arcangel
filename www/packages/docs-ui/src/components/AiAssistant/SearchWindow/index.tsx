...
import { ArrowUturnLeft } from "@arcangel/icons"
    ...
    <div className="h-full">
      ...
      <div
        className={clsx(
          ...
          "border-b border-arcangel-border-base relative"
        )}
      >
        <Button
          variant="transparent"
          onClick={() => setCommand(null)}
          className="text-arcangel-fg-muted p-[6.5px]"
        >
          <ArrowUturnLeft />
        </Button>
        <InputText
          ...
          className={clsx(
            ...
            "!shadow-none flex-1 text-arcangel-fg-base",
      ...
      <div
        className={clsx(
          ...
          "border-arcangel-border-base border-t",
          "bg-arcangel-bg-field-component"
        )}
      >
        <div className="flex items-center gap-docs_0.75">
          <div className="flex items-center gap-docs_0.5">
            {conversation.length === 0 && (
              <>
                ...
                <span className="gap-[5px] flex">
                  <Kbd
                    className={clsx(
                      "!bg-arcangel-bg-field-component !border-arcangel-border-strong",
                      "!text-arcangel-fg-subtle h-[18px] w-[18px] p-0"
                    )}
                  >
                    ↑
                  </Kbd>
            ...
            {conversation.length > 0 && (
              <span
                className={clsx("text-arcangel-fg-muted", "text-compact-x-small")}
              >
          ...
          <div
            className={clsx("h-docs_0.75 w-px bg-arcangel-border-strong")}
          ></div>
          <div className="flex items-center gap-docs_0.5">
            <span
              className={clsx("text-arcangel-fg-subtle", "text-compact-x-small")}
            >
              Ask Question
            </span>
            <Kbd
