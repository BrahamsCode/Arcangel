    ...
    () =>
      clsx(
        ...
        !overrideColors.bg && [
          ...
          blockStyle === "subtle" && "bg-arcangel-bg-component",
        ]
      ),
    ...
    () =>
      clsx(
        ...
        !overrideColors.lineNumbersBg && [
          ...
          blockStyle === "subtle" && "text-arcangel-fg-muted",
        ]
      ),
    [blockStyle, colorMode, overrideColors]
  )
  ...
  const innerBgColor = useMemo(
    () =>
      clsx(
        ...
        !overrideColors.innerBg && [
          blockStyle === "loud" && [
            hasInnerCodeBlock && "bg-arcangel-contrast-bg-subtle",
            !hasInnerCodeBlock && "bg-arcangel-contrast-bg-base",
          ],
    ...
    () =>
      clsx(
        ...
        !overrideColors.innerBorder && [
          blockStyle === "loud" && [
            hasInnerCodeBlock &&
              "border border-solid border-arcangel-contrast-border-bot rounded-docs_DEFAULT",
