...
export const CodeBlockLine = ({
      ...
      {isTokenHighlighted && (
        <span
          className={clsx(
            ...
            codeBlockStyle === "loud" && [
              "top-0 h-full",
              "lg:bg-arcangel-alpha-white-alpha-6 lg:border lg:border-arcangel-alpha-white-alpha-12",
            ...
            codeBlockStyle === "subtle" && [
              ...
              "group-hover:scale-y-100 bg-arcangel-fg-base",
            ]
          )}
          ...
          <span
            ...
            className={clsx(
              ...
              isTokenHighlighted && [
                "relative z-[1]",
                codeBlockStyle === "subtle" &&
                  "group-hover:!text-arcangel-fg-on-color group-hover:dark:!text-arcangel-fg-on-inverted",
              ]
            )}
  ...
  return (
    <span
      ...
      className={clsx(
        "table-row",
        isHighlightedLine && "bg-arcangel-alpha-white-alpha-6",
        lineProps.className
      )}
