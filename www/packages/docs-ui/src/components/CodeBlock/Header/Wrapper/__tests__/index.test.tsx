...
describe("render", () => {
  test("render with children, blockStyle loud, and colorMode light", () => {
    ...
    expect(wrapper).toHaveClass("bg-arcangel-contrast-bg-base")
    expect(wrapper).not.toHaveClass("bg-arcangel-bg-component")
    expect(wrapper).not.toHaveClass("border-arcangel-border-base")
  })
  ...
  test("render with children, blockStyle subtle, and colorMode light", () => {
    ...
    const wrapper = container.querySelector("div")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveClass("bg-arcangel-bg-component")
    expect(wrapper).not.toHaveClass("bg-arcangel-code-bg-header")
    expect(wrapper).not.toHaveClass("bg-arcangel-contrast-bg-base")
  })
  ...
  test("render with children, blockStyle subtle, and colorMode dark", () => {
    ...
    const wrapper = container.querySelector("div")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveClass("bg-arcangel-code-bg-header")
    expect(wrapper).not.toHaveClass("bg-arcangel-bg-component")
    expect(wrapper).not.toHaveClass("bg-arcangel-contrast-bg-base")
  })
})
