...
describe("rendering", () => {
  test("renders primary button", () => {
    ...
    expect(button).toHaveClass("bg-arcangel-button-inverted")
    expect(button).toHaveClass("hover:bg-arcangel-button-inverted-hover")
    expect(button).toHaveClass("active:bg-arcangel-button-inverted-pressed")
    expect(button).toHaveClass("focus:bg-arcangel-button-inverted")
    ...
    expect(button).toHaveClass("disabled:bg-arcangel-bg-disabled")
  ...
  test("renders secondary button", () => {
    ...
    const button = container.querySelector("button")
    expect(button).toBeInTheDocument()
    expect(button).toHaveClass("bg-arcangel-button-neutral")
    expect(button).toHaveClass("hover:bg-arcangel-button-neutral-hover")
    expect(button).toHaveClass("active:bg-arcangel-button-neutral-pressed")
    expect(button).toHaveClass("focus:bg-arcangel-button-neutral")
