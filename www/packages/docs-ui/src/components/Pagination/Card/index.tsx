import { TriangleLeftMini, TriangleRightMini } from "@arcangel/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "bg-arcangel-bg-component hover:bg-arcangel-bg-component-hover",
    ...
    >
      ...
      >
        {type === "previous" && (
          <TriangleLeftMini
            className="text-arcangel-fg-muted"
        ...
        >
          {parentTitle && (
            <span
              className="block text-compact-small text-arcangel-fg-subtle"
          ...
          <span
            className="block text-compact-small-plus text-arcangel-fg-base"
