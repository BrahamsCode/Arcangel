...
import { ColoredArcangelIcon } from "../Icons"
...
export const MainNav = ({ className, itemsClassName }: MainNavProps) => {
  ...
  return (
    <div
      className={clsx("w-full z-20 sticky top-0 bg-arcangel-bg-base", className)}
      data-testid="main-nav"
    >
      <div
        className={clsx(
          "flex justify-between items-center px-docs_1 w-full gap-docs_0.5",
          "border-b border-arcangel-border-base relative z-50"
        )}
      ...
      >
        <div className="flex items-center gap-[10px]">
          ...
          <Link href={`${logoUrl || config.baseUrl}`} data-testid="logo-link">
            {logo || <ColoredArcangelIcon variant="subtle" />}
          </Link>
        </div>
        {!collapseNavbar && (
        ...
        {!isInProduct && (
          ...
          >
            <div className="lg:flex items-center gap-docs_0.25 text-arcangel-fg-subtle hidden">
              <MainNavVersion />
              <MainNavItemDropdown
                item={
                  helpNavItem || {
                    ...
                    children: [
                      {
                        ...
                        link: "https://docs.arcangel.com/resources/troubleshooting",
                      },
                      {
                        type: "link",
                        title: "Report Issue",
                      ...
                      },
                      {
                        ...
                        link: "https://discord.gg/arcangel",
                      },
                      {
                        type: "divider",
                      },
                      {
                        type: "link",
                        title: "Contact Sales",
                        link: "https://arcangel.com/contact/",
                      },
                    ],
                  }
                }
      ...
      {collapseNavbar && (
        <div
          className={clsx(
            "border-b border-arcangel-border-base px-docs_1 relative z-10"
          )}
