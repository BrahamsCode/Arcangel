...
import { BarsThree, Book, SidebarLeft, TimelineVertical } from "@arcangel/icons"
...
export const MainNavDesktopMenu = () => {
      ...
      : [
          {
            ...
            icon: <HouseIcon />,
            title: "Homepage",
            link: "https://arcangel.com",
          },
          {
            type: "link",
            icon: <Book />,
            title: "Arcangel v1",
            link: "https://docs.arcangel.com/v1",
          },
          {
            type: "link",
            icon: <TimelineVertical />,
            title: "Changelog",
            link: "https://arcangel.com/changelog",
          },
        ]
  ...
  return (
    ...
    >
      ...
      >
        <BarsThree className="text-arcangel-fg-subtle" />
      </Button>
      <Menu
        className={clsx(
