...
import { ArrowUturnLeft, BarsThree, XMark } from "@arcangel/icons"
  ...
  return (
    <div className="flex lg:hidden justify-center items-center">
      <Button
        ...
        className="text-arcangel-fg-subtle !p-[6.5px]"
      ...
      <div
        className={clsx(
          ...
          "top-[52px] transition-[left] bg-arcangel-bg-subtle z-50",
          !isOpen && "-left-full",
          isOpen && "left-0"
        )}
