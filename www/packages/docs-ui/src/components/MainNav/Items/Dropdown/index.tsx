          ...
          icon={
            <TriangleDownMini
              className={clsx(
                ...
                isOpen && "rotate-180",
                isActive && "text-arcangel-fg-base hover:text-arcangel-fg-subtle",
                !isActive && "text-arcangel-fg-subtle hover:text-arcangel-fg-base"
              )}
            />
          }
          className="!flex"
      ...
      <div
        className={clsx(
          ...
          !isActive && [
            ...
            isOpen && "text-arcangel-fg-subtle",
          ],
          "hover:bg-arcangel-button-transparent-hover rounded-docs_sm px-docs_0.5",
          className
        )}
        tabIndex={-1}
