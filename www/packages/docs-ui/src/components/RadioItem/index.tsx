  ...
  return (
    <div className="p-[3px] flex justify-center items-center relative">
      <input
        type="radio"
        className={clsx(
          "appearance-none bg-arcangel-bg-component shadow-borders-base dark:shadow-border-base-dark",
          "w-[14px] h-[14px] rounded-full",
          "focus:shadow-borders-interactive-with-focus disabled:opacity-50",
          "checked:!bg-arcangel-bg-interactive checked:!shadow-borders-interactive-with-shadow",
          !checked && "hover:bg-arcangel-bg-component-hover",
          className
        )}
        checked={checked}
        {...props}
      ...
      {checked && (
        <span
          className={clsx(
            "w-[6px] h-[6px] bg-arcangel-bg-base dark:bg-arcangel-fg-on-color absolute top-1/2 left-1/2 rounded-full",
