import { MagnifierAlert } from "@arcangel/icons"
...
export const SearchNoResult = () => {
  return (
    ...
    >
      <MagnifierAlert className="text-arcangel-fg-base" />
      <div
        className={clsx(
      ...
      >
        <span className="text-compact-small-plus text-arcangel-fg-subtle">
          No results found.
        </span>
        <span className="text-arcangel-fg-muted txt-small text-center">
