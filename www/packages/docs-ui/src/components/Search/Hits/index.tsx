...
export const SearchHits = ({
  ...
  return (
    <div
      className={clsx(
        "overflow-auto",
        "[&_mark]:bg-arcangel-bg-highlight",
        "[&_mark]:text-arcangel-fg-interactive"
      )}
      data-group
    >
      {hits.map((item, index) => {
        ...
        return (
          <div
            ...
            className={clsx(
              "p-docs_0.5",
              "hover:bg-arcangel-bg-base-hover",
              "focus:bg-arcangel-bg-base-hover",
              "focus:outline-none",
          ...
          >
            ...
            >
              ...
              <span className="text-compact-small text-arcangel-fg-subtle text-ellipsis overflow-hidden">
                {item.type === "content" && (
                  <>
                    {/* @ts-expect-error React v19 doesn't see this type as a React element */}
              ...
              <span
                className={clsx(
                  ...
                  "text-arcangel-fg-muted items-center text-compact-x-small"
                )}
              >
                {hierarchies}
              </span>
            ...
            {!!item.integration_vendor &&
              item.integration_vendor !== "Arcangel" && (
