...
import { Bolt, InformationCircle } from "@arcangel/icons"
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={clsx(
            "shadow-borders-base flex w-fit bg-arcangel-bg-base",
        ...
        >
          {step.type === "hook" && (
            <div className="flex size-[20px] items-center justify-center text-arcangel-tag-orange-icon">
              <Bolt />
            </div>
          )}
          {step.when && (
            <div className="flex size-[20px] items-center justify-center text-arcangel-tag-green-icon">
              <InformationCircle />
            </div>
          )}
          <Text
