...
import { ArrowPathMini, MinusMini, PlusMini } from "@arcangel/icons"
import { DropdownMenu, Text } from "@arcangel/ui"
import {
  createNodeClusters,
  getNextCluster,
  ...
  return (
    <div className="h-[200px] w-full rounded-docs_DEFAULT">
      ...
      >
        <div className="relative size-full overflow-hidden object-contain rounded-docs_DEFAULT shadow-elevation-card-rest">
          <div>
            ...
            <motion.div
              ...
              className={clsx(
                "bg-arcangel-bg-subtle relative size-[500rem] origin-top-left items-start justify-start overflow-hidden",
        ...
        <div className="bg-arcangel-bg-base shadow-borders-base text-arcangel-fg-subtle absolute bottom-docs_1 left-docs_1.5 flex h-[28px] items-center overflow-hidden rounded-docs_sm">
          <div className="flex items-center">
            <button
              ...
              disabled={!canZoomIn}
              aria-label="Zoom in"
              className="disabled:text-arcangel-fg-disabled transition-fg hover:bg-arcangel-bg-base-hover active:bg-arcangel-bg-base-pressed focus-visible:bg-arcangel-bg-base-pressed border-r p-docs_0.25 outline-none"
            >
              <PlusMini />
            </button>
            <div>
              <DropdownMenu>
                <DropdownMenu.Trigger
                  className="disabled:text-arcangel-fg-disabled transition-fg hover:bg-arcangel-bg-base-hover active:bg-arcangel-bg-base-pressed focus-visible:bg-arcangel-bg-base-pressed flex w-[50px] items-center justify-center border-r p-docs_0.25 outline-none"
                ...
                <DropdownMenu.Content className="bg-arcangel-bg-base">
          ...
          <button
            ...
            className="disabled:text-arcangel-fg-disabled transition-fg hover:bg-arcangel-bg-base-hover active:bg-arcangel-bg-base-pressed focus-visible:bg-arcangel-bg-base-pressed p-docs_0.25 outline-none"
          >
            <ArrowPathMini />
          </button>
        </div>
