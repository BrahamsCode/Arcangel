...
describe("render", () => {
  test("renders npm2yarn code", () => {
    const { container } = render(
      <Npm2YarnCode npmCode="npm install @arcangel/arcangel" />
    )
    ...
    expect(yarnCodeBlock).toHaveTextContent("yarn add @arcangel/arcangel")
    ...
    expect(pnpmCodeBlock).toHaveTextContent("pnpm add @arcangel/arcangel")
    ...
    expect(npmCodeBlock).toHaveTextContent("npm install @arcangel/arcangel")
  })

  test("renders npm2yarn code with custom code options", () => {
    const { container } = render(
      <Npm2YarnCode
        npmCode="npm install @arcangel/arcangel"
        title="Custom Title"
      />
    )
    expect(container).toBeInTheDocument()
