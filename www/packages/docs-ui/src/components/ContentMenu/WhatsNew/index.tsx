    ...
    >
      ...
      <div
        className={clsx(
          ...
          "bg-arcangel-bg-component shadow-elevation-card-rest dark:shadow-elevation-card-rest-dark",
          "hover:shadow-elevation-card-hover dark:hover:shadow-elevation-card-hover-dark",
          "card mb-docs_0.75"
        )}
      >
        <span className="text-2x-small-plus text-arcangel-fg-base truncate">
          {announcement.title}
        </span>
        <span className="text-2x-small-plus text-arcangel-fg-subtle truncate">
      ...
      <div className={clsx("h-docs_0.75 w-docs_0.75 relative rounded-full")}>
        <div
          className={clsx(
            ...
            isNew && "bg-arcangel-tag-blue-icon"
          )}
        />
        <div
          className={clsx(
            "w-[5px] h-[5px] rounded-full",
            "border-[0.5px] border-arcangel-alphas-alpha-10",
            "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",
            isNew ? "bg-arcangel-tag-blue-icon" : "bg-arcangel-fg-disabled"
          )}
        />
      </div>
      <div className="flex-1 h-full w-[1.5px] bg-arcangel-alphas-alpha-10" />
    </div>
  )
}
