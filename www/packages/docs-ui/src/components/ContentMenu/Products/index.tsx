  ...
  return (
    ...
    >
      <div className="flex flex-col gap-docs_0.5 p-docs_1">
        <span className="text-x-small-plus text-arcangel-fg-muted">
          Modules used
        </span>
        {loadedProducts.map((product, index) => (
          ...
          >
            <BorderedIcon
              wrapperClassName={clsx("bg-arcangel-bg-base")}
            ...
            <span
              className={
                "text-arcangel-fg-subtle text-x-small-plus group-hover:text-arcangel-fg-base transition-colors"
              }
            >
              {product.title}
            </span>
