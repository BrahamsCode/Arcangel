...
import { BroomSparkle, MarkdownSolid } from "@arcangel/icons"
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-docs_0.5 p-docs_1">
        <Link
          className="flex items-center gap-docs_0.5 text-arcangel-fg-subtle text-x-small-plus hover:text-arcangel-fg-base"
        ...
        {features?.aiAssistant && (
          <button
            className="appearance-none p-0 flex items-center gap-docs_0.5 text-arcangel-fg-subtle text-x-small-plus hover:text-arcangel-fg-base"
