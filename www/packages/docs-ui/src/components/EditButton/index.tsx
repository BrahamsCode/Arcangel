...
import { ArrowUpRightOnBox } from "@arcangel/icons"
...
export const EditButton = ({ filePath, editDate }: EditButtonProps) => {
  return (
    <div className="flex flex-wrap gap-docs_0.5 mt-docs_2 text-arcangel-fg-subtle">
      {editDate && <EditDate date={editDate} />}

      <Link
        href={`https://github.com/arcangel/arcangel/edit/develop${filePath}`}
        className={clsx(
