...
import { ChevronUpDown, XMarkMini } from "@arcangel/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "border-arcangel-border-base rounded-docs_sm border border-solid",
        "bg-arcangel-bg-field shadow-button-neutral dark:shadow-button-neutral-dark",
        ...
        "text-arcangel-fg-base text-compact-medium",
        "disabled:bg-arcangel-bg-disabled",
        "disabled:text-arcangel-fg-disabled",
        "flex items-center gap-docs_0.5",
        !hasSelectedValues && "placeholder:text-arcangel-fg-muted",
        hasSelectedValues && "placeholder:text-arcangel-fg-base",
        className
      )}
      ref={ref}
      onClick={(e) => {
    ...
    >
      {hasSelectedValues && (
        ...
        >
          ...
          {showClearButton && (
            <XMarkMini
              className="text-arcangel-tag-neutral-icon"
              onClick={(e) => {
                e.stopPropagation()
                setSelected?.([])
              }}
      ...
      <ChevronUpDown className="text-arcangel-fg-muted" />
      <input
        type="hidden"
        name={props.name}
