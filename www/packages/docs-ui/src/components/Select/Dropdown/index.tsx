...
import { CheckMini, EllipseMiniSolid } from "@arcangel/icons"
      ...
      >
        <div
          className={clsx(
            ...
            "hover:bg-arcangel-bg-component-hover cursor-pointer",
            "flex gap-docs_0.5 text-arcangel-fg-base items-center",
    ...
    >
      <ul
        className={clsx(
          ...
          "bg-arcangel-bg-component text-arcangel-fg-base",
