...
describe("rendering", () => {
  ...
  test("renders colored indicator for default type", () => {
    ...
    expect(indicator).toHaveClass("bg-arcangel-tag-neutral-icon")
  })
  ...
  test("renders colored indicator for error type", () => {
    ...
    expect(indicator).toHaveClass("bg-arcangel-tag-red-icon")
  })
  ...
  test("renders colored indicator for success type", () => {
    ...
    expect(indicator).toHaveClass("bg-arcangel-tag-green-icon")
  })
  ...
  test("renders colored indicator for soon type", () => {
    ...
    expect(indicator).toHaveClass("bg-arcangel-tag-blue-icon")
  })
})
