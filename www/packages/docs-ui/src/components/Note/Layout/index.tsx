  ...
  return (
    <div
      className={clsx(
        ...
        "bg-arcangel-bg-component border border-arcangel-border-base"
      )}
      ...
      <span
        className={clsx(
          ...
          (type === "default" || type === "check") &&
            "bg-arcangel-tag-neutral-icon",
          (type === "error" || type === "warning") && "bg-arcangel-tag-red-icon",
          type === "success" && "bg-arcangel-tag-green-icon",
          // TODO remove once all soon components are removed
          type === "soon" && "bg-arcangel-tag-blue-icon"
        )}
        data-testid="note-layout-indicator"
      ></span>
      <div className="flex-1">
        <div className="text-small text-arcangel-fg-subtle [&_ol]:!mb-0 [&_ul]:!mb-0">
          <span
            className={clsx("text-small-plus text-arcangel-fg-base")}
