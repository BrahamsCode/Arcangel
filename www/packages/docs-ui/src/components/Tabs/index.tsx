...
import { Tabs as UiTabs } from "@arcangel/ui"
import { ComponentProps } from "react"
import clsx from "clsx"
import { EllipseMiniSolid } from "@arcangel/icons"
...
export const TabsTriggerVertical = ({
  ...
  return (
    <UiTabs.Trigger
      ...
      className={clsx(
        className,
        "px-docs_0.5 py-docs_0.25 !text-arcangel-fg-base text-compact-small data-[state=active]:!text-compact-small-plus",
        "[&[data-state=active]_svg]:!visible hover:!bg-arcangel-bg-base-hover rounded-docs_DEFAULT",
        "!shadow-none"
      )}
    >
