...
import { ArrowDownRightMini } from "@arcangel/icons"
    ...
    return (
      <div className="mb-docs_1" ref={ref}>
        {manualTestTrigger && (
          <div
            className={clsx(
              "bg-arcangel-bg-component rounded-docs_DEFAULT",
          ...
          >
            ...
            >
              <ArrowDownRightMini className="text-arcangel-fg-muted" />
              ...
              <ArrowRightDownIcon className="text-arcangel-fg-muted" />
            </div>
            <div
              className={clsx(
                "border-t border-arcangel-border-base",
