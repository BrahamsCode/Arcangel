...
describe("render", () => {
  test("default render (loud blockStyle, not selected, light color mode)", () => {
    ...
    expect(button).toHaveClass("text-arcangel-contrast-fg-secondary")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-primary")
    expect(button).not.toHaveClass("xs:border-arcangel-border-base")
    expect(button).not.toHaveClass("xs:border-arcangel-code-border")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-primary")
    expect(button).not.toHaveClass("xs:border-arcangel-border-base")
    expect(button).not.toHaveClass("xs:border-arcangel-code-border")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-primary")
  ...
  test("render with selected (loud blockStyle, light color mode)", () => {
    ...
    expect(button).toHaveAttribute("role", "tab")
    expect(button).toHaveClass("text-arcangel-contrast-fg-primary")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
    expect(button).not.toHaveClass("xs:border-arcangel-border-base")
    expect(button).not.toHaveClass("xs:border-arcangel-code-border")
  })
  ...
  test("render with subtle blockStyle (not selected, light color mode)", () => {
    ...
    expect(button).toHaveAttribute("aria-selected", "false")
    expect(button).toHaveAttribute("role", "tab")
    expect(button).toHaveClass("text-arcangel-fg-subtle hover:bg-arcangel-bg-base")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
    expect(button).not.toHaveClass("xs:border-arcangel-code-border")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-primary")
    expect(button).not.toHaveClass("hover:bg-arcangel-code-bg-base")
  })
  ...
  test("render with subtle blockStyle and selected (light color mode)", () => {
    ...
    expect(button).toHaveClass(
      "xs:border-arcangel-border-base text-arcangel-contrast-fg-primary"
    )
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
    expect(button).not.toHaveClass("hover:bg-arcangel-code-bg-base")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
  ...
  test("render with subtle blockStyle and dark color mode and selected", () => {
    ...
    expect(button).toHaveAttribute("role", "tab")
    expect(button).toHaveClass(
      "xs:border-arcangel-code-border text-arcangel-contrast-fg-primary"
    )
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
    expect(button).not.toHaveClass("hover:bg-arcangel-code-bg-base")
    expect(button).not.toHaveClass("text-arcangel-contrast-fg-secondary")
