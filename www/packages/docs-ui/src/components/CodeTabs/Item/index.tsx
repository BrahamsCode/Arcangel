    ...
    <li>
      <button
        className={clsx(
          ...
          !isSelected && [
            blockStyle === "loud" && "text-arcangel-contrast-fg-secondary",
            blockStyle === "subtle" && [
              colorMode === "light" &&
                "text-arcangel-fg-subtle hover:bg-arcangel-bg-base",
              colorMode === "dark" &&
                "text-arcangel-contrast-fg-secondary hover:bg-arcangel-code-bg-base",
            ],
          ],
          isSelected && [
            blockStyle === "loud" && "text-arcangel-contrast-fg-primary",
            blockStyle === "subtle" && [
              colorMode === "light" &&
