      ...
      <CodeBlockHeaderWrapper blockStyle={blockStyle} ref={codeTabsWrapperRef}>
        <span
          className={clsx(
            ...
            blockStyle === "loud" && "bg-arcangel-contrast-fg-primary h-px",
            blockStyle === "subtle" && [
              colorMode === "light" &&
                "xs:border-arcangel-border-base xs:bg-arcangel-bg-base",
              colorMode === "dark" &&
                "xs:border-arcangel-code-border xs:bg-arcangel-code-bg-base",
            ]
          )}
