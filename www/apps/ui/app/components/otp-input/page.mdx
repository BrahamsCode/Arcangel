...
A component that renders a form input field for one-time passwords (OTP) using Arcangel's design system.
...
The `OTPInput` component is available since v4.1.13 of `@arcangel/ui`.
