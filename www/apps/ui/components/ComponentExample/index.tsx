...
import { Spinner } from "@arcangel/icons"
import { Tabs, clx } from "@arcangel/ui"
      ...
      <Tabs defaultValue="preview" className="relative mr-auto w-full">
        <div className="flex flex-col pb-3">
          ...
          >
            <div
              className={clx(
                "bg-arcangel-bg-base border-arcangel-border-base flex max-h-[400px] min-h-[400px]",
            ...
            >
              <React.Suspense
                fallback={
                  <div className="text-arcangel-fg-muted flex items-center text-sm">
