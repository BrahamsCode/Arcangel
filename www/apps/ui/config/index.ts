...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "Arcangel UI",
  description:
    "Learn about Arcangel UI, A React package with primitives for building Arcangel applications. Explore components, hooks, colors, icons, and more.",
  baseUrl,
