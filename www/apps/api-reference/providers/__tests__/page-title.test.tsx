...
describe("PageTitleProvider", () => {
  ...
  describe("document title", () => {
    test("sets title to suffix when activePath is null", () => {
      ...
      expect(document.title).toBe("Arcangel Store API Reference")
    })
    ...
    test("sets title with activeItem title when activeItem.path matches activePath", () => {
      ...
      expect(document.title).toBe("Test Item - Arcangel Store API Reference")
    })
    ...
    test("sets title with child item title when activeItem has matching child", () => {
      ...
      expect(document.title).toBe("Child Item - Arcangel Store API Reference")
    })
    ...
    test("updates title when displayedArea changes", () => {
      ...
      expect(document.title).toBe("Test Item - Arcangel Admin API Reference")
    })
    ...
    test("updates title when activePath changes", () => {
      ...
      expect(document.title).toBe("New Item - Arcangel Store API Reference")
    })
  })
})
