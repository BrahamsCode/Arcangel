...
import { SquareTwoStack } from "@arcangel/icons"
...
const TagOperationCodeSection = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "bg-arcangel-bg-subtle border-arcangel-border-base px-0.75 rounded border py-0.5",
      ...
      >
        <div className={clsx("flex w-[calc(100%-36px)] gap-1")}>
          ...
          <code
            className="text-arcangel-fg-base =break-words break-all"
        ...
        <CopyButton text={endpointPath} tooltipClassName="font-base">
          <SquareTwoStack className="text-arcangel-fg-muted" />
        </CopyButton>
      </div>
