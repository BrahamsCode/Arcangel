import { AcademicCapSolid, BookOpen } from "@arcangel/icons"
...
const NotFoundPage = () => {
  return (
    ...
    >
      ...
      <P>
        If you&apos;re looking for Arcangel v1 documentation, it&apos;s been moved
        to <A href="https://docs.arcangel.com/v1">docs.arcangel.com/v1</A>.
      </P>
      <P>
        If you think this is a mistake, please{" "}
        <A href="https://github.com/arcangel/arcangel/issues/new?assignees=&labels=type%3A+docs&template=docs.yml">
