...
Fetch https://docs.arcangel.com/cloud/cli/agents and set up the Arcangel Cloud CLI.
```
...
/plugin install arcangel-cloud@arcangel
```
...
Install `@arcangel/mcloud` globally with the user's preferred package manager:
