...
export const metadata = {
  title: `local Command - Arcangel Cloud CLI Reference`,
}
...
This command is available starting Arcangel mcloud CLI v0.1.10. Make sure to update your CLI to the latest version if you don't see this command.
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      The root path of the Arcangel project relative to the repository root. Used for backend builds. Inferred from the Cloud project if not specified, or `.` if a Cloud project isn't found.
