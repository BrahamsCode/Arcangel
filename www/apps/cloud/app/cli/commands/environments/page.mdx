...
export const metadata = {
  title: `environments Command - Arcangel Cloud CLI Reference`,
}
...
Retrieve a single environment by its ID, handle, or name. This is useful if you want to retrieve the environment's details, such as its status or tracked branch.
...
<CodeTabs group="cli-output">
  ...
  Type:            production
  Status:          ready
  Arcangel domain:   https://trusting-soft-form.arcangel.app
  Custom domain:   https://acme.com
  Tracked branch:  main
  ...
  ```json
  {
    ...
    "default_domain": "trusting-soft-form.arcangel.app",
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to retrieve.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      `-e <id-handle-or-name>`, `--environment <id-handle-or-name>`

      </Table.Cell>
      <Table.Cell>

      The ID, handle, or name of the environment to retrieve. Interchangeable with the positional argument.
...
Delete an environment by its ID, handle, or name.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to delete.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to delete. Interchangeable with the positional argument.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to redeploy.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to redeploy. Interchangeable with the positional argument.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to build.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the environment to build. Interchangeable with the positional argument.
  ...
  create-environment:
    ...
    steps:
      - name: Install the Cloud CLI
        run: npm install @arcangel/mcloud -g
