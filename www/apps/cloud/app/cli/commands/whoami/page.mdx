...
export const metadata = {
  title: `whoami Command - Arcangel Cloud CLI Reference`,
}
...
<CodeTabs group="cli-output">
  ...
  API URL:        https://api.prod.arcangel.cloud
  Dashboard URL:  https://cloud.arcangel.com
  ...
  ```json
  {
    ...
    "api_url": "https://api.prod.arcangel.cloud",
    "dashboard_url": "https://cloud.arcangel.com",
    "organization": {
      "value": "org_123",
      "id": "org_123",
