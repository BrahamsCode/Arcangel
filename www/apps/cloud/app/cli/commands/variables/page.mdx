...
export const metadata = {
  title: `variables Command - Arcangel Cloud CLI Reference`,
}
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      Include system variables that Arcangel auto-injects into the environment.
...
This command is available since Arcangel mcloud CLI v0.1.10.
...
Deleting a variable is irreversible. You can't delete system variables that Arcangel auto-injects into the environment.
