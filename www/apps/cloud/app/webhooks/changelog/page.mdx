...
In this guide, you'll find the notable changes to the webhook events that Arcangel delivers, with the newest change listed first. Each entry is grouped by the date the change went live.
...
Arcangel released webhooks for Cloud organizations with the following events:
