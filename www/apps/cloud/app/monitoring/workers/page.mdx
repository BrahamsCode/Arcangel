...
For your [long-lived environments](../../environments/long-lived/page.mdx), Arcangel hosts server and worker instances. Worker instances handle background jobs, such as subscribers and scheduled jobs.
