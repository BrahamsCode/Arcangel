...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        [Total CPU](#monitor-total-cpu) and [Summary of CPU Usage Across Servers](#monitor-summary-of-cpu-usage-across-servers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Summary of Memory Usage Across Servers](#monitor-summary-of-memory-usage-across-servers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Server Restarts](#monitor-server-restarts) and [Summary of Memory Usage Across Servers](#monitor-summary-of-memory-usage-across-servers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Summary of CPU Usage Across Servers](#monitor-summary-of-cpu-usage-across-servers) and [Summary of Memory Usage Across Servers](#monitor-summary-of-memory-usage-across-servers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Total CPU](#monitor-total-cpu) and [Summary of Memory Usage Across Servers](#monitor-summary-of-memory-usage-across-servers)
      </Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
...
2. Click **Monitoring** > **Servers** in the sidebar.
