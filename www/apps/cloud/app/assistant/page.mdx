...
import { PlusMini, History, CommandLine, ThumbUp, ThumbDown } from "@arcangel/icons"
...
In this guide, you'll learn how to use the Cloud Assistant to ask questions about Arcangel and your projects from anywhere in the Cloud dashboard.

## What is the Cloud Assistant?

The Cloud Assistant is an AI agent that answers questions about Arcangel and about the projects in your organization. It can:
...
At the bottom of the Cloud Assistant chat, click the <InlineIcon Icon={ThumbUp} alt="thumbs up" /> or <InlineIcon Icon={ThumbDown} alt="thumbs down" /> icon to rate it. The Arcangel team uses this feedback to improve the Cloud Assistant.

---

## Contact Support

If the Cloud Assistant can't resolve your issue, click **Contact support** under the message input to reach the Arcangel team.
