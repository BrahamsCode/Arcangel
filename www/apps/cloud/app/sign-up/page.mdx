...
After creating an organization, you can start deploying your Arcangel applications and storefronts on Cloud.
...
To sign up for Cloud, go to [cloud.arcangel.com/signup](https://cloud.arcangel.com/signup?utm_source=docs&utm_medium=website&utm_campaign=cloud_signup_guide).
...
- **Where did you hear about Arcangel?**: Select an option from the dropdown menu. This helps us understand how users find out about Arcangel.
- **What are you building?**: Select an option from the dropdown menu. This helps us understand what users are building with Arcangel. If you don't see an option that fits your use case, select "Other" and provide more details in the text box that appears.
- **News and features**: Keep the switch enabled to receive updates about Arcangel, including new features, improvements, and other news. You can disable this option if you prefer not to receive such updates.
...
By default, the **Develop** plan is selected. This plan is minimal and allows you to deploy a single Arcangel application that is suitable for development and testing purposes.
...
At this point, Arcangel will charge your card for the first month based on the plan you selected, and you will be redirected to your organization's Cloud dashboard.

---

## Next Steps

After you sign up, the next step is to create your first project. Arcangel guides you based on the path that works best for you, with options for AI-assisted project creation.
