...
The [Cloud status page](https://status.arcangel.com) shows the current health of the services that Cloud runs, along with a history of past incidents and scheduled maintenance.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The Cloud API that the [dashboard](https://cloud.arcangel.com) and the [Cloud CLI](../cli/page.mdx) use.
...
1. Open the [status page](https://status.arcangel.com).
