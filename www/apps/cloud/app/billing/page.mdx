...
Arcangel bills your organization monthly based on its plan and usage across projects. If you're in multiple organizations, each organization is billed separately.
...
You can reach out to `billing@arcangel.com` for assistance.
...
You can set a spending threshold at which Arcangel will send you an alert. This helps you monitor your Flex Usage costs before they grow unexpectedly. This budget alert amount applies to your Flex Usage only, and not to the usage already part of your plan.
