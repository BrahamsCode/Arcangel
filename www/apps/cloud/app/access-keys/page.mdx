...
Access keys are useful when using the [Cloud CLI](../cli/page.mdx) in non-interactive environments such as CI/CD pipelines, server scripts, or when you want to avoid opening a browser for authentication.
...
3. Click on **Access keys** > **Organization** in the sidebar.
...
1. If you're in a different organization, [switch to the organization](../organizations/page.mdx#switch-organization).
2. Make sure you're on the projects overview page of the organization. You can do this by clicking on the organization name at the top left of the dashboard.
3. Click on **Access keys** > **Personal** in the sidebar.
