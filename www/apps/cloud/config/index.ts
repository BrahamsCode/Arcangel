...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "Arcangel Cloud Documentation",
  description:
    "Learn about Cloud, Arcangel's PaaS offering for scalable deployments. Learn how to sign up, deploy, and manage your Arcangel Cloud projects.",
  baseUrl,
