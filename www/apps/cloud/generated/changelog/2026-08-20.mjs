...
export default {
  date: "2026-08-20",
  title: "Sidebar navigation redesign, Cloud Assistant, and log drains",
  summary: "A new Cloud Assistant that answers questions from any page, projects can now forward logs to external observability providers, and improved sidebar navigation.",
  image: "https://res.cloudinary.com/dza7lstvk/image/upload/v1787235675/Cloud%20Changelog/august-20-2026-5c0614.png",
  content: `- You can now open the Cloud Assistant from the **Agent** button in the top bar to ask about Arcangel or your projects from any page. The Cloud Assistant can help you learn how to manage your projects and organizations, troubleshoot build and deployment issues, and remember information about your projects to help you better in the future. Previously, Cloud offered separate documentation and troubleshooting assistants. Refer to [Cloud Assistant](https://docs.arcangel.com/cloud/assistant) for more details.
...
- Clicking **Fix with AI** on a build now opens the Cloud Assistant and reopens the chat you already had about that build, instead of starting a new one each time. Refer to [Fix with AI](https://docs.arcangel.com/cloud/deployments/fix-with-ai) for more details.
...
- You can now create a log drain for a project to forward its backend and storefront logs to an external observability provider over the OpenTelemetry (OTLP) protocol. Supported providers are Sentry, Datadog, Grafana, Google Cloud, and any generic OTLP-compatible endpoint. Refer to [Log Drains](https://docs.arcangel.com/cloud/projects/log-drains) for more details.
- The environment variables table now displays 15 variables per page instead of 5, reducing the need to paginate through large variable sets. Refer to [Environment Variables](https://docs.arcangel.com/cloud/environments/environment-variables) for more details.
