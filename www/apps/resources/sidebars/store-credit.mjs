...
export const storeCreditSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Store Credit Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Store Credit features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
