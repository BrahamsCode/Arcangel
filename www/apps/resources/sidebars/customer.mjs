...
export const customerSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Customer Module in your customizations on the Arcangel application server.",
        children: [
          {
            type: "link",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Customer features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
