...
export const translationSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Translation Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Translation features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
