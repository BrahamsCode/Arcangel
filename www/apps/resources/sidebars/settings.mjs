...
export const settingsSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Settings Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
        title: "Admin Guides",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Settings features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
