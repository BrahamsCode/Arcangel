...
export const salesChannelSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Sales Channel Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Sales Channel features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
