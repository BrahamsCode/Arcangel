...
export const loyaltySidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Loyalty Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Loyalty features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
