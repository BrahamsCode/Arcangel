...
export const stockLocationSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Stock Location Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Stock Location features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
