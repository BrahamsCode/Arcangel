...
export const referencesSidebar = [
  ...
  {
    type: "link",
    path: "/arcangel-container-resources",
    title: "Container Resources",
    description:
      "Resources you can access through the Arcangel and Module containers.",
  },
  {
    type: "sidebar",
  ...
  },
  {
    ...
    title: "Events",
    description: "List of events emitted by Arcangel's Commerce Modules.",
  },
  {
    type: "sidebar",
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            type: "link",
            title: "arcangelIntegrationTestRunner",
            path: "/test-tools-reference/arcangelIntegrationTestRunner",
          },
          {
            type: "link",
