...
export const howToTutorialsSidebar = [
  ...
  },
  {
    ...
    title: "How-To Guides",
    description:
      "How-to guides are a collection of guides that help you understand how to achieve certain customizations or implementing specific features in Arcangel.",
    children: [
      {
        type: "sub-category",
        title: "Server",
        ...
        description:
          "These how-to guides help you customize the Arcangel server to implement custom features and business logic.",
      },
      {
        type: "sub-category",
        title: "Admin",
        ...
        sort_sidebar: "alphabetize",
        description:
          "These how-to guides help you customize the Arcangel Admin dashboard with practical examples.",
        children: [
          {
            type: "sidebar",
...
While tutorials show you a specific use case, they also help you understand how to implement similar use cases in your own projects. Also, you can implement the use case in a tutorial differently to fit your business requirements.`,
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to build Agentic Commerce with Arcangel to support purchase with AI agents like ChatGPT.",
      },
      {
        type: "ref",
        ...
        description:
          "Learn how to integrate Segment with Arcangel to track user interactions and events.",
      },
      {
        type: "link",
      ...
      },
      {
        ...
        description:
          "Learn how to implement bundled products in your Arcangel store.",
      },
      {
        type: "link",
      ...
      },
      {
        ...
        description:
          "Learn how to implement customer tiers in your Arcangel store.",
      },
      {
        type: "link",
        ...
        description:
          "Learn how to implement first-purchase discounts in your Arcangel store.",
      },
      {
        type: "link",
        ...
        description:
          "Learn how to generate invoices for orders in your Arcangel store.",
      },
      {
        type: "ref",
        ...
        description:
          "Learn how to integrate Payload CMS with Arcangel to manage your product content.",
      },
      {
        type: "link",
        ...
        description:
          "Learn how to implement a loyalty points system in your Arcangel store.",
      },
      {
        type: "ref",
        ...
        description:
          "Learn how to implement localization in Arcangel by integrating Contentful.",
      },
      {
        type: "ref",
      ...
      },
      {
        ...
        description:
          "Learn how to implement a product feed for Meta (Facebook and Instagram) and Google using Arcangel.",
      },
      {
        type: "ref",
        ...
        description:
          "Learn how to integrate Mailchimp with Arcangel to manage and automate newsletters.",
      },
      {
        type: "ref",
        ...
        description:
          "Learn how to implement personalized products in your Arcangel store.",
      },
      {
        type: "link",
      ...
      },
      {
        ...
        description:
          "Learn how to implement pre-order functionality for products in your Arcangel store.",
      },
      {
        type: "link",
      ...
      },
      {
        ...
        description:
          "Learn how to implement product rentals in your Arcangel store.",
      },
      {
        type: "link",
        ...
        description:
          "Learn how to implement product reviews in your Arcangel store.",
      },
      {
        type: "link",
      ...
      },
      {
        ...
        description:
          "Learn how to implement saved payment methods in your Arcangel store.",
      },
      {
        type: "link",
