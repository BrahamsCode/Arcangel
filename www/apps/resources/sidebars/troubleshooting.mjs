...
export const troubleshootingSidebar = [
  ...
  },
  {
    ...
    children: [
      {
        type: "link",
        path: "/troubleshooting/create-arcangel-app-errors",
        title: "Create Arcangel App Errors",
      },
      {
        type: "link",
  ...
  },
  {
    ...
    children: [
      {
        type: "link",
        path: "/troubleshooting/arcangel-admin/no-widget-route",
        title: "Widget or Route not Showing",
      },
      {
        type: "link",
        path: "/troubleshooting/arcangel-admin/blocked-request",
        title: "Blocked Request",
      },
      {
        type: "link",
        path: "/troubleshooting/arcangel-admin/build-error",
