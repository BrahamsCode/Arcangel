...
export const apiKeySidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the API Key Module in your customizations on the Arcangel application server.",
      },
      {
        type: "category",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage API Key features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
