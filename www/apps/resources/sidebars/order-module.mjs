...
export const orderSidebar = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "Learn how to use the Order Module in your customizations on the Arcangel application server.",
        children: [
          {
            type: "link",
      ...
      },
      {
        ...
        sort_sidebar: "alphabetize",
        description:
          "Learn how to utilize and manage Order features in the Arcangel Admin dashboard.",
      },
      {
        type: "category",
        title: "References",
