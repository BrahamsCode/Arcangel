...
Refer to the [Arcangel Admin User Guide](!user-guide!/products) to learn how to manage products using the dashboard.

</Note>

Arcangel has product related features available out-of-the-box through the Product Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Arcangel's commerce features are placed in Commerce Modules, such as this Product Module.
