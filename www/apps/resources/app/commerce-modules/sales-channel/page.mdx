...
Refer to the [Arcangel Admin User Guide](!user-guide!/settings/sales-channels) to learn how to manage sales channels using the dashboard.

</Note>

Arcangel has sales channel related features available out-of-the-box through the Sales Channel Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Arcangel's commerce features are placed in Commerce Modules, such as this Sales Channel Module.
...
- [Product Availability](./links-to-other-modules/page.mdx): Arcangel uses the Product and Sales Channel modules to allow merchants to specify a product's availability per sales channel.
...
- [Inventory Availability Per Sales Channel](./links-to-other-modules/page.mdx): Arcangel links sales channels to stock locations, allowing you to retrieve available inventory of products based on the specified sales channel.
