...
In this guide, you'll learn how Arcangel handles access to the [Get an Order API route](!api!/store/orders/get-an-order), and how to restrict access to it in your Arcangel application.

## How Arcangel Handles Order Retrieval
