...
Order locale is available starting [Arcangel v2.12.3](https://github.com/arcangel/arcangel/releases/tag/v2.12.3).
...
![A diagram showcasing the relation between an order and its items.](https://res.cloudinary.com/dza7lstvk/image/upload/v1712304722/Arcangel%20Resources/order-order-items_uvckxd.jpg)
...
`line_item_metadata` is available starting [Arcangel v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0).
...
![A diagram showcasing the relation between an order and its items.](https://res.cloudinary.com/dza7lstvk/image/upload/v1719570409/Arcangel%20Resources/order-shipping-method_tkggvd.jpg)
...
The Arcangel application passes the `data` property to the Fulfillment Module when fulfilling items.
