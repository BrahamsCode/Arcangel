...
<Prerequisites
  items={[
    {
      text: "Arcangel v2.12.3 or later",
      link: "https://github.com/arcangel/arcangel/releases/tag/v2.12.3"
    },
    {
...
Refer to the [Arcangel Admin User Guide](!user-guide!/settings/translations) to learn how to manage translations in the dashboard.

</Note>

Arcangel has translation features available out-of-the-box through the Translation Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Arcangel's commerce features is provided in Commerce Modules, such as the Translation Module.
...
- [Translation for Custom Models](./custom-data-models/page.mdx): Extend translation capabilities to custom data models in your Arcangel application.
- [Manage Translatable Resources from Arcangel Admin](!user-guide!/settings/translations#manage-translatable-resources): Configure which resources and fields are translatable directly from the Arcangel Admin dashboard.

---

## Configure Translation Module

The Translation Module is currently behind a feature flag. To use it in your Arcangel application, add it to the `modules` array and enable the `translation` feature flag.

In your `arcangel-config.ts` file, add the Translation Module to the `modules` array and enable the `translation` feature flag:
...
You can then use the Translation Module in your Arcangel application.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      <Table.Cell>
        `CustomerGroup` ([Customer Module](../customer/page.mdx)) ([+v2.12.4](https://github.com/arcangel/arcangel/releases/tag/v2.12.4))
      </Table.Cell>
      <Table.Cell>
        `name`
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `Region` ([Region Module](../region/page.mdx)) ([+v2.12.4](https://github.com/arcangel/arcangel/releases/tag/v2.12.4))
      </Table.Cell>
      <Table.Cell>
        `name`
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `ShippingOption` ([Fulfillment Module](../fulfillment/page.mdx)) ([+v2.12.4](https://github.com/arcangel/arcangel/releases/tag/v2.12.4))
      </Table.Cell>
      <Table.Cell>
        `name`
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `ShippingOptionType` ([Fulfillment Module](../fulfillment/page.mdx)) ([+v2.12.4](https://github.com/arcangel/arcangel/releases/tag/v2.12.4))
      </Table.Cell>
      <Table.Cell>
        - `label`
        - `description`
    ...
    <Table.Row>
      <Table.Cell>
        `TaxRate` ([Tax Module](../tax/page.mdx)) ([+v2.12.4](https://github.com/arcangel/arcangel/releases/tag/v2.12.4))
      </Table.Cell>
      <Table.Cell>
        `name`
      </Table.Cell>
