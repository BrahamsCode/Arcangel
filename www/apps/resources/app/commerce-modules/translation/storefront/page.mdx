...
In this guide, you’ll learn how to use locales and serve translated content in your storefront application in your Arcangel application.
...
Arcangel determines the locale for the request in the following order of priority:

- The `locale` query parameter in the API request.
- The `x-arcangel-locale` header in the API request.
