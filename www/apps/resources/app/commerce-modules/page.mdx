...
In this section of the documentation, you'll find guides and references related to Arcangel's Commerce Modules.

A Commerce Module provides features for a commerce domain within its service. When you install the Arcangel application, all Commerce Modules are available out-of-the-box. The Arcangel application exposes their features in its core API routes to clients.

A Commerce Module also defines data models, representing tables in the database. The Arcangel Framework and tools allow you to extend these data models to add custom fields.
...
<CardList
  items={[
    ...
    },
    {
      ...
      href: "/commerce-modules/settings"
    },
    {
    ...
    },
    {
      ...
      href: "/commerce-modules/store-credit",
      badge: {
        children: "Plugin",
        variant: "orange"
      }
...
- Arcangel Application: The Arcangel application comes with all Commerce Modules pre-installed and configured. Their commerce features are exposed through REST APIs.
