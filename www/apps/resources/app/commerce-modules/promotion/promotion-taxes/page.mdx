...
This feature is available from [Arcangel v2.8.5](https://github.com/arcangel/arcangel/releases/tag/v2.8.5).
...
In this scenario, Arcangel applies taxes consistently across the cart, ensuring that the total price reflects the taxes and promotions correctly.
...
You can enable tax-inclusiveness for a promotion when [creating it in the Arcangel Admin](!user-guide!/promotions/create).
...
For example, if you're creating a promotion with the [createPromotionsWorkflow](/references/arcangel-workflows/createPromotionsWorkflow) in an API route:
