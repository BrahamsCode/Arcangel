...
Refer to the [Arcangel Admin User Guide](!user-guide!/promotions) to learn how to manage promotions using the dashboard.

</Note>

Arcangel has promotion related features available out-of-the-box through the Promotion Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Arcangel's commerce features are placed in Commerce Modules, such as this Promotion Module.
