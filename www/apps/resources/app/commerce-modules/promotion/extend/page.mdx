...
- Set the `custom_name` property when a promotion is created or updated using Arcangel's API routes.
...
To do that, you'll consume the [promotionsCreated](/references/arcangel-workflows/createPromotionsWorkflow#promotionsCreated) hook of the [createPromotionsWorkflow](/references/arcangel-workflows/createPromotionsWorkflow). This workflow is executed in the [Create Promotion Admin API route](!api!/admin/promotions/create-promotion)
...
import { PromotionDTO } from "@arcangel/framework/types"
...
import { createPromotionsWorkflow } from "@arcangel/arcangel/core-flows"
import { 
...
Similar to the `promotionsCreated` hook, you'll consume the [promotionsUpdated](/references/arcangel-workflows/updatePromotionsWorkflow#promotionsUpdated) hook of the [updatePromotionsWorkflow](/references/arcangel-workflows/updatePromotionsWorkflow) to update `custom_name` when the promotion is updated.
...
import { updatePromotionsWorkflow } from "@arcangel/arcangel/core-flows"
import { 
