...
In this guide, you'll learn how to retrieve cart totals in your Arcangel application using [Query](!docs!/learn/fundamentals/module-links/query).

You may need to retrieve cart totals in your Arcangel customizations, such as workflows or custom API routes, to perform custom actions with them. The ideal way to retrieve totals is with Query.
...
To display a cart total, convert it to a plain number and format it. Since Arcangel stores prices in major currency units, you can format the value directly:
