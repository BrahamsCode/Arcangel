...
In this document, you’ll learn about the main concepts related to carts in Arcangel.
...
Cart locale is available starting [Arcangel v2.12.3](https://github.com/arcangel/arcangel/releases/tag/v2.12.3).
...
In the Arcangel application, a product variant is implemented in the [Product Module](../../product/page.mdx).
...
![A diagram showcasing the relation between the Cart and Address data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1711532392/Arcangel%20Resources/cart-addresses_ls6qmv.jpg)
...
In the Arcangel application, the shipping method is created from a shipping option, available through the [Fulfillment Module](../../fulfillment/page.mdx). Its ID is stored in the `shipping_option_id` property of the method.

<Note>

Adding multiple shipping methods in a single request is available since Arcangel [v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0).
