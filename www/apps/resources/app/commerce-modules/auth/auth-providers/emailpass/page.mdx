...
If you want to pass options to the provider, add the provider to the `providers` option of the Auth Module in your `arcangel-config.ts`:
...
The `require_verification` option was removed since Arcangel [v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0). Use the [authVerificationsPerActor configuration](!docs!/learn/configurations/arcangel-config#httpauthVerificationsPerActor) instead.
