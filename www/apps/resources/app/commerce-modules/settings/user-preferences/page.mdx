...
The Settings Module's service provides methods to create, retrieve, update, and delete user preferences. Resolve the service from the Arcangel container using `Modules.SETTINGS`.
