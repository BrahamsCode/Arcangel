...
In this document, you’ll learn how registered and unregistered accounts are distinguished in the Arcangel application.

<Note title="Looking for no-code docs?">

Refer to this [Arcangel Admin User Guide](!user-guide!/customers) to learn how to manage customers using the dashboard.
...
When using the Arcangel Application with the [Auth Module](../../auth/page.mdx), possible confusion may arise in the following scenarios:
...
- [Conceptual guide on how to implement this flow with Arcangel's authentication routes](../../auth/authentication-route/page.mdx#handling-existing-identities).
