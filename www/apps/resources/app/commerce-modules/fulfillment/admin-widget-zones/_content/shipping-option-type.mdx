...
The following injection zones are available from [Arcangel v2.10.0](https://github.com/arcangel/arcangel/releases/tag/v2.10.0)
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Type `DetailWidgetProps<AdminShippingOptionType>` imported from `@arcangel/framework/types`
