...
![A diagram showcasing the relation between a fulfillment, fulfillment provider, and shipping option](https://res.cloudinary.com/dza7lstvk/image/upload/v1712331947/Arcangel%20Resources/fulfillment-shipping-option_jk9ndp.jpg)
...
By default, when creating a fulfillment for an order, Arcangel uses the order's shipping address as the delivery address sent to the Fulfillment Module Provider.
...
![A diagram showcasing the relation between fulfillment and fulfillment items.](https://res.cloudinary.com/dza7lstvk/image/upload/v1712332114/Arcangel%20Resources/fulfillment-item_etzxb0.jpg)
