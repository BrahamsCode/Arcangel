...
Arcangel validates that sufficient credit is available and reserves the applied credit until the order is confirmed.
...
Arcangel provides a Claim Store Credit Account API to allow customers to claim their store credit accounts.
