...
The `providers` option is an array of payment module providers to be registered in your Arcangel application.

When the Arcangel application starts, these providers are registered and can be used to process payments.
