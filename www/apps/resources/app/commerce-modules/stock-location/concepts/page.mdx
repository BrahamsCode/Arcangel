...
The metadata field is available since Arcangel [v2.14.0](https://github.com/arcangel/arcangel/releases/tag/v2.14.0).

</Note>

Arcangel uses stock locations to provide inventory details, stored and managed by the [Inventory Module](../../inventory/concepts/page.mdx), per location.
