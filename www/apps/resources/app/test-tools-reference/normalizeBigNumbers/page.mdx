...
This is a reference to the `normalizeBigNumbers` function provided by the `@arcangel/test-utils` package.

<Note>

This function is available since Arcangel [v2.19.0](https://github.com/arcangel/arcangel/releases/tag/v2.19.0).
...
```ts
import { arcangelIntegrationTestRunner, normalizeBigNumbers } from "@arcangel/test-utils"
