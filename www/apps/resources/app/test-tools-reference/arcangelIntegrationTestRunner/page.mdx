...
export const metadata = {
  title: `arcangelIntegrationTestRunner Reference`,
}

# {metadata.title}

This is a reference to the `arcangelIntegrationTestRunner` function provided by the `@arcangel/test-utils` package.
  ...
  types={[
    {
      ...
      children: [
        {
          type: "`(options: ArcangelSuiteOptions) => void`",
          name: "testSuite",
        ...
        },
        {
          type: "`string`",
          name: "dbName",
          description: "A name to use for the database. If not specified, the database name will be of the format `arcangel-<moduleName>-integration-<randomNumber>`.",
          optional: true
        },
        {
          type: "`string`",
        ...
        {
          type: "`string`",
          name: "arcangelConfigFile",
          description: "The path to the `arcangel-config.ts` file, excluding `arcangel-config.ts`. This path is used as the current working directory as well.",
        ...
        },
        {
          ...
          children: [
            {
              type: "`(container: ArcangelContainer) => Promise<void>`",
              name: "beforeServerStart",
              description: "A hook that runs before the Arcangel server starts.",
          optional: true
            }
          ]
        }
      ...
      children: [
        {
          ...
          name: "api",
          description: "A set of methods used to send requests to the Arcangel application.",
          optional: false,
          children: [
            {
        ...
        {
          type: "`() => ArcangelContainer`",
          name: "getContainer",
          description: "A function that returns the Arcangel container.",
        },
        {
