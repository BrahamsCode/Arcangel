...
Find guides to deploy your Arcangel application, Arcangel Admin, and Next.js Starter Storefront.

## Cloud

Cloud is our managed services offering for Arcangel applications. Cloud hosts your server, Admin dashboard, database, and Redis instance. The infrastructure is security-compliant and optimized for Arcangel and supports:
...
To host and maintain Arcangel on your own, check out the following guides.

<Card
  title="General Guide"
  href="https://docs.arcangel.com/learn/deployment/general"
  text="General steps to deploy Arcangel."
/>
...
Cloud supports deploying storefronts alongside your Arcangel application. Learn more in the [Storefront Deployment on Cloud](!cloud!/storefront) guide.
