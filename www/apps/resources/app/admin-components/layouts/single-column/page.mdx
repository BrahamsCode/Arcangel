...
In this guide, you'll learn how to create a layout component that matches the Arcangel Admin's design conventions for pages with a single column of content.

<Note>

As of Arcangel v2.16.0, Arcangel provides a [LayoutComposer](../../components/layout-composer/page.mdx) component that you can use to create layouts, including the single column layout.

</Note>

The Arcangel Admin has pages with a single column of content.
...
![An example of an admin page with a single column](https://res.cloudinary.com/dza7lstvk/image/upload/v1728286605/Arcangel%20Resources/single-column.png)
