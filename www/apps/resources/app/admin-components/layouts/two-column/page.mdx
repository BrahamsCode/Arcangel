...
In this guide, you'll learn how to create a layout component that matches the Arcangel Admin's design conventions for pages with two columns of content.

<Note>

As of Arcangel v2.16.0, Arcangel provides a [LayoutComposer](../../components/layout-composer/page.mdx) component that you can use to create layouts, including the two column layout.

</Note>

The Arcangel Admin has pages with two columns of content.
...
![An example of an admin page with two columns](https://res.cloudinary.com/dza7lstvk/image/upload/v1728286690/Arcangel%20Resources/two-column_sdnkg0.png)
...
This UI route also uses [Container](../../components/container/page.mdx) and [Header](../../components/header/page.mdx) custom components.