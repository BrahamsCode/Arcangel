...
In this guide, you'll learn how to create a section row component that matches the Arcangel Admin's design conventions.

The Arcangel Admin often shows information in rows of label-values, such as when showing a product's details.

![Example of a section row in the Arcangel Admin](https://res.cloudinary.com/dza7lstvk/image/upload/v1728292781/Arcangel%20Resources/section-row_kknbnw.png)
