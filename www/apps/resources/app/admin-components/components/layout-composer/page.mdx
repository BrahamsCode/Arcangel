...
This component is available since Arcangel [v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0).
...
import type { LayoutComponentProps } from "@arcangel/dashboard/components"
...
To get type-safe section names when using your custom layout, augment the `LayoutSectionRegistry` interface in `@arcangel/admin-shared`:
