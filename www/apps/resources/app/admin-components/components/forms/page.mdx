...
In this guide, you'll learn how to create forms that match the Arcangel Admin's design conventions.

The Arcangel Admin has two types of forms:
...
This guide explains how to create these two form types following the Arcangel Admin's conventions.

## Form Tooling

The Arcangel Admin uses the following tools to build the forms:
...
You can replace the content of the function with sending a request to Arcangel's routes. Refer to [this guide](!docs!/learn/fundamentals/admin/tips#send-requests-to-api-routes) for more details on how to do that.
