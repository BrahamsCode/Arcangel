...
export const metadata = {
  title: `Implement Quick Re-Order Functionality in Arcangel`,
  openGraph: {
    images: [
      {
        url: ogImage,
...
In this tutorial, you'll learn how to implement a re-order functionality in Arcangel.
...
The Arcangel Framework facilitates building custom features that are necessary for your business use case. In this tutorial, you'll learn how to implement a re-order functionality in Arcangel. This feature is useful for businesses whose customers are likely to repeat their orders, such as B2B or food delivery businesses.
...
![Diagram showcasing the re-order logic](https://res.cloudinary.com/dza7lstvk/image/upload/v1746451309/Arcangel%20Resources/reorder-summary_wnbbws.jpg)

<CardList items={[
  {
    href: "https://github.com/arcangel/examples/tree/main/re-order",
...
To build custom commerce features in Arcangel, you create a [workflow](!docs!/learn/fundamentals/workflows). A workflow is a series of queries and actions, called steps, that complete a task.
...
This workflow uses steps from Arcangel's `@arcangel/arcangel/core-flows` package. So, you can implement the workflow without implementing custom steps.
...
Data manipulation is not allowed in a workflow, as Arcangel stores its definition before executing it. Instead, you can use `transform` from the Workflows SDK to manipulate the data.
...
Learn about other input parameters you can pass in the [createCartWorkflow reference](/references/arcangel-workflows/createCartWorkflow).
...
- Invoke it, passing it the [Arcangel container](!docs!/learn/fundamentals/arcangel-container) available in the `req.scope` property.
    - The Arcangel container is a registry of Framework and commerce resources that you can resolve and use in your customizations.
...
First, to start the Arcangel application, run the following command in the `apps/backend` directory:
...
![Orders page on customer account](https://res.cloudinary.com/dza7lstvk/image/upload/v1746449666/Arcangel%20Resources/Screenshot_2025-05-05_at_3.52.46_PM_ae4e78.png)

On the order's details page, you'll find a "Reorder" button.

![Reorder button on order details page](https://res.cloudinary.com/dza7lstvk/image/upload/v1746450255/Arcangel%20Resources/Screenshot_2025-05-05_at_4.03.51_PM_xaslqo.png)
...
![Checkout page showing the payment step](https://res.cloudinary.com/dza7lstvk/image/upload/v1746450342/Arcangel%20Resources/Screenshot_2025-05-05_at_4.05.29_PM_vqpdqo.png)

---

## Next Steps

You now have a re-order functionality in your Arcangel application and Next.js Starter Storefront. You can expand more on this feature based on your use case.
