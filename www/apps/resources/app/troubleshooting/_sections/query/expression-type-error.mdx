...
This issue has been resolved in [Arcangel v2.8.5+](https://github.com/arcangel/arcangel/releases/tag/v2.8.5). If you're facing this error, please [update your Arcangel application](!docs!/learn/update) and run the `dev` command. If the issue persists, please [report it on GitHub](https://github.com/arcangel/arcangel/issues/new/choose).
