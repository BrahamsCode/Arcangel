...
export const paginateHighlights = [
  ...
  ["27", "count", "The total number of products in the Arcangel application."],
...
This feature is available since [Arcangel v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0).
