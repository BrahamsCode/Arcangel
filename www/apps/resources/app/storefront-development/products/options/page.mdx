...
This feature is available since [Arcangel v2.17.0](https://github.com/arcangel/arcangel/releases/tag/v2.17.0).
...
export const paginateHighlights = [
  ...
  ["27", "count", "The total number of product options in the Arcangel application."],
