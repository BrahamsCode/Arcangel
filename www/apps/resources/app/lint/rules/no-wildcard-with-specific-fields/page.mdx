...
This rule is available since Arcangel [v2.18.0](https://github.com/arcangel/arcangel/releases/tag/v2.18.0).
...
export default defineConfig([
  ...
  {
    rules: {
      "@arcangel/no-wildcard-with-specific-fields": "off",
    },
  },
])
```
...
```ts
// eslint-disable-next-line @arcangel/no-wildcard-with-specific-fields
