...
Learn more in the [Arcangel Container documentation](!docs!/learn/fundamentals/arcangel-container).
...
export default defineConfig([
  ...
  {
    rules: {
      "@arcangel/prefer-container-registration-keys": "off",
    },
  },
])
```
...
```ts
// eslint-disable-next-line @arcangel/prefer-container-registration-keys
const query = req.scope.resolve("query")
```
