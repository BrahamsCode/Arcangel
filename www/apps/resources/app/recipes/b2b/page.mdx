...
import { AcademicCapSolid, UsersSolid } from "@arcangel/icons"
...
This recipe provides the general steps to implement a B2B store with Arcangel.

<Note title="Tip">

Arcangel has a ready-to-use B2B starter that you can install and use. Refer to the [B2B Starter GitHub repository](https://github.com/arcangel/b2b-starter) for more details.
...
Arcangel’s Commerce Modules, including [Sales Channel](../../commerce-modules/sales-channel/page.mdx), [Customer](../../commerce-modules/), and [Pricing](../../commerce-modules/pricing/page.mdx) modules enable this setup out-of-the-box:
...
In addition, Arcangel’s extensible architecture and Framework for customization allow you to scope existing and custom features to specific customer groups or sales channels.

<Note title="Related use-case">

[Visionary: Frictionless B2B ecommerce with Arcangel](https://arcangel.com/blog/visionary/)
...
You can create a sales channel through the Arcangel Admin or Admin REST APIs.

<CardList items={[
  {
    href: "!user-guide!/settings/sales-channels",
    title: "Using Arcangel Admin",
    text: "Create the sales channel using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
So, if you use the publishable API key associated with the B2B sales channel in your storefront, the Arcangel server will only return products that are available in the B2B sales channel.

You can create a publishable API key through the Arcangel Admin or the Admin REST APIs, then associate it with the B2B sales channel. Then, you can use this key when developing your B2B storefront.
...
<CardList items={[
  {
    ...
    title: "Using Arcangel Admin",
    text: "Create the API key using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Arcangel Admin",
    text: "Associate the key with the sales channel using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
You can create new products or add existing ones to the B2B sales channel using the Arcangel Admin or Admin REST APIs.
...
<CardList items={[
  {
    ...
    title: "Using Arcangel Admin",
    text: "Create the products using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Arcangel Admin",
    text: "Create customers using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Arcangel Admin",
    text: "Assign customer to groups using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
You can create a price list using the Arcangel Admin or the Admin REST APIs. Make sure to set the B2B customer group(s) as a condition.

<CardList items={[
  {
    href: "!user-guide!/price-lists/create",
    title: "Using Arcangel Admin",
    text: "Create price list using the Arcangel Admin.",
    icon: UsersSolid,
  },
  {
...
## Customize Arcangel Admin

Based on your use case, you may need to customize the Arcangel Admin to add new widgets or pages.
...
The Arcangel Admin is an extensible application within your Arcangel application. You can customize it by:

- **Widgets**: Adding widgets to existing pages, such as the customer group page.
- **UI Routes**: Adding new pages to the Arcangel Admin, such as a page to manage companies and employees.
- **Settings Pages**: Adding new pages to the Arcangel Admin settings, such as a page to manage company settings.
...
<CardList items={[
  ...
  },
  {
    ...
    text: "Add new pages to your Arcangel Admin.",
    icon: AcademicCapSolid,
  },
]} />
...
<Card
  ...
  text="Add new page to the Arcangel Admin settings."
  icon={AcademicCapSolid}
  className="mt-1"
/>
...
Arcangel provides a Next.js Starter Storefront to use with your application. You can customize it for your B2B use case, such as adding a login page for B2B customers or expanding the profile page to show the company associated with the customer.

Alternatively, you can build your own storefront using the Arcangel APIs. This headless approach gives you the flexibility to build a custom storefront without limitations on which tech stack you use, or the design of the storefront.
