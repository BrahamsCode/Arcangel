...
This recipe provides the general steps to implement a marketplace in your Arcangel application.
...
Arcangel supports creating custom actor types that can be authenticated with your custom API routes.

<CardList items={[
  {
    href: "!docs!/learn/fundamentals/api-routes",
    title: "Create API Routes",
    text: "Learn how to create an API Route in Arcangel.",
    icon: AcademicCapSolid,
  },
  {
...
<CardList items={[
  ...
  },
  {
    ...
    text: "Learn how to create a workflow in Arcangel.",
    icon: AcademicCapSolid,
  },
]} />
...
- **UI Routes**: Adding new pages to the Arcangel Admin, such as a page to manage vendors.
- **Settings Pages**: Adding new pages to the Arcangel Admin settings, such as a page to manage marketplace settings.
...
For more complex use cases, customizing the Arcangel Admin may not be enough to allow vendors to manage their data.

In that case, you can build a custom dashboard for vendors that allows them to manage their data. This dashboard can interact with Arcangel's Admin API and the custom API routes you created for vendors to provide a seamless experience.

<Card
  href="!api!/admin"
  title="Arcangel Admin APIs"
  text="Learn about available APIs for the Arcangel Admin."
  icon={AcademicCapSolid}
/>
...
Arcangel provides a Next.js Starter Storefront to use with your application. You can customize it for your marketplace use case, such as showing products by vendor.
