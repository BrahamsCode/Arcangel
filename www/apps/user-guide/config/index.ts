...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "Arcangel Admin User Guide",
  description:
    "Explore and learn how to use the Arcangel Admin. Learn how to manage products, orders, customers, and more within the Arcangel Admin dashboard.",
  baseUrl,
