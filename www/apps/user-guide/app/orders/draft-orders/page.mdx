...
export const metadata = {
  title: `Draft Orders in Arcangel Admin`,
}
...
The Draft Orders section of the Arcangel Admin allows you to create and manage draft orders on behalf of customers.
