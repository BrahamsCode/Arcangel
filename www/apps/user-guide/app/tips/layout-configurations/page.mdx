...
import { Adjustments, BellAlert, DotsSix, EyeMini, EyeSlashMini } from "@arcangel/icons"
import { InlineIcon } from "docs-ui"

export const metadata = {
  title: `Configure Layouts of the Arcangel Admin Dashboard`,
}

# {metadata.title}

In this guide, you'll learn how to customize the layout of the Arcangel Admin dashboard to suit your preferences and workflow.

<Note>

Layout configuration is available from [Arcangel Admin v2.17.2](https://github.com/arcangel/arcangel/releases/tag/v2.17.2). If you don't see the layout configuration options in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).

</Note>

## What is Layout Configuration?

The Arcangel Admin dashboard allows you to configure the layout of its pages, sidebar, and top navigation bar to suit your preferences and workflow. You can choose what to display and in what order.

You can customize the layouts of core Arcangel pages, as well as pages of Arcangel plugins and integrations. You can also create personal layouts, and layouts for your team.
...
You can customize the top bar layout to show the items you want, and in the order you want. By default, you can only customize the <InlineIcon Icon={BellAlert} alt="notifications" /> icon, but if you have Arcangel plugins that add items to the top bar, you can customize those items as well.
