...
import { Adjustments, Funnel, DescendingSorting } from "@arcangel/icons"
import { InlineIcon } from "docs-ui"

export const metadata = {
  title: `Configure Table Views in Arcangel Admin`,
}

# {metadata.title}

In this guide, you'll learn how to customize data tables in the Arcangel Admin dashboard and save your customizations as reusable views.

<Note>

Configurable table views are an experimental feature that your technical team must enable in your Arcangel application before you can use it. If you don't see the view options described in this guide, ask your technical team to [enable them](!resources!/commerce-modules/settings/view-configurations).

</Note>

## What are Table Views?

Many pages in the Arcangel Admin show your data in tables, such as the products or orders list. A table view is a saved customization of a table, including which columns are shown, their order, the applied filters, the sorting, and the search query.
