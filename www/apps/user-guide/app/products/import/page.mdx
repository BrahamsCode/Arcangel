...
import { ArrowDownTray, Trash, BellAlert, EllipsisHorizontal } from "@arcangel/icons"
import { Prerequisites, Table } from "docs-ui"

export const metadata = {
  title: `Import Products in Arcangel Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to import products into your Arcangel store.

## Import Products from a CSV File

If you're migrating from another commerce platform, or from Arcangel v1, you can import products into Arcangel using a CSV file.

When you import the CSV file, Arcangel will either create or update products based on the CSV file you upload.
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>Whether Arcangel manages the variant's inventory. Can be `true` or `false`.</Table.Cell>
    </Table.Row>
    <Table.Row>
...
1. The [storage integration](!resources!/infrastructure-modules/file) is correctly set up in your Arcangel application.
2. The CSV file follows the [required format](#csv-file-format).
3. All IDs provided in the CSV file (such as for collections, categories, tags, sales channels, shipping profiles, etc...) exist in your Arcangel application.

You can also refer to the server logs of your Arcangel application to get more information about the error.
