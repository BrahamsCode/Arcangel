...
import { ArrowUpRightOnBox, EllipsisHorizontal, EllipsisVertical, ThumbnailBadge, XMark } from "@arcangel/icons"
import { Table } from "docs-ui"

export const metadata = {
  title: `Edit Product in Arcangel Admin`,
}

# {metadata.title}

In this guide, you'll learn about editing a product's details in the Arcangel Admin.
...
Locales are available from [Arcangel v2.12.3](https://github.com/arcangel/arcangel/releases/tag/v2.12.3). If you don't see the translation management in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
...
Product variant media is available from [Arcangel Admin v2.11.2](https://github.com/arcangel/arcangel/releases/tag/v2.11.2). If you don't see the "Manage associated variants" action, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
...
As of [Arcangel v2.16.0](https://github.com/arcangel/arcangel/releases/tag/v2.16.0), product options can be managed globally and re-used across products. If you don't see the Product → Options page in the sidebar, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
...
![Manage Product Options form in the Arcangel Admin dashboard](https://res.cloudinary.com/dza7lstvk/image/upload/v1765529614/User%20Guide/CleanShot_2025-12-12_at_10.53.03_2x_f8ftqv.png)
