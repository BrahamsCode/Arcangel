...
import { EllipsisHorizontal, XMark } from "@arcangel/icons"

export const metadata = {
  title: `Manage Gift Card Products in Arcangel Admin`,
}

# {metadata.title}

In this guide, you'll learn how to create and manage gift card products in the Arcangel Admin.
