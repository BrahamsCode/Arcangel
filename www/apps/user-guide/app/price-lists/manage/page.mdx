...
import { EllipsisHorizontal, ArrowUpRightOnBox, EllipsisVertical, ArrowsPointingOut, PlusMini, XMarkMini } from "@arcangel/icons"
import { Table, InlineIcon } from "docs-ui"

export const metadata = {
  title: `Manage Price Lists in Arcangel Admin`,
}
...
Quantity-based pricing is available since [Arcangel v2.17.2](https://github.com/arcangel/arcangel/releases/tag/v2.17.2).
...
The Metadata section is available since [Arcangel v2.15.0](https://github.com/arcangel/arcangel/releases/tag/v2.15.0). If you don't see the Metadata section in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
