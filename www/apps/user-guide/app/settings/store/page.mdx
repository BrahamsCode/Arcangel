...
export const metadata = {
  title: `Manage Store in Arcangel Admin`,
}
...
In the store's settings, you can also manage a currency's tax-inclusive price setting. During checkout, after Arcangel calculates the tax of a product or shipping, it will either:
...
Locales are available from [Arcangel v2.12.3](https://github.com/arcangel/arcangel/releases/tag/v2.12.3). If you don't see the locale settings in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
