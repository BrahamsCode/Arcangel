...
export const metadata = {
  title: `Manage Product Tags in Arcangel Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to manage product tags in the Arcangel Admin.
...
Management of product tag metadata was added in [Arcangel v2.10.0](https://github.com/arcangel/arcangel/releases/tag/v2.10.0).
