...
import { EllipsisHorizontal, TaxExclusive, TaxInclusive, ArrowsPointingOut, Plus } from "@arcangel/icons"

export const metadata = {
  title: `Manage Locations in Arcangel Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to manage the stock locations using the Arcangel Admin.
