...
export const metadata = {
  title: `Manage Users in Arcangel Admin`,
}
...
This feature is available since [Arcangel v2.20.0](https://github.com/arcangel/arcangel/releases/tag/v2.20.0). The option only appears for users that authenticate with an email and password. If you don't find the option to copy a reset password link, make sure to [update your Arcangel application](!docs!/learn/update).
...
This feature is available since [Arcangel v2.12.0](https://github.com/arcangel/arcangel/releases/tag/v2.12.0). If you don't find the option to delete a user, or user deletion doesn't work, make sure to [update your Arcangel application](!docs!/learn/update).
