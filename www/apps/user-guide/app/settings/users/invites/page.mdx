...
export const metadata = {
  title: `Manage Invites in Arcangel Admin`,
}
...
Make sure you've set up [Arcangel Emails](!cloud!/emails) in your Cloud project to send admin user invite emails. Arcangel Emails is a managed email service that allows you to send transactional emails with zero configuration.
