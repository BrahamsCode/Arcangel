...
export const metadata = {
  title: `Manage Property Labels in Arcangel Admin`,
}

# {metadata.title}

In this guide, you'll learn how to manage property labels in the Arcangel Admin.

## What is a Property Label?

Property labels let you customize the names of columns shown in the Arcangel Admin's [configurable table views](../../tips/table-views/page.mdx). When the dashboard builds a data table, it uses your property labels as the column names, so you can use the terminology that fits your store.
