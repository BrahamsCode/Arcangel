...
export const metadata = {
  title: `Developer Settings in Arcangel Admin`,
}

# {metadata.title}

The Developer section in the Arcangel Admin's settings is useful for developers building customizations for your Arcangel application.
