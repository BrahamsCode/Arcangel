...
import { BarsArrowDown, Collapse } from "@arcangel/icons"
import { Prerequisites, InlineIcon } from "docs-ui"

export const metadata = {
  title: `Manage Translations in Arcangel Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to manage translations of resources like products in the Arcangel Admin.

<Note>

Translations are available from [Arcangel v2.12.3](https://github.com/arcangel/arcangel/releases/tag/v2.12.3). If you don't see the locale settings in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).

</Note>

## Translations Overview

Arcangel allows you to translate various resources in your store, such as product titles and descriptions, into multiple locales (languages) supported by your store.
...
You can view and manage translations in the Arcangel Admin dashboard by going to Settings → Translations. This page allows you to manage translations of core and custom resources in bulk.
