...
export const metadata = {
  title: `Manage Refund Reasons in Arcangel Admin`,
}
...
Refund reason management is available from [Arcangel v2.11.0](https://github.com/arcangel/arcangel/releases/tag/v2.11.0). If you don't see the Refund Reasons option in your Arcangel Admin, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
...
Arcangel adds some default refund reasons to your store. You can use or [delete](#delete-a-refund-reason) them.
