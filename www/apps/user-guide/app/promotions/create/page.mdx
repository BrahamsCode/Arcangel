...
export const metadata = {
  title: `Create a Promotion in Arcangel Admin`,
}
...
If any of the fields are not visible in your admin, contact your technical team to [update your Arcangel version](!docs!/learn/update).
...
Free shipping promotions were added in [Arcangel v2.10.0](https://github.com/arcangel/arcangel/releases/tag/v2.10.0).
...
The **Limit usage per** field is available from [Arcangel Admin v2.11.0](https://github.com/arcangel/arcangel/releases/tag/v2.11.0). If you don't see it, request your technical team to [upgrade your Arcangel application](!docs!/learn/update).
