...
const redirects = async () => {
  return [
    ...
    {
      source: "/arcangel-react/:path*",
      destination: "/v1/arcangel-react/:path*",
      permanent: true,
    },
    {
    ...
    {
      source: "/learn/basics/arcangel-container",
      destination: "/learn/fundamentals/arcangel-container",
      permanent: true,
    },
    {
    ...
    {
      source: "/starters/nextjs-arcangel-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
    ...
    },
    {
      ...
      destination: "/resources/arcangel-cli",
      permanent: true,
    },
    {
    ...
    {
      source: "/v1/starters/nextjs-arcangel-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
    ...
    },
    {
      ...
      destination: "/learn/configurations/arcangel-config",
      permanent: true,
    },
    {
    ...
    {
      source: "/usage/create-arcangel-app",
      destination: "/learn/installation",
      permanent: true,
    },
    {
    ...
    {
      source: "/starters/gatsby-arcangel-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
