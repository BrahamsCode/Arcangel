  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <span className="text-medium text-arcangel-fg-subtle">
      ...
      <div className="flex flex-col gap-0.5">
        <form
          className={clsx(
            "py-[10px] px-0.75 flex gap-0.75 bg-arcangel-bg-base",
        ...
        >
          <input
            className={clsx(
              ...
              "placeholder:text-arcangel-fg-muted bg-transparent",
          ...
          <button
            ...
            className={clsx(
              ...
              "text-arcangel-fg-base disabled:text-arcangel-fg-disabled flex-shrink-0 whitespace-nowrap",
              "hover:text-arcangel-fg-subtle cursor-pointer"
            )}
            disabled={loading}
          >
            Subscribe
        ...
        {message && (
          <span className="text-arcangel-fg-subtle">{message.text}</span>
        )}
      </div>
    </div>
  )
