...
const HomepageCommerceModulesSection = () => {
  ...
  return (
    <div className="w-full border-b border-arcangel-border-base">
      <div className="p-2 flex gap-2 border-b border-arcangel-border-base">
        <h2 className="text-h1 text-arcangel-fg-base min-w-max">
          Commerce Modules
        </h2>
        ...
        {sections.map((section, index) => (
          ...
          >
            ...
            {section.modules.map(({ Icon, ...module }, modIndex) => (
              ...
              >
                <span className="absolute top-0 left-0 lg:-left-px w-[2px] h-full bg-transparent group-hover:bg-arcangel-fg-interactive" />
                <div className="flex gap-0.5 items-center">
                  <Icon className="text-arcangel-fg-subtle group-hover:text-arcangel-fg-interactive" />
                  <span className="text-arcangel-fg-base text-medium-plus">
                    {module.name}
                  </span>
                </div>
