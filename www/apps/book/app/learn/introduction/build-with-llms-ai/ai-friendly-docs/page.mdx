...
export const metadata = {
  title: `${pageNumber} AI-Friendly Arcangel Documentation`,
}

# {metadata.title}

In this chapter, you'll learn about the AI-friendly features of the Arcangel documentation, including the AI Assistant and the plain text documentation.

## AI Assistant in Documentation

The Arcangel documentation includes an AI Assistant that answers your questions and helps you build customizations with Arcangel.

<Note>

The AI Assistant in the docs is different from [Bloom](https://bloom.chat/), our AI-powered commerce assistant that helps you build, manage, and scale your ecommerce store. The AI Assistant in the docs is specifically designed to help you with Arcangel development by providing relevant documentation links, code snippets, and explanations.
...
You can then ask the AI Assistant any questions about Arcangel, such as:

- What is a workflow?
- How to create a product review module?
- How to update Arcangel?
...
The Arcangel documentation is available in plain text format, allowing LLMs and AI tools to easily parse and understand the content.

You can access the following plain text documentation files:

- [llms.txt](https://docs.arcangel.com/llms.txt): Contains a short structure of links to important documentation pages.
- [llms-full.txt](https://docs.arcangel.com/llms-full.txt): Contains the full documentation content, including all pages and sections.
- **Markdown version of any page**: Users and agents can access the Markdown version of any documentation page by either:
    ...
    - Appending `/index.html.md` to the page URL. For example, the plain text content of the current page is available at [https://docs.arcangel.com/learn/introduction/build-with-llms-ai/ai-friendly-docs/index.html.md](https://docs.arcangel.com/learn/introduction/build-with-llms-ai/ai-friendly-docs/index.html.md).
    - Appending `.md` to the page URL. For example, the plain text content of the current page is also available at [https://docs.arcangel.com/learn/introduction/build-with-llms-ai/ai-friendly-docs.md](https://docs.arcangel.com/learn/introduction/build-with-llms-ai/ai-friendly-docs.md).
