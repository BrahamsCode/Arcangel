...
Thank you for your interest in contributing to the documentation! You will be helping the open source community and other developers interested in learning more about Arcangel and using it.
...
This guide is specific to contributing to the documentation. If you’re interested in contributing to Arcangel’s codebase, check out the [contributing guidelines in the Arcangel GitHub repository](https://github.com/arcangel/arcangel/blob/develop/CONTRIBUTING.md).

</Note>

## What Can You Contribute?

You can contribute to the Arcangel documentation in the following ways:
...
- Additions to the documentation. If you think a documentation page can be useful to other developers, you can contribute by adding it.
    - Make sure to open an issue first in the [arcangel repository](https://github.com/arcangel/arcangel) to confirm that you can add that documentation page.
...
Arcangel's documentation projects are all part of the documentation `yarn` workspace, which you can find in the [arcangel repository](https://github.com/arcangel/arcangel) under the `www` directory.
...
- `apps`: this directory holds the different documentation websites and projects. All projects are built with [Next.js 15](https://nextjs.org/).
  - `book`: includes the codebase and content for the [main Arcangel documentation](../../../page.mdx).
  ...
  - `ui`: includes the codebase and content for the [Arcangel UI documentation](!ui!).
  - `user-guide`: includes the codebase and content for the [user guide documentation](!user-guide!).
  - `cloud`: includes the codebase and content for the [Arcangel Cloud documentation](!cloud!).
...
### Arcangel Main Docs Content

The content of the Arcangel main docs are under the `www/apps/book/app` directory.

### Arcangel Resources Content

The content of all pages under the `/resources` path are under the `www/apps/resources/app` directory.

<Note>

Documentation pages under the `www/apps/resources/references` directory are generated automatically from the source code under the `packages/arcangel` directory. So, you can't directly make changes to them. Instead, you'll have to make changes to the comments in the original source code.
...
### Arcangel UI Documentation

The content of the Arcangel UI documentation are located under the `www/apps/ui/app` directory. They are MDX files.
...
If you’re adding a new page or contributing to the codebase, fork the repository, create a new branch, and make all changes necessary in your repository. Then, once you’re done, create a PR in the Arcangel repository.
...
Arcangel uses [Vale](https://vale.sh/) to lint documentation pages and perform checks on incoming PRs into the repository.
...
# to lint content for the Arcangel UI documentation
...
Arcangel supports Node versions 14 and 16.
...
Arcangel uses ESlint to lint code blocks both in the content and the code base of the documentation apps.
