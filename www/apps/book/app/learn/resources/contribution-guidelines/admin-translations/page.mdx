export const metadata = {
  title: `Translate Arcangel Admin`,
}

# {metadata.title}

The Arcangel Admin supports multiple languages, with the default being English. In this documentation, you'll learn how to contribute to the community by translating the Arcangel Admin to a language you're fluent in.
...
Check out the translated languages either in the admin dashboard's settings or on [GitHub](https://github.com/arcangel/arcangel/blob/develop/packages/admin/dashboard/src/i18n/languages.ts).
...
1. Clone the [Arcangel monorepository](https://github.com/arcangel/arcangel) to your local machine:

```bash
git clone https://github.com/arcangel/arcangel.git
```
