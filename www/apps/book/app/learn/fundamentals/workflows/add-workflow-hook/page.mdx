...
Refer to the [Workflow Hooks](../workflow-hooks/page.mdx) chapter to learn what a workflow hook is and how to consume Arcangel's workflow hooks.

</Note>

## When to Expose a Hook?

Arcangel exposes hooks in many of its workflows to allow you to inject custom functionality.
...
You can also access the Arcangel container in the hook handler to perform actions like using Query or module services.
