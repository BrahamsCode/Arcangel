...
Arcangel also uses Query Context to [retrieve product variants' prices based on the customer's currency](!resources!/commerce-modules/product/guides/price).
...
import { ArcangelContext, ArcangelService } from "@arcangel/framework/utils"
