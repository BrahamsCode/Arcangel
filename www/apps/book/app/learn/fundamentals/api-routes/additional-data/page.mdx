...
export const metadata = {
  title: `${pageNumber} Pass Additional Data to Arcangel's API Route`,
}

# {metadata.title}

In this chapter, you'll learn how to pass additional data in requests to Arcangel's API Route.

## Why Pass Additional Data?

Some of Arcangel's API Routes accept an `additional_data` parameter whose type is an object. The API Route passes the `additional_data` to the workflow, which in turn passes it to its hooks.
...
For example, the [Create Product API Route](!api!/admin/products/create-product) accepts an `additional_data` parameter. If you have a data model linked to it, you consume the `productsCreated` hook to create a record of the data model using the custom data and link it to the product.
...
- Campaigns
    - [Create Campaign](!api!/admin/campaigns/create-campaign)
    - [Update Campaign](!api!/admin/campaigns/update-a-campaign)
- Cart
    - [Create Cart](!api!/store/carts/create-cart)
    - [Update Cart](!api!/store/carts/update-a-cart)
- Collections
...
- Customers
    - [Create Customer](!api!/admin/customers/create-customer)
    - [Update Customer](!api!/admin/customers/update-a-customer)
    - [Create Address](!api!/admin/customers/add-address)
    - [Update Address](!api!/admin/customers/update-address)
- Draft Orders
    - [Create Draft Order](!api!/admin/draft-orders/create-draft-order)
- Orders
    - [Complete Orders](!api!/admin/orders/complete-order)
    - [Cancel Order's Fulfillment](!api!/admin/orders/cancel-fulfillment)
    - [Create Shipment](!api!/admin/orders/create-shipment)
    - [Create Fulfillment](!api!/admin/orders/create-fulfillment)
- Products
    - [Create Product](!api!/admin/products/create-product)
    - [Update Product](!api!/admin/products/update-a-product)
    - [Create Product Variant](!api!/admin/products/create-variant)
    - [Update Product Variant](!api!/admin/products/update-variant)
- Product Tags
...
- Promotions
    - [Create Promotion](!api!/admin/promotions/create-promotion)
    - [Update Promotion](!api!/admin/promotions/update-a-promotion)
