...
Use these rules whenever linking to Arcangel documentation in a comment, regardless of issue category.
...
Prepend `https://docs.arcangel.com` to all paths:

```
https://docs.arcangel.com/learn
https://docs.arcangel.com/resources/commerce-modules
https://docs.arcangel.com/api/admin#products_getproducts
```
