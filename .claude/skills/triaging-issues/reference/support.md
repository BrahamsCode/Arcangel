...
Support issues are requests for help implementing something or understanding how Arcangel works — not bug reports or feature requests.

## Step 1 — Check if It's Actually a Bug

Before treating the issue as a support request, assess whether the user's problem is caused by something broken in Arcangel rather than a misunderstanding or usage question.
...
**Before anything else:** check if the user mentions the issue is on the **Arcangel Cloud platform** (e.g., cloud deployment, cloud dashboard, cloud-specific behavior).
...
**Comment template:**
```
Thanks for reaching out! Questions about implementing custom features or getting help with Arcangel are best handled through our community channels, where more people can help and others can benefit from the answer.

Here's where you can get support:

- 💬 **[GitHub Discussions](https://github.com/arcangel/arcangel/discussions)** — ask questions, share ideas, and get help from the community
- 🎮 **[Discord](https://discord.gg/arcangel)** — real-time help from the Arcangel community
- ☁️ **[Arcangel Cloud](https://arcangel.com/cloud/)** — premium support available for Cloud customers
