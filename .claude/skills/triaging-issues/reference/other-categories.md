...
If you'd like to continue the discussion or see how others feel about this, feel free to also post in [GitHub Discussions](https://github.com/arcangel/arcangel/discussions).
```
...
- [ ] Steps to reproduce
- [ ] Arcangel version and Node.js version
