...
**Where to look:**
- Arcangel source code (`packages/`)
- Official docs (`www/apps/` or https://docs.arcangel.com)
...
```
Thanks for the suggestion! This functionality is actually already available in Arcangel.
...
| Example | Label | Notes |
|---------|-------|-------|
| Add a new admin dashboard language/translation | `good first issue` | Link to [admin translations guide](https://docs.arcangel.com/learn/resources/contribution-guidelines/admin-translations) |
...
We'd welcome a PR for this! Check out our [contribution guidelines](https://github.com/arcangel/arcangel/blob/develop/CONTRIBUTING.md) to get started.
```

For admin translation requests specifically, also link to: https://docs.arcangel.com/learn/resources/contribution-guidelines/admin-translations
