...
[#NNNN](https://github.com/arcangel/arcangel/pull/NNNN)
...
[#MMMM](https://github.com/arcangel/arcangel/pull/MMMM)
```
...
- Avoid "we" — write "Arcangel now supports…" or use passive sparingly
...
Zod has been moved from a peer dependency to a direct dependency of `@arcangel/framework`. If you previously installed Zod explicitly in your project to satisfy the peer dependency requirement, you can remove it.

[#14441](https://github.com/arcangel/arcangel/pull/14441)
```
...
[#14520](https://github.com/arcangel/arcangel/pull/14520)
```
...
Arcangel's CLI and starter templates now fully support pnpm as a package manager. Pass `--package-manager pnpm` when creating a new project:

\`\`\`bash
npx create-arcangel-app@latest my-store --package-manager pnpm
\`\`\`

[#14600](https://github.com/arcangel/arcangel/pull/14600)
```
