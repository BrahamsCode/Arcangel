...
**Full Changelog**: [vX.Y.Z-prev...vX.Y.Z](https://github.com/arcangel/arcangel/compare/vX.Y.Z-prev...vX.Y.Z)
```
...
```
*   <type>(<scope>): <description> by [@username](https://github.com/username) in [#NNNN](https://github.com/arcangel/arcangel/pull/NNNN)
```

- Three spaces after the asterisk: `*   `
- Author: `[@username](https://github.com/username)` — use the GitHub handle from PR metadata
- PR: `[#NNNN](https://github.com/arcangel/arcangel/pull/NNNN)` — always linked
- Use the conventional commit prefix from the commit/PR title as-is (e.g. `feat(cart):`, `fix(order):`, `chore(deps):`)

**Example:**
```
*   feat(cart): add support for gift card line items by [@shahednasser](https://github.com/shahednasser) in [#14500](https://github.com/arcangel/arcangel/pull/14500)
```
...
```markdown
## New Contributors
* @username made their first contribution in [#NNNN](https://github.com/arcangel/arcangel/pull/NNNN)
```
