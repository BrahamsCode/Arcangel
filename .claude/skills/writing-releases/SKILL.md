...
description: Writes GitHub release notes for Arcangel releases in the established style. Use when generating a draft release description from a list of commits and PR metadata. Covers minimal patch releases, single-highlight releases, multi-feature releases, and releases with breaking changes.
---

# Writing Arcangel Release Notes

Generates GitHub release notes from commit/PR data in the established Arcangel style.
