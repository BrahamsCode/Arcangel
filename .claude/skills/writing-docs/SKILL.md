---
name: writing-docs
description: Writes and updates Arcangel documentation MDX files for the book, resources, ui, user-guide, and cloud projects. Use when making documentation changes based on code diffs, adding new pages, updating existing content, or updating component examples. ALWAYS load this skill before modifying any MDX file in www/apps/.
---

# Writing Arcangel Documentation
...
- [ ] Using "Arcangel API" to mean the backend — use "Arcangel backend" instead
- [ ] Writing "Arcangel Cloud" — use "Arcangel" (noun form) or "Cloud" (location/service)
