...
export const highlights = [
  ...
  ["4", "container", "Receive the Arcangel container as a parameter."],
...
**Release URL pattern:** `https://github.com/arcangel/arcangel/releases/tag/v{version}`
...
This option is available since Arcangel [v2.13.6](https://github.com/arcangel/arcangel/releases/tag/v2.13.6).
...
### Changed behavior — "Before Arcangel v..." inside `<Note>`
...
Before [Arcangel v2.13.6](https://github.com/arcangel/arcangel/releases/tag/v2.13.6), you did X. Now, you must do Y instead.
...
<Prerequisites
  items={[
    {
      text: "Arcangel application set up",
