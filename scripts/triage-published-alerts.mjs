...
// PRODUCTION dependency closure of a published (@arcangel/*, private!==true) package.
...
if (DISMISS) {
  for (const a of irrelevant) {
    execSync(
      ...
      `-f dismissed_comment="Not in the production dependency tree of any published @arcangel package (auto-triaged)."`,
      { stdio: "inherit" }
    )
  }
