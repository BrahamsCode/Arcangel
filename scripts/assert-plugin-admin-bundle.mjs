/**
 * Asserts that a plugin's admin extension bundle — produced by `arcangel
 * plugin:build`, i.e. @arcangel/admin-bundler's Vite `build.lib` path — is
 * shaped correctly.
 *
...
const adminDir = path.resolve(pluginDir, ".arcangel/server/src/admin")
...
const DEFINE_GLOBALS = {
  ...
  __JWT_TOKEN_STORAGE_KEY__: "arcangel_auth_token",
