    ...
    beforeAll(async () => {
      ...
      invite = (
        await api.post(
          "/admin/invites",
          {
            email: "invite@arcangel-commerce.com",
          },
          adminHeaders
        )
      ).data.invite
    ...
    describe("Admin invites", () => {
      ...
      it("should fail to accept an already accepted invite ", async () => {
        ...
        const signupAgain = await api.post("/auth/user/emailpass/register", {
          email: "another-test@arcangel-commerce.com",
          password: "secret_password",
        })
      ...
      it("should create invite with roles and assign them to user on acceptance", async () => {
        ...
        const createdInvite = (
          await api.post(
            "/admin/invites",
            {
              email: "role-test@arcangel-commerce.com",
        ...
        const {
          ...
          Modules,
        } = require("@arcangel/framework/utils")
      ...
      it("should create invite with super admin role and assign it to user", async () => {
        ...
        const createdInvite = (
          await api.post(
            "/admin/invites",
            {
              email: "admin-test@arcangel-commerce.com",
      ...
      it("should create invite without roles and work normally", async () => {
        ...
        const createdInvite = (
          await api.post(
            "/admin/invites",
            {
              email: "no-roles-test@arcangel-commerce.com",
            },
            adminHeaders
          )
        ).data.invite
      ...
      it("should handle invite with non-existent role gracefully", async () => {
        ...
        const error = await api
          .post(
            "/admin/invites",
            {
              email: "invalid-role-test@arcangel-commerce.com",
