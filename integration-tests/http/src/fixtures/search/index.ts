import "@arcangel/modules-sdk"
import { defineSearchIndex, ProductEvents, search } from "@arcangel/utils"
...
// registers the definitions, and arcangel-config passes the returned (normalized)
