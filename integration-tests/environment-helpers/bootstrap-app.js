...
const { isObject } = require("@arcangel/framework/utils")
...
async function bootstrapApp({ cwd, env = {} } = {}) {
  ...
  const loaders = require("@arcangel/arcangel/dist/loaders").default
...
module.exports = {
  ...
  startBootstrapApp: async ({
    ...
    const shutdown = async () => {
      await Promise.all([expressServer.close(), arcangelShutdown()])
