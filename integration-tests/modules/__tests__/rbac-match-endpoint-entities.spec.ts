import { dynamicImport, PolicyResource } from "@arcangel/framework/utils"
...
async function collectAdminEndpointEntities(): Promise<Set<string>> {
  ...
  const adminApiPath = join(__dirname, "../../../packages/arcangel/src/api/admin")
